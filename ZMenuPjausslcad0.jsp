...
<%session.setAttribute("cadbeanx","cadZMenuPjausslBean");%>
...
lpCaller();
fcf('cadForm:_Pjhsogpx');
AlternarSuperFlag(el('cadForm:tabsvf').value);
mesgStyle(rel('cadForm:xmesg_rc'));
}
</SCRIPT>
<title><h:outputText value="#{cadZMenuPjausslBean.role}"/></title>
<style>
.menu-group {
...
<body onkeydown="rk();" onload="window.focus();loading();ufmvini();tran='zmenupjausslcad';cadbeanx='cadZMenuPjausslBean';loadPage(<%= request.getAttribute("pagina") %>);">
<h:form id="cadForm">
...
<!-- Titulo -->
<h:outputText value="#{cadZMenuPjausslBean.role}"/>
</td>
...
<h:inputHidden id="tabsvf" value="#{cadZMenuPjausslBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadZMenuPjausslBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadZMenuPjausslBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadZMenuPjausslBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadZMenuPjausslBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadZMenuPjausslBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadZMenuPjausslBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadZMenuPjausslBean.xmesg_st}" />
...
<h:selectOneMenu value="#{cadZMenuPjausslBean.selectedItem}">
<f:selectItems value="#{cadZMenuPjausslBean.selectItems}" />
</h:selectOneMenu>
<h:commandButton value="enviar" action="#{cadZMenuPjausslBean.action}" />
<h:messages />
&nbsp&nbsp&nbsp&nbsp
<h:inputText id="mesg_var" value="#{cadZMenuPjausslBean.mesg_var}"  styleClass="txrr pr5 tb650r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> menu --%>
</tr> <%-- <tr close> menu --%>
...
<f:facet name="header">
<h:outputText  value="#{iimsg.ZMenuPjaussl_MenuSolic_tt}"/>
</f:facet>
<%-- prop buttonLink 4577--%>
<h:commandLink id="aExePjhsogpx" rendered="#{cadZMenuPjausslBean.canac_pjhsogpx}" onmousedown="fExecx('pjhsogpxpsq', tran, this.id, 'no', '', 'false');" immediate="true" styleClass="mnt" action="#{cadPjhsogpxBean.doSelecionar}">
...
<h:commandLink id="xsel_vali" action="#{cadZMenuPjausslBean.doValidate}" immediate="true"/>
<h:commandLink id="xsel_codf" action="#{cadCodfBean.doSelecionarOnly}" immediate="true"/>
<h:commandLink id="xrec_obob" action="#{cadZMenuPjausslBean.doObternull}" immediate="true"/>
...
<!-- for current oabv -->
<h:commandLink id="xsel_zmenupjaussl" action="#{cadZMenuPjausslBean.doSelecionar}" immediate="true"/>
<h:commandLink id="xrec_zmenupjaussl" action="#{cadZMenuPjausslBean.doObternull}" immediate="true"/>
</h:form>
