...
<link rel="stylesheet" href="../HelprSearchvwpsq.css" type="text/css">
...
function fPgAssist() {
page_assist = <%= session.getAttribute("helprsearchvwpsq") %>;
return page_assist;
}
function loadPage() {
hovDtTable('dtDados');
...
<body onload="window.focus();loadPage();loading();helpcd='';;tran='helprsearchvwpsq'; vl='';cadbeanx='cadHelprSearchvwBean';<%session.setAttribute("tipo","helprsearchvwpsq");%>">
<h:form id="cadForm">
...
<h:commandButton id="aPrev" styleClass="btp"  image="../imagens/btPgAnterior.gif" title="#{iimsg.botao_anterior}" rendered="#{cadHelprSearchvwBean.hasPrevPage}" action="#{cadHelprSearchvwBean.doPaginaAnterior}"/>
<h:commandButton id="aNext" styleClass="btp"  image="../imagens/btPgProxima.gif" title="#{iimsg.botao_proxima}" rendered="#{cadHelprSearchvwBean.hasNextPage}" action="#{cadHelprSearchvwBean.doProximaPagina}"/>
<h:outputText id="label_fill" style="display:none" value="#{iimsg.label_fill}" />
<h:outputText id="label_notfound" style="display:none" value="#{iimsg.label_notfound}" />
<h:outputText id="sys_openning_form" style="display:none" value="#{iimsg.sys_openning_form}" />
<ps:psCommandLink id="aFiltrar" styleClass="btp"  ativo="../imagens/btFilter.gif" title="#{iimsg.botao_filtrar}" action="#{cadHelprSearchvwBean.doSelecionar}">
<f:param name="campo6" value=""/>
<f:param name="tipo" value="helprsearchvwpsq"/>
</ps:psCommandLink>
<h:commandButton id="aHelp" tabindex="-1" immediate="true" title="#{iimsg.botao_help}" onmousedown="pw('helpcad', tran, this.id, 'yes','HelprSearchvw');" image="../imagens/btHelp.gif"/>
...
<h:commandButton id="aHelpHelprSearchvwSfm" tabindex="-1" rendered="#{cadHelprSearchvwBean.hasHelpSpcSfm}" immediate="true" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes','HelprSearchvwSfm');" image="../imagens/btHelpSpc.gif"/>
...
<h:inputText id="mesg_var" value="#{cadHelprSearchvwBean.mesg_var}"  styleClass="txrr pr5 tb600r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> msg --%>
<td> &nbsp&nbsp </td>
<td      width="50" > <%-- open w/ inputText 222--%>
<%-- outputLabel msg --%>
...
<%-- outputText --%>
<td    width="100" > <h:inputText id="codfqt" onfocus="this.blur()" value="#{cadHelprSearchvwBean.codfqt}" size="5" maxlength="5"  styleClass="txl pl5 tbxr"/>
</td> <%-- <close td> msg --%>
</tr> <%-- <tr close> msg--%>
...
<h:outputText id="hd_help_cd_tt_xide" title="#{iimsg.HelprSearchvw_help_cd_tt}" value="#{iimsg.HelprSearchvw_help_cd_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_help_nm_tt_xide" title="#{iimsg.HelprSearchvw_help_nm_tt}" value="#{iimsg.HelprSearchvw_help_nm_ta}"/>
<f:verbatim>&nbsp;&nbsp;</f:verbatim>
<h:commandLink id="hoord_help_nm" action="#{cadHelprSearchvwBean.doOrd_help_nm}">
<ps:psGraphicImage id="hord_help_nm_desc" url="../imagens/btOrder_up.gif" border="0" rendered="#{cadHelprSearchvwBean.ord_help_nm_desc}"/>
<ps:psGraphicImage id="hord_help_nm" url="../imagens/btOrder_down.gif" border="0" rendered="#{cadHelprSearchvwBean.ord_help_nm}"/>
...
<h:outputText id="hd_buttonHelp_tt_xide" title="#{iimsg.HelprSearchvw_buttonHelp_tt}" value="#{iimsg.HelprSearchvw_buttonHelp_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propSearchChildTableGen -->
<!-- assist 1 -->
<h:column rendered="#{cadHelprSearchvwBean.assist}">
<f:facet name="header">
...
<h:inputText id="help_cd_xfil" onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadHelprSearchvwBean.fil_help_cd}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<!-- Dados -->
<h:dataTable
value="#{cadHelprSearchvwBean.pesqData}"
var="Help"
binding="#{cadHelprSearchvwBean.pesqTable}"
rowClasses="tre9, tro9"
headerClass="tbh9"
footerClass="tbf9"
id="dtDados"
rows="#{cadHelprSearchvwBean.pageLength}"
first="#{cadHelprSearchvwBean.currentLine}">
<!-- propColumnGen -->
<h:column id="help_cd">
...
<h:commandLink id="xrec_obnv" action="#{cadHelprSearchvwBean.doNovo}" immediate="true"/>
