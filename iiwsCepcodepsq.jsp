...
<body onload="tran='cepcodepsq';<%session.setAttribute("tipo","cepcodepsq");%>;AlternarMenus(<%= request.getParameter("menu") %>,<%= session.getAttribute("cepcodepsq") %> );">
  <h:form id="cadForm">
                          ...
                          <td colspan="3" align="center">
                            ...
                            <h:dataTable
                              ...
                              <h:column>
                                ...
                                <f:verbatim>&nbsp;&nbsp;</f:verbatim>
                                <h:commandButton id="xget" immediate="true" rendered="#{cadCepBean.assist}" onmousedown="aa=this.id.slice(0,this.id.search('xget'));valor=el(aa+'cep_xide').innerHTML;update(valor);" image="../imagens/btSel.gif"/>
                                <f:facet name="footer">
