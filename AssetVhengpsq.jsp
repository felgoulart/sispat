...
<%session.setAttribute("cadbeanx","cadAssetVhengBean");%>
...
<link rel="stylesheet" href="../AssetVhengpsq.css" type="text/css">
...
function fPgAssist() {
page_assist = <%= session.getAttribute("assetvhengpsq") %>;
return page_assist;
}
function loadPage() {
hovDtTable('dtDados');
...
<title>
<h:outputText value="#{cadAssetVhengBean.trans_tt}"/>
</title>
</head>
<body onload="window.focus();loadPage();loading();fcf('cadForm:p_asset_nu_ident');helpcd='AssetVhengSfm';;tran='assetvhengpsq'; vl='';cadbeanx='cadAssetVhengBean';<%session.setAttribute("tipo","assetvhengpsq");%>">
<h:form id="cadForm">
...
<div class="row-offcanvas row-offcanvas-left">
  <div id="sidebar" class="sidebar-offcanvas">
      <div class="col-md-12">
		...
		<%@include file="AssetVhengpsq_param2.jsp"%>
...
<!-- Principal -->
	<div class="containermod expand-max bg-transparent mt-3">
	  <div class="row">
		...
		<div class="col-sm-10">
		<h2 class="title" style="font-size: 35px;"><h:outputText value="#{cadAssetVhengBean.trans_tt}"/></h2>
		<p class="subtitle"></p>
		</div>
		<div class="col-sm-1">
		<h:commandButton id="aBackToSearch"  styleClass="btn btn-outline-dark" value="Voltar"  onmousedown="document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+''+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadAssetVhengBean.doReturnMenu}"/>
		</div>
	</div>
...
<tr>
	...
	<div class="containermod expand-max bg-transparent">
	  <div class="row">
	  <div class="col-sm-6">
<h:commandButton id="aPrev" styleClass="btp"  image="../imagens/btPgAnterior.gif" title="#{iimsg.botao_anterior}" rendered="#{cadAssetVhengBean.hasPrevPage}" action="#{cadAssetVhengBean.doPaginaAnterior}"/>
<h:commandButton id="aNext" styleClass="btp"  image="../imagens/btPgProxima.gif" title="#{iimsg.botao_proxima}" rendered="#{cadAssetVhengBean.hasNextPage}" action="#{cadAssetVhengBean.doProximaPagina}"/>
<h:outputText id="label_fill" style="display:none" value="#{iimsg.label_fill}" />
<h:outputText id="label_notfound" style="display:none" value="#{iimsg.label_notfound}" />
<h:outputText id="sys_openning_form" style="display:none" value="#{iimsg.sys_openning_form}" />
<h:commandButton id="aFiltrar" value="Filtrar"  styleClass="btn btn-outline-dark"  title="#{iimsg.botao_filtrar}" action="#{cadAssetVhengBean.doSelecionar}"/>
<h:commandButton id="aLimpar" value="Limpar"  styleClass="btn btn-outline-dark" rendered="#{cadAssetVhengBean.canPesquisar}"  title="#{iimsg.botao_limpar}" action="#{cadAssetVhengBean.doLimparPesq}"/>
<h:commandButton id="aNew" value="Inserir"  styleClass="btn btn-outline-dark" rendered="#{cadAssetVhengBean.canInserir}"  onmousedown="fNovorwpp('assetvhengcad', tran, this.id, 'yes', fPgAssist());" title="#{iimsg.botao_novo}" action="#{cadAssetVhengBean.doNovo}"/>
<h:commandButton id="XlsExport_xls_stb"  value="Exportar"  styleClass="btn btn-outline-dark" rendered="#{cadAssetVhengBean.canPesquisar}" title="#{iimsg.AssetVheng_XlsExport_xls_stb_tt}"  action="#{cadAssetVhengBean.doXlsExport_xls_stb}"/>
<h:commandButton id="aHelp" styleClass="d-none" tabindex="-1" immediate="true" title="#{iimsg.botao_help}" onmousedown="pw('helpcad', tran, this.id, 'yes','AssetRolls');" />
...
<h:commandButton id="aHelpAssetComRollsSfm" styleClass="d-none"  tabindex="-1" rendered="#{cadAssetVhengBean.hasHelpComSfm}" immediate="true" title="#{iimsg.botao_help_com}" onmousedown="pw('helpcad', tran, this.id, 'yes','AssetComRollsSfm');" />
...
<h:inputHidden id="xmesg_rc" value="#{cadAssetVhengBean.xmesg_rc}" />
<h:inputHidden id="xhelp_rc" value="#{cadAssetVhengBean.xhelp_rc}" />
<h:commandButton id="aClose" styleClass="d-none" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
	...
	<div class="col-sm-6" align="right">
		<h:outputLabel  styleClass="h6 text-secondary"  id="lbl_asset_in_ultvist" for="asset_in_ultvist"  value="#{iimsg.AssetVheng_asset_in_ultvist_tt}"/>
		<h:inputHidden id="asset_in_ultvist_bol" value="#{cadAssetVhengBean.asset_in_ultvist}"/>
		<h:selectBooleanCheckbox id="asset_in_ultvist" tabindex="13"  value="#{cadAssetVhengBean.asset_in_ultvist_bol}" onclick="chkBoolean(this, 'cadForm:asset_in_ultvist_bol');"/>
	</div>
  </div>
</div>
<div class="containermod  expand-max  bg-transparent" >
...
<h:outputText id="hd_asset_nu_ident_tt_xide" title="#{iimsg.AssetVheng_asset_nu_ident_tt}" value="#{iimsg.AssetVheng_asset_nu_ident_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_nu_tt_xide" title="#{iimsg.AssetVheng_asset_nu_tt}" value="#{iimsg.AssetVheng_asset_nu_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_modelo_tt" title="#{iimsg.AssetVheng_asset_cd_modelo_tt}" value="#{iimsg.AssetVheng_asset_cd_modelo_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_tp_propriedade_tt" title="#{iimsg.AssetVheng_asset_tp_propriedade_tt}" value="#{iimsg.AssetVheng_asset_tp_propriedade_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_corredor_tt" title="#{iimsg.AssetVheng_asset_cd_corredor_tt}" value="#{iimsg.AssetVheng_asset_cd_corredor_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_operacional_vg_tt" title="#{iimsg.AssetVheng_asset_cd_operacional_vg_tt}" value="#{iimsg.AssetVheng_asset_cd_operacional_vg_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_px_local_vistoria_tt" title="#{iimsg.AssetVheng_asset_px_local_vistoria_tt}" value="#{iimsg.AssetVheng_asset_px_local_vistoria_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_dt_vistoria_tt_xide" title="#{iimsg.AssetVheng_asset_dt_vistoria_tt}" value="#{iimsg.AssetVheng_asset_dt_vistoria_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_nu_imobilizado_tt_xide" title="#{iimsg.AssetVheng_asset_nu_imobilizado_tt}" value="#{iimsg.AssetVheng_asset_nu_imobilizado_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_proprietaria_erp_tt" title="#{iimsg.AssetVheng_asset_cd_proprietaria_erp_tt}" value="#{iimsg.AssetVheng_asset_cd_proprietaria_erp_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_vl_contabil_tt_xide" title="#{iimsg.AssetVheng_asset_vl_contabil_tt}" value="#{iimsg.AssetVheng_asset_vl_contabil_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_ds_atividade_tt_xide" title="#{iimsg.AssetVheng_asset_ds_atividade_tt}" value="#{iimsg.AssetVheng_asset_ds_atividade_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_qt_dias_parados_tt_xide" title="#{iimsg.AssetVheng_asset_qt_dias_parados_tt}" value="#{iimsg.AssetVheng_asset_qt_dias_parados_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_operacional_vg_unl_tt" title="#{iimsg.AssetVheng_asset_cd_operacional_vg_unl_tt}" value="#{iimsg.AssetVheng_asset_cd_operacional_vg_unl_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_corredor_unl_tt" title="#{iimsg.AssetVheng_asset_cd_corredor_unl_tt}" value="#{iimsg.AssetVheng_asset_cd_corredor_unl_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenTransGen -->
...
<h:outputText id="hd_asset_images_ongrid_tt_xide" title="#{iimsg.AssetVheng_asset_images_ongrid_tt}" value="#{iimsg.AssetVheng_asset_images_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
...
<h:outputText id="hd_asset_docs_ongrid_tt_xide" title="#{iimsg.AssetVheng_asset_docs_ongrid_tt}" value="#{iimsg.AssetVheng_asset_docs_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenTransGen -->
...
<h:outputText id="hd_asset_geo_ongrid_tt_xide" title="#{iimsg.AssetVheng_asset_geo_ongrid_tt}" value="#{iimsg.AssetVheng_asset_geo_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText  styleClass="d-none" id="hd_tabs_vc_tt_xide" title="#{iimsg.AssetVheng_tabs_vc_tt}" value="#{iimsg.AssetVheng_tabs_vc_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- recdWdColumnGen -->
...
<!-- Dados -->
<h:dataTable
value="#{cadAssetVhengBean.pesqData}"
var="Asset"
binding="#{cadAssetVhengBean.pesqTable}"
rowClasses="tre9mod, tro9mod"
headerClass="tbh9"
footerClass="tbf9"
id="dtDados"
rows="#{cadAssetVhengBean.pageLength}"
first="#{cadAssetVhengBean.currentLine}">
<!-- propColumnGen -->
<h:column id="asset_nu_ident">
...
<h:commandButton id="flag_imgrecd_wd_asset_images_ongrid" action="#{cadObimgBean.doObternull}"  image="imagens/picture2.png"  onmousedown="wtran='obimgcad';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_asset_idasset_images_ongrid_bt').value;el('fiiSaveType').src = 'iiSaveType.jsp?tbak=assetvhengpsq&tipo='+wtran+'&valor='+valor1;" onmouseup="this.form.target='_blank';" onblur="this.form.target='_self';"/>
</h:panelGroup>
</h:column>
<!-- buttonOpenChildTransGen -->
<h:column id="asset_docs_ongrid_bt">
...
<h:commandButton id="flag_imgrecd_wd_asset_docs_ongrid" action="#{cadObdocBean.doSelecionar}" image="imagens/folder.png" onmousedown="wtran='obdocpsq';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_asset_idasset_docs_ongrid_bt').value;el('fiiSaveTypex').src = 'iiSaveTypex.jsp?tbak=assetvhengpsq&tipo='+wtran+'&valor='+valor1;el('fiiSaveField').src='iiSaveField.jsp?campo=campo1&valor='+valor1;" onmouseup="this.form.target='_blank';" onblur="this.form.target='_self';"/>
</h:panelGroup>
</h:column>
<!-- buttonOpenTransGen -->
<h:column id="asset_geo_ongrid_bt">
...
<h:outputLink id="flag_imggeo_asset_geo_ongrid" value="mapa.jsp?bp=" target="_blank" onclick="aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_asset_idasset_geo_ongrid_bt').value;valor1=valor1.slice(0,valor1.length - 5);this.href='mapa.jsp?bp='+valor1+'&type=LC';">
...
<h:commandLink id="flag_imgAssetVheng" onmousedown="wtran='assetvhengcad';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_asset_id').value;el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1;showpopup(tran,'xrec_obob',this.id,wtran,'yes');">
<ps:psGraphicImage flag="#{Asset.tabs_vc}" styleClass="d-none" />
</h:commandLink>
</h:panelGroup>
</h:column>
<!-- recdWdColumnGen -->
...
<!-- REC-30-->  <h:commandButton id="flag_imgrecd_wd" image="../imagens/file.png"  action="#{cadAssetVhengBean.doObternullSearchBack}" onmousedown="wtran='assetvhengcad';aa=this.id.slice(0,this.id.search('flag_img'));valor1=rpel(aa+'sel_asset_id');selDtTableOneRow(aa);el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1;"/>
</h:panelGroup>
</h:column>
<!-- propSearchChildTableGen -->
</h:dataTable>
...
<!-- Conteudo -->
<iframe id="AssetVheng" width="0" height="0" frameborder="0"> </iframe>
...
<h:commandLink id="xrec_obob" action="#{cadAssetVhengBean.doObternull}" immediate="true"/>
<h:commandLink id="xrec_obnv" action="#{cadAssetVhengBean.doNovo}" immediate="true"/>
...
<h:commandLink id="xnew_invtylc" action="#{cadInvtyLCBean.doObternull}" immediate="true"/>
