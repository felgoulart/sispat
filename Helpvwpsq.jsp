...
<%session.setAttribute("cadbeanx","cadHelpvwBean");%>
...
<link rel="stylesheet" href="../Helpvwpsq.css" type="text/css">
...
function fPgAssist() {
page_assist = <%= session.getAttribute("helpvwpsq") %>;
return page_assist;
}
function loadPage() {
hovDtTable('dtDados');
...
<title>
<h:outputText value="#{cadHelpvwBean.trans_tt}"/>
</title>
</head>
<body onload="window.focus();loadPage();loading();helpcd='';;tran='helpvwpsq'; vl='';cadbeanx='cadHelpvwBean';<%session.setAttribute("tipo","helpvwpsq");%>">
<h:form id="cadForm">
...
<h:commandButton id="aPrev" styleClass="btp"  image="../imagens/btPgAnterior.gif" title="#{iimsg.botao_anterior}" rendered="#{cadHelpvwBean.hasPrevPage}" action="#{cadHelpvwBean.doPaginaAnterior}"/>
<h:commandButton id="aNext" styleClass="btp"  image="../imagens/btPgProxima.gif" title="#{iimsg.botao_proxima}" rendered="#{cadHelpvwBean.hasNextPage}" action="#{cadHelpvwBean.doProximaPagina}"/>
<h:outputText id="label_fill" style="display:none" value="#{iimsg.label_fill}" />
<h:outputText id="label_notfound" style="display:none" value="#{iimsg.label_notfound}" />
<h:outputText id="sys_openning_form" style="display:none" value="#{iimsg.sys_openning_form}" />
<h:commandButton id="aFiltrar" styleClass="btp"  image="../imagens/btFilter.gif" title="#{iimsg.botao_filtrar}" action="#{cadHelpvwBean.doSelecionar}"/>
<h:commandButton id="aHelp" tabindex="-1" immediate="true" title="#{iimsg.botao_help}" onmousedown="pw('helpcad', tran, this.id, 'yes','Helpvw');" image="../imagens/btHelp.gif"/>
...
<h:commandButton id="aHelpHelpvwSfm" tabindex="-1" rendered="#{cadHelpvwBean.hasHelpSpcSfm}" immediate="true" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes','HelpvwSfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aHelpgSearch" tabindex="-1" immediate="true" title="#{iimsg.button_help_repository}" onmousedown="pw('helpsearchpsq', tran, this.id, 'yes', 'HelpSearch');" image="../imagens/btHelpRep.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:inputHidden id="xmesg_rc" value="#{cadHelpvwBean.xmesg_rc}" />
<h:inputHidden id="xhelp_rc" value="#{cadHelpvwBean.xhelp_rc}" />
...
<h:inputText id="mesg_var" value="#{cadHelpvwBean.mesg_var}"  styleClass="txrr pr5 tb600r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> msg --%>
<td> &nbsp&nbsp </td>
<td      width="50" > <%-- open w/ inputText 222--%>
<%-- outputLabel msg --%>
...
<%-- outputText --%>
<td    width="100" > <h:inputText id="codfqt" onfocus="this.blur()" value="#{cadHelpvwBean.codfqt}" size="5" maxlength="5"  styleClass="txl pl5 tbxr"/>
</td> <%-- <close td> msg --%>
</tr> <%-- <tr close> msg--%>
...
<h:outputText id="hd_help_cd_tt_xide" title="#{iimsg.Helpvw_help_cd_tt}" value="#{iimsg.Helpvw_help_cd_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_help_nm_tt_xide" title="#{iimsg.Helpvw_help_nm_tt}" value="#{iimsg.Helpvw_help_nm_ta}"/>
<f:verbatim>&nbsp;&nbsp;</f:verbatim>
<h:commandLink id="hoord_help_nm" action="#{cadHelpvwBean.doOrd_help_nm}">
<ps:psGraphicImage id="hord_help_nm_desc" url="../imagens/btOrder_up.gif" border="0" rendered="#{cadHelpvwBean.ord_help_nm_desc}"/>
<ps:psGraphicImage id="hord_help_nm" url="../imagens/btOrder_down.gif" border="0" rendered="#{cadHelpvwBean.ord_help_nm}"/>
<!-- Generate param for Regular Prop -->
<f:param name="tipo" value="helpvwpsq"/>
</h:commandLink>
</h:panelGroup>
</f:facet>
</h:column>
...
<h:outputText id="hd_buttonHelp_tt_xide" title="#{iimsg.Helpvw_buttonHelp_tt}" value="#{iimsg.Helpvw_buttonHelp_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propSearchChildTableGen -->
<!-- assist 1 -->
<h:column rendered="#{cadHelpvwBean.assist}">
<f:facet name="header">
...
<h:inputText id="help_cd_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadHelpvwBean.fil_help_cd}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<!-- Dados -->
<h:dataTable
value="#{cadHelpvwBean.pesqData}"
var="Help"
binding="#{cadHelpvwBean.pesqTable}"
rowClasses="tre9, tro9"
headerClass="tbh9"
footerClass="tbf9"
id="dtDados"
rows="#{cadHelpvwBean.pageLength}"
first="#{cadHelpvwBean.currentLine}">
<!-- propColumnGen -->
<h:column id="help_cd">
<h:panelGroup id="pg_help_cd_sg">
<!-- propColumnGen String -->
<h:outputLabel id="sel_help_cd"  onclick="slvl(this.id,this.value);" value="#{Help.help_cd}"/>
...
<h:commandLink id="xrec_obob" action="#{cadHelpvwBean.doObternull}" immediate="true"/>
<h:commandLink id="xrec_obnv" action="#{cadHelpvwBean.doNovo}" immediate="true"/>
