...
arSubFields[1][5] = new stSubFields('pjaus_in_est_tub_camisa_ss', '0');
arSubFields[1][6] = new stSubFields('pjaus_in_est_fiacao_ss', '0');
arSubFields[1][7] = new stSubFields('pjaus_tp_ten_interf_ss', '0');
arSubFields[1][8] = new stSubFields('pjaus_tp_pos_pn_via_ss', '0');
// pjaus_tp_infc_viaferrea_hl_1 
arSubFields[2] = new Array();
arSubFields[2][1] = new stSubFields('pjaus_vl_ang_interf_via', '0');
arSubFields[2][2] = new stSubFields('pjaus_vl_alt_interf', '2');
arSubFields[2][3] = new stSubFields('pjaus_vl_prf_sub', '0');
arSubFields[2][4] = new stSubFields('pjaus_ar_intf', '0');
arSubFields[2][5] = new stSubFields('pjaus_in_est_tub_camisa_ss', '0');
arSubFields[2][6] = new stSubFields('pjaus_in_est_fiacao_ss', '2');
arSubFields[2][7] = new stSubFields('pjaus_tp_ten_interf_ss', '0');
arSubFields[2][8] = new stSubFields('pjaus_tp_pos_pn_via_ss', '2');
// pjaus_tp_infc_viaferrea_hl_2 
arSubFields[3] = new Array();
arSubFields[3][1] = new stSubFields('pjaus_vl_ang_interf_via', '0');
arSubFields[3][2] = new stSubFields('pjaus_vl_alt_interf', '0');
arSubFields[3][3] = new stSubFields('pjaus_vl_prf_sub', '2');
arSubFields[3][4] = new stSubFields('pjaus_ar_intf', '0');
arSubFields[3][5] = new stSubFields('pjaus_in_est_tub_camisa_ss', '2');
arSubFields[3][6] = new stSubFields('pjaus_tp_ten_interf_ss', '0');
arSubFields[3][7] = new stSubFields('pjaus_tp_pos_pn_via_ss', '2');
// FIELDS
...
arFields[5] = new stField('pjaus_in_est_tub_camisa_ss');
arFields[6] = new stField('pjaus_in_est_fiacao_ss');
arFields[7] = new stField('pjaus_tp_ten_interf_ss');
arFields[8] = new stField('pjaus_tp_pos_pn_via_ss');
...
// High Light FIELDS Function
function hlFields_tpei(fld) {
    // alert('hlFields_tpei' + '  fld: ' + fld); // qqq  
    buttx = fld;
    if (fld == 0) { return;}
var arSubFields = new Array();
// pjaus_tp_est_interf_hl_in 
arSubFields[1] = new Array();
arSubFields[1][1] = new stSubFields('pjaus_tp_ten_interf_ss', '0');
arSubFields[1][2] = new stSubFields('pjaus_vl_dist', '0');
// pjaus_tp_est_interf_hl_1 
arSubFields[2] = new Array();
arSubFields[2][1] = new stSubFields('pjaus_tp_ten_interf_ss', '2');
arSubFields[2][2] = new stSubFields('pjaus_vl_dist', '2');
// FIELDS
var arFields = new Array();
arFields[1] = new stField('pjaus_tp_ten_interf_ss');
...
arSubFields[3][2] = new stSubFields('pjaus_ar_intf', '2');
// pjaus_tp_pos_pn_via_hl_2 
arSubFields[4] = new Array();
arSubFields[4][1] = new stSubFields('pjaus_vl_ang_interf_via', '2');
arSubFields[4][2] = new stSubFields('pjaus_ar_intf', '2');
// FIELDS
var arFields = new Array();
arFields[1] = new stField('pjaus_vl_ang_interf_via');
arFields[2] = new stField('pjaus_ar_intf');
...
arCleFields[8][3] = new stCleFields('pjaus_tp_espec_2', '');
arCleFields[8][4] = new stCleFields('pjaus_tp_espec_2_desc', '');
// pjaus_tp_espec_1 
arCleFields[9] = new Array();
arCleFields[9][0] = new stCleFields('pjaus_tp_espec_1', '');
arCleFields[9][1] = new stCleFields('pjaus_tp_espec_2', '');
arCleFields[9][2] = new stCleFields('pjaus_tp_espec_2_desc', '');
...
arCleFields[11][1] = new stCleFields('pjaus_tp_ten_interf', '');
arCleFields[11][2] = new stCleFields('pjaus_tp_ten_interf_desc', '');
// pjaus_tp_pos_pn_via 
...
function pjaus_tp_infc_viaferrea_hl(val) {
  ...
  if (val == '1') {cle_mesg();hlFields_tivf(2);};
  if (val == '2') {cle_mesg();hlFields_tivf(3);};
}
function pjaus_tp_est_interf_hl(val) {
      val = rel('cadForm:pjaus_tp_est_interf');
      // alert('pjaus_tp_est_interf' + ' val: ' + val); // qqq
  if (val == '') {cle_mesg();hlFields_tpei(1);};
  if (val == '1') {cle_mesg();hlFields_tpei(2);};
}
...
function PjausPaaittv_pjint_hl() {
    // alert('PjausPaaittv_pjint_hl()'); // qqq 
    pjaus_tp_infc_viaferrea_hl('');
    pjaus_tp_est_interf_hl('');
    pjaus_tp_pos_pn_via_hl('');
}
function PjausPaaittv_pjtct_hl() {
    // alert('PjausPaaittv_pjtct_hl()'); // qqq 
    pjaus_tp_investimento_hl('');
    pjaus_tp_arrecadacao_hl('');
}
function PjausPaaittv_hl() {
    pjaus_tp_infc_viaferrea_hl('');
    pjaus_tp_est_interf_hl('');
    pjaus_tp_pos_pn_via_hl('');
    pjaus_tp_investimento_hl('');
