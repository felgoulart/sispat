...
<%session.setAttribute("cadbeanx","cadAssetYrdldBean");%>
...
<link rel="stylesheet" href="../AssetYrdldpsq.css" type="text/css">
...
<script src="../AssetYrdldfunctions.js" type="text/javascript" language="javascript"></script>
<SCRIPT type="text/javascript">
function fPgAssist() {
page_assist = <%= session.getAttribute("assetyrdldpsq") %>;
return page_assist;
}
function loadPage() {
hovDtTable('dtDados');
...
<title>
<h:outputText value="#{cadAssetYrdldBean.trans_tt}"/>
</title>
</head>
<body onload="window.focus();loadPage();loading();fcf('cadForm:asset_km_range_sqlparm');helpcd='AssetYrdldSfm';;tran='assetyrdldpsq'; vl='';cadbeanx='cadAssetYrdldBean';<%session.setAttribute("tipo","assetyrdldpsq");%>">
<h:form id="cadForm">
...
<h:commandButton id="aBackToSearch" styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+''+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadAssetYrdldBean.doReturnMenu}"/>
<h:commandButton id="aPrev" styleClass="btp"  image="../imagens/btPgAnterior.gif" title="#{iimsg.botao_anterior}" rendered="#{cadAssetYrdldBean.hasPrevPage}" action="#{cadAssetYrdldBean.doPaginaAnterior}"/>
<h:commandButton id="aNext" styleClass="btp"  image="../imagens/btPgProxima.gif" title="#{iimsg.botao_proxima}" rendered="#{cadAssetYrdldBean.hasNextPage}" action="#{cadAssetYrdldBean.doProximaPagina}"/>
<h:outputText id="label_fill" style="display:none" value="#{iimsg.label_fill}" />
<h:outputText id="label_notfound" style="display:none" value="#{iimsg.label_notfound}" />
<h:outputText id="sys_openning_form" style="display:none" value="#{iimsg.sys_openning_form}" />
<h:commandButton id="aFiltrar" styleClass="btp"  image="../imagens/btFilter.gif" title="#{iimsg.botao_filtrar}" action="#{cadAssetYrdldBean.doSelecionar}"/>
<h:commandButton id="aLimpar" styleClass="btp" rendered="#{cadAssetYrdldBean.canPesquisar}" image="../imagens/btCancel.gif" title="#{iimsg.botao_limpar}" action="#{cadAssetYrdldBean.doLimparPesq}"/>
<h:commandButton id="aNew" styleClass="btp" rendered="#{cadAssetYrdldBean.canInserir}" image="../imagens/btNew.gif" onmousedown="fNovorwpp('assetyrdldcad', tran, this.id, 'yes', fPgAssist());" title="#{iimsg.botao_novo}" action="#{cadAssetYrdldBean.doNovo}"/>
<h:commandButton id="XlsExport_xls_stb" rendered="#{cadAssetYrdldBean.canPesquisar}" title="#{iimsg.AssetYrdld_XlsExport_xls_stb_tt}" image="../imagens/excellRed.jpg" action="#{cadAssetYrdldBean.doXlsExport_xls_stb}"/>
...
<h:commandButton id="aHelpAssetComSfm" tabindex="-1" rendered="#{cadAssetYrdldBean.hasHelpComSfm}" immediate="true" title="#{iimsg.botao_help_com}" onmousedown="pw('helpcad', tran, this.id, 'yes','AssetComSfm');" image="../imagens/btHelpCom.gif"/>
...
<h:inputHidden id="xmesg_rc" value="#{cadAssetYrdldBean.xmesg_rc}" />
<h:inputHidden id="xhelp_rc" value="#{cadAssetYrdldBean.xhelp_rc}" />
...
<%@include file="AssetYrdldpsq_param.jsp"%>
<table    >  <%-- <search mesg frame open> --%>
<tr>  <%-- <tr open> msg --%>
<td      width="50" > <%-- open w/ inputText 222--%>
<h:inputText id="mesg_var" value="#{cadAssetYrdldBean.mesg_var}"  styleClass="txrr pr5 tb600r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> msg --%>
<td> &nbsp&nbsp </td>
<td      width="50" > <%-- open w/ inputText 222--%>
<%-- outputLabel msg --%>
...
<%-- outputText --%>
<td    width="100" > <h:inputText id="codfqt" onfocus="this.blur()" value="#{cadAssetYrdldBean.codfqt}" size="5" maxlength="5"  styleClass="txl pl5 tbxr"/>
</td> <%-- <close td> msg --%>
</tr> <%-- <tr close> msg--%>
...
<h:outputText id="hd_asset_nu_tt_xide" title="#{iimsg.AssetYrdld_asset_nu_tt}" value="#{iimsg.AssetYrdld_asset_nu_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_st_operacional_cfoperc_tt" title="#{iimsg.AssetYrdld_asset_st_operacional_cfoperc_tt}" value="#{iimsg.AssetYrdld_asset_st_operacional_cfoperc_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_tp_propriedade_tt" title="#{iimsg.AssetYrdld_asset_tp_propriedade_tt}" value="#{iimsg.AssetYrdld_asset_tp_propriedade_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- fkeyColumnGen -->
...
<h:outputText id="hd_asset_cd_ccusto_tt" title="#{iimsg.AssetYrdld_asset_cd_ccusto_tt}" value="#{iimsg.AssetYrdld_asset_cd_ccusto_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_uf_tt" title="#{iimsg.AssetYrdld_asset_cd_uf_tt}" value="#{iimsg.AssetYrdld_asset_cd_uf_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_cfresid_tt" title="#{iimsg.AssetYrdld_asset_cd_cfresid_tt}" value="#{iimsg.AssetYrdld_asset_cd_cfresid_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_nm_bairro_tt_xide" title="#{iimsg.AssetYrdld_asset_nm_bairro_tt}" value="#{iimsg.AssetYrdld_asset_nm_bairro_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_nm_logradouro_tt_xide" title="#{iimsg.AssetYrdld_asset_nm_logradouro_tt}" value="#{iimsg.AssetYrdld_asset_nm_logradouro_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_trecho_tt" title="#{iimsg.AssetYrdld_asset_cd_trecho_tt}" value="#{iimsg.AssetYrdld_asset_cd_trecho_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_subtrecho_tt" title="#{iimsg.AssetYrdld_asset_cd_subtrecho_tt}" value="#{iimsg.AssetYrdld_asset_cd_subtrecho_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_cfreslc_tt" title="#{iimsg.AssetYrdld_asset_cd_cfreslc_tt}" value="#{iimsg.AssetYrdld_asset_cd_cfreslc_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_cfreslc_prx_tt" title="#{iimsg.AssetYrdld_asset_cd_cfreslc_prx_tt}" value="#{iimsg.AssetYrdld_asset_cd_cfreslc_prx_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_km_ini_tt_xide" title="#{iimsg.AssetYrdld_asset_km_ini_tt}" value="#{iimsg.AssetYrdld_asset_km_ini_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_km_fim_tt_xide" title="#{iimsg.AssetYrdld_asset_km_fim_tt}" value="#{iimsg.AssetYrdld_asset_km_fim_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_st_geral_tt" title="#{iimsg.AssetYrdld_asset_st_geral_tt}" value="#{iimsg.AssetYrdld_asset_st_geral_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_in_manut_tt" title="#{iimsg.AssetYrdld_asset_in_manut_tt}" value="#{iimsg.AssetYrdld_asset_in_manut_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_termo_devolucao_ckb_tt" title="#{iimsg.AssetYrdld_asset_cd_termo_devolucao_ckb_has_tt}" value="#{iimsg.AssetYrdld_asset_cd_termo_devolucao_ckb_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_termo_entrega_ckb_tt" title="#{iimsg.AssetYrdld_asset_cd_termo_entrega_ckb_has_tt}" value="#{iimsg.AssetYrdld_asset_cd_termo_entrega_ckb_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_tombamento_ckb_tt" title="#{iimsg.AssetYrdld_asset_cd_tombamento_ckb_has_tt}" value="#{iimsg.AssetYrdld_asset_cd_tombamento_ckb_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_dt_vistoria_tt_xide" title="#{iimsg.AssetYrdld_asset_dt_vistoria_tt}" value="#{iimsg.AssetYrdld_asset_dt_vistoria_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenTransGen -->
...
<h:outputText id="hd_asset_images_ongrid_tt_xide" title="#{iimsg.AssetYrdld_asset_images_ongrid_tt}" value="#{iimsg.AssetYrdld_asset_images_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
...
<h:outputText id="hd_asset_docs_ongrid_tt_xide" title="#{iimsg.AssetYrdld_asset_docs_ongrid_tt}" value="#{iimsg.AssetYrdld_asset_docs_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenChildTransGen -->
...
<h:outputText id="hd_asset_ocrs_ongrid_tt_xide" title="#{iimsg.AssetYrdld_asset_ocrs_ongrid_tt}" value="#{iimsg.AssetYrdld_asset_ocrs_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenTransGen -->
...
<h:outputText id="hd_asset_geo_ongrid_tt_xide" title="#{iimsg.AssetYrdld_asset_geo_ongrid_tt}" value="#{iimsg.AssetYrdld_asset_geo_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_tabs_vc_tt_xide" title="#{iimsg.AssetYrdld_tabs_vc_tt}" value="#{iimsg.AssetYrdld_tabs_vc_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- recdWdColumnGen -->
...
<h:inputText id="fil_asset_st_operacional_cfoperc_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'OPERC', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdldBean.fil_asset_st_operacional_cfoperc}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<!--   // 444-->
<h:inputText id="asset_cd_ccusto_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('Ixccustpsq', tran, this.id, 'no', vl);" onblur="cfb(this.id, 'pfdb9', 'pfd9');" onfocus="this.className='pfd9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdldBean.fil_asset_cd_ccusto}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_asset_cd_cfresid_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'RESID', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdldBean.fil_asset_cd_cfresid}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
<h:column id="asset_nm_bairro">
<f:facet name="footer">
<h:panelGroup id="fpg_asset_nm_bairro">
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
<h:column id="asset_nm_logradouro">
<f:facet name="footer">
<h:panelGroup id="fpg_asset_nm_logradouro">
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_asset_in_manut_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'SN', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdldBean.fil_asset_in_manut}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_asset_cd_termo_devolucao_ckb_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdldBean.fil_asset_cd_termo_devolucao_ckb}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_asset_cd_termo_entrega_ckb_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdldBean.fil_asset_cd_termo_entrega_ckb}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_asset_cd_tombamento_ckb_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdldBean.fil_asset_cd_tombamento_ckb}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="tabs_vc_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadAssetYrdldBean.fil_tabs_vc}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- recdWdColumnGen -->
...
<!-- Dados -->
<h:dataTable
value="#{cadAssetYrdldBean.pesqData}"
var="Asset"
binding="#{cadAssetYrdldBean.pesqTable}"
rowClasses="tre9, tro9"
headerClass="tbh9"
footerClass="tbf9"
id="dtDados"
rows="#{cadAssetYrdldBean.pageLength}"
first="#{cadAssetYrdldBean.currentLine}">
<!-- propColumnGen -->
<h:column id="asset_nu">
...
<!-- propColumnGen String -->
<h:outputLabel id="sel_asset_nm_bairro"  onclick="slvl(this.id,this.value);" value="#{Asset.asset_nm_bairro}"/>
</h:panelGroup>
</h:column>
<!-- propColumnGen -->
<h:column id="asset_nm_logradouro">
...
<!-- propColumnGen String -->
<h:outputLabel id="sel_asset_nm_logradouro"  onclick="slvl(this.id,this.value);" value="#{Asset.asset_nm_logradouro}"/>
</h:panelGroup>
</h:column>
<!-- codfColumnGen -->
...
<h:commandButton id="flag_imgrecd_wd_asset_images_ongrid" action="#{cadObimgBean.doObternull}"  image="#{Asset.imag_im}"  onmousedown="wtran='obimgcad';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_asset_idasset_images_ongrid_bt').value;el('fiiSaveType').src = 'iiSaveType.jsp?tbak=assetyrdldpsq&tipo='+wtran+'&valor='+valor1;" onmouseup="this.form.target='_blank';" onblur="this.form.target='_self';"/>
</h:panelGroup>
</h:column>
<!-- buttonOpenChildTransGen -->
<h:column id="asset_docs_ongrid_bt">
...
<h:commandButton id="flag_imgrecd_wd_asset_docs_ongrid" action="#{cadObdocBean.doSelecionar}" image="#{Asset.file_im}" onmousedown="wtran='obdocpsq';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_asset_idasset_docs_ongrid_bt').value;el('fiiSaveTypex').src = 'iiSaveTypex.jsp?tbak=assetyrdldpsq&tipo='+wtran+'&valor='+valor1;el('fiiSaveField').src='iiSaveField.jsp?campo=campo1&valor='+valor1;" onmouseup="this.form.target='_blank';" onblur="this.form.target='_self';"/>
</h:panelGroup>
</h:column>
<!-- buttonOpenChildTransGen -->
<h:column id="asset_ocrs_ongrid_bt">
...
<h:outputLink id="flag_imggeo_asset_geo_ongrid" value="mapa.jsp?bp=" target="_blank" onclick="aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_asset_idasset_geo_ongrid_bt').value;valor1=valor1.slice(0,valor1.length - 5);this.href='mapa.jsp?bp='+valor1+'&type=TP';">
<ps:psGraphicImage  flagType="geo" flag="#{Asset.geo_vx}" title="#{iimsg.AssetYrdld_asset_geo_ongrid_tt}" styleClass="btp" />
</h:outputLink>
</h:panelGroup>
</h:column>
<!-- propColumnGen -->
...
<h:commandLink id="flag_imgAssetYrdld" onmousedown="wtran='assetyrdldcad';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_asset_id').value;el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1;showpopup(tran,'xrec_obob',this.id,wtran,'yes');">
...
<!-- REC-30-->  <h:commandButton id="flag_imgrecd_wd" image="../imagens/btRecd.gif" action="#{cadAssetYrdldBean.doObternullSearchBack}" onmousedown="wtran='assetyrdldcad';aa=this.id.slice(0,this.id.search('flag_img'));valor1=rpel(aa+'sel_asset_id');selDtTableOneRow(aa);el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1;"/>
</h:panelGroup>
</h:column>
<!-- propSearchChildTableGen -->
</h:dataTable>
...
<iframe id="InvtyTP" width="0" height="0" frameborder="0"> </iframe>
<iframe id="InvtyTP" width="0" height="0" frameborder="0"> </iframe>
<iframe id="InvtyTP" width="0" height="0" frameborder="0"> </iframe>
...
<h:commandLink id="xrec_obob" action="#{cadAssetYrdldBean.doObternull}" immediate="true"/>
<h:commandLink id="xrec_obnv" action="#{cadAssetYrdldBean.doNovo}" immediate="true"/>
...
<h:commandLink id="xnew_invtytp" action="#{cadInvtyTPBean.doObternull}" immediate="true"/>
