...
<title><h:outputText value="#{cadObdocpjemlBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();" onload="window.focus();loading();ufmvini();tran='obdocpjemlcad';cadbeanx='cadObdocpjemlBean';loadPage(<%= request.getAttribute("pagina") %>);">
<h:form id="cadForm" enctype="multipart/form-data" >
<jsp:setProperty property="cadbeanx" name="cadObdocpjemlBean" value="cadObdocpjemlBean"/>
<h:inputHidden id="cadbeanx" value="#{cadObdocpjemlBean.cadbeanx}"  />
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obdocpjemlpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadObdocpjemlBean.doSelecionarBackx}"/>
...
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obdocpjemlcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadObdocpjemlBean.doReturnMenu}"/>
<h:commandButton id="aPrev" immediate="true" styleClass="btp" rendered="#{cadObdocpjemlBean.idxflag}" image="../imagens/btPgAnterior.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_anterior}" action="#{cadObdocpjemlBean.doObternullPrev}"/>
<h:commandButton id="aNext" immediate="true" styleClass="btp" rendered="#{cadObdocpjemlBean.idxflag}" image="../imagens/btPgProxima.gif" onmousedown="msgwr()" title="#{iimsg.botao_proxima}" action="#{cadObdocpjemlBean.doObternullNext}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadObdocpjemlBean.canUpdate}" image="../imagens/btSave.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obdocpjemlcad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadObdocpjemlBean.doUpdate1Chld}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadObdocpjemlBean.canUpdate}" image="../imagens/btNew.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadObdocpjemlBean.doObterParentForCancel}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadObdocpjemlBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadObdocpjemlBean.doExcluirChld}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}"  action="#{cadObdocpjemlBean.doObter}"  onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obdocpjemlcad'+'&ufmv='+stx"/>
...
<h:inputHidden id="tabsvf" value="#{cadObdocpjemlBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadObdocpjemlBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadObdocpjemlBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadObdocpjemlBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadObdocpjemlBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadObdocpjemlBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadObdocpjemlBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadObdocpjemlBean.xmesg_st}" />
...
<td   colspan="2"    >
<h:inputText id="mesg_var" value="#{cadObdocpjemlBean.mesg_var}"  styleClass="txrr pr5 tb450r" tabindex="-1" readonly="true"/>
<h:commandButton id="aMessage" image="../imagens/btMessage_off.gif" styleClass="btp" title="#{iimsg.botao_message}" rendered="#{cadObdocpjemlBean.canUpdate}" action="#{cadObdocpjemlBean.doValidate}" onmousedown="msgw('aMessage');"/>
<h:inputText id="idxm" value="#{cadObdocpjemlBean.idxm}"  styleClass="txrr pr5 tb50r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> bbb --%>
</tr> <%-- <tr close> bbb --%>
<tr>   <%-- <tr open> vvv --%>
</td> <%-- <close td> ccc --%>
...
<%-- Processing Fk --%>
<%-- Processing Fk 333--%>
<h:inputText id="obdocpj_id" tabindex="-1"  onclick="clf(this);" readonly="true" value="#{cadObdocpjemlBean.obdocpj_id}"  styleClass="tbxr" onkeydown="keypress=1;" size="20" maxlength="20" />
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
<%-- prop Primary Key --%>
<%-- Processing Pk --%>
<h:inputHidden id="obdocpj_sq" value="#{cadObdocpjemlBean.obdocpj_sq}"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<%-- Hidden --%>
<h:inputHidden id="obdocpj_cl" value="#{cadObdocpjemlBean.obdocpj_cl}"/>
<tr>   <%-- <tr open> vvv --%>
<%-- Hidden --%>
<h:inputHidden id="obdocpj_cl_type" value="#{cadObdocpjemlBean.obdocpj_cl_type}"/>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
<%-- outputLabel aaa --%>
...
<h:inputText  id="obdobdocpj_tp" onclick="clf(this);" value="#{cadObdocpjemlBean.obdobdocpj_tp}" onkeydown="keypress=1;"  styleClass="tbx" onchange="bdcd('','obdobdocpj_tp','0','TPDCP',this.value);;" size="7" maxlength="5" tabindex="2" />
...
<ps:psGraphicImage id="obdobdocpj_tp_vc" flagType="val" flag="#{cadObdocpjemlBean.obdobdocpj_tp_vc}" styleClass="btp"/>
<%-- Processing Codf 1 AAA --%>
<h:inputText id="obdobdocpj_tp_desc" tabindex="-1" onfocus="this.blur()" value="#{cadObdocpjemlBean.obdobdocpj_tp_desc}" styleClass="txlr pr5 tb90r"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<%-- Processing Fk --%>
<%-- Processing Fk 333--%>
<h:inputText id="obdocpj_cd_solct" tabindex="3"  onclick="clf(this);" value="#{cadObdocpjemlBean.obdocpj_cd_solct}"  styleClass="tbx" onkeydown="keypress=1;" onchange="this.value=this.value.toUpperCase();Transfk('','','0','obdocpj_cd_solct','Solct','solct_cd','solct_ds',this.value);" size="32" maxlength="30" />
...
<ps:psGraphicImage id="obdocpj_cd_solct_vc" flagType="val" flag="#{cadObdocpjemlBean.obdocpj_cd_solct_vc}" styleClass="btp"/>
<%-- ak/fk else akhidden --%>
<h:inputText id="obdocpj_cd_solct_desc" tabindex="-1" onfocus="this.blur()" value="#{cadObdocpjemlBean.obdocpj_cd_solct_desc}" styleClass="txlr pr5 tb90r"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<%-- Processing Fk --%>
<%-- Processing Fk 333--%>
<h:inputText id="obdocpj_cd_destino" tabindex="4"  onclick="clf(this);" value="#{cadObdocpjemlBean.obdocpj_cd_destino}"  styleClass="tbx" onkeydown="keypress=1;" onchange="this.value=this.value.toUpperCase();Transfk('','','0','obdocpj_cd_destino','Solct','solct_cd','solct_ds',this.value);" size="32" maxlength="30" />
<%-- Avoid Fks that are recursive fks --%>
<%-- prop BBB --%>
<%-- ak/fk --%>
...
<ps:psGraphicImage id="obdocpj_cd_destino_vc" flagType="val" flag="#{cadObdocpjemlBean.obdocpj_cd_destino_vc}" styleClass="btp"/>
<%-- ak/fk else akhidden --%>
<h:inputText id="obdocpj_cd_destino_desc" tabindex="-1" onfocus="this.blur()" value="#{cadObdocpjemlBean.obdocpj_cd_destino_desc}" styleClass="txlr pr5 tb90r"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<%-- Processing Codf 1--%>
<%-- Processing Codf 1 HLFN --%>
<h:inputText  id="obdocpj_st" onclick="clf(this);" value="#{cadObdocpjemlBean.obdocpj_st}" onkeydown="keypress=1;"  styleClass="tbx" onchange="bdcd('','obdocpj_st','0','STDCP',this.value);;" size="7" maxlength="5" tabindex="5" />
...
<ps:psGraphicImage id="obdocpj_st_vc" flagType="val" flag="#{cadObdocpjemlBean.obdocpj_st_vc}" styleClass="btp"/>
<%-- Processing Codf 1 AAA --%>
<h:inputText id="obdocpj_st_desc" tabindex="-1" onfocus="this.blur()" value="#{cadObdocpjemlBean.obdocpj_st_desc}" styleClass="txlr pr5 tb100r"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<ps:psGraphicImage id="obdocpj_dt_envio_vc" flagType="val" flag="#{cadObdocpjemlBean.obdocpj_dt_envio_vc}" styleClass="btp"/>
...
<%-- DateTime --%>
<td  width="12" > <h:inputText id="obdocpj_dt_recepcao" tabindex="-1"  onfocus="this.blur()" value="#{cadObdocpjemlBean.obdocpj_dt_recepcao_str}" onchange="uf();" size="12" maxlength="12"  styleClass="tbDhr" onkeydown="formataDataHora('cadForm:obdocpj_dt_recepcao', event);" onkeyup="SaltaCampo('cadForm:obdocpj_dt_recepcao', 'cadForm:obdocpj_cd_file', 14 , event);"/>
<ps:psGraphicImage id="obdocpj_dt_recepcao_vc" flagType="val" flag="#{cadObdocpjemlBean.obdocpj_dt_recepcao_vc}" styleClass="btp"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<%-- Hidden --%>
<h:inputHidden id="obdocpj_cd_file" value="#{cadObdocpjemlBean.obdocpj_cd_file}"/>
<tr>   <%-- <tr open> vvv --%>
<%-- Hidden --%>
<h:inputHidden id="obdocpj_tp_cfpjtp" value="#{cadObdocpjemlBean.obdocpj_tp_cfpjtp}"/>
<tr>   <%-- <tr open> vvv --%>
<%-- Hidden --%>
<h:inputHidden id="obdocpj_nm" value="#{cadObdocpjemlBean.obdocpj_nm}"/>
<tr>   <%-- <tr open> vvv --%>
...
<tr>   <%-- <tr open> vvv --%>
<%-- inputTextArea --%>
<td   colspan="2" >  <h:inputTextarea id="obdocpj_ds" tabindex="8"  value="#{cadObdocpjemlBean.obdocpj_ds}" cols="80" rows="4" styleClass="obdocpj_ds_rtfFontChoice" onchange="bv('','obdocpj_ds','0',this.value);"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<%-- Hidden --%>
<h:inputHidden id="obdocpj_ct" value="#{cadObdocpjemlBean.obdocpj_ct}"/>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
<%-- outputLabel aaa --%>
...
<%-- prop Selection --%>
<td width="600"/>
<ps:psInputFile id="inputFile"  value="#{cadObdocpjemlBean.file}" styleClass="tb400r" /> ></td>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<td  width="600" > <h:inputText id="obdocpj_nm_file" tabindex="-1"  readonly="true" value="#{cadObdocpjemlBean.obdocpj_nm_file}"  styleClass="tbxr" size="100" maxlength="100"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<%-- Hidden --%>
<h:inputHidden id="obdocpj_nm_filex" value="#{cadObdocpjemlBean.obdocpj_nm_filex}"/>
<tr>   <%-- <tr open> vvv --%>
<%-- Hidden --%>
<h:inputHidden id="obdocpj_in_ultimo" value="#{cadObdocpjemlBean.obdocpj_in_ultimo}"/>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
<%-- outputLabel aaa --%>
<h:outputLabel  styleClass="tip txl pl0"  rendered="#{cadObdocpjemlBean.canUpload}" id="lbl_upload" for="upload"  value="#{iimsg.Obdocpjeml_upload_tt}"/>  </td> <%-- <top> --%>
<%-- prop fileUploadOnly --%>
<td width="600"/>
<h:commandButton id="doUpload" rendered="#{cadObdocpjemlBean.canUpload}" action="#{cadObdocpjemlBean.doFileUpload}" image="../imagens/fileUpload3.gif" /></td>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
<%-- outputLabel aaa --%>
<h:outputLabel  styleClass="tip txl pl0"  rendered="#{cadObdocpjemlBean.canDownload}" id="lbl_download" for="download"  value="#{iimsg.Obdocpjeml_download_ta}"/>  </td> <%-- <top> --%>
<%-- prop buttonDownload --%>
<td width="600" />
<h:commandButton id="doSownload" rendered="#{cadObdocpjemlBean.canDownload}" action="#{cadObdocpjemlBean.downloadFile}" image="../imagens/fileDownload3.gif" onmousedown="wtran=document.getElementById('cadForm:obdocpj_nm_file').value;el('fiiSaveValue').src = 'iiSaveValue.jsp?tipo='+wtran;" /></td>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<!-- D00_NOTR -->
...
<h:commandLink id="xsel_vali" action="#{cadObdocpjemlBean.doValidate}" immediate="true"/>
...
<c:if test="${  cadObdocpjemlBean.obdocpj_nm_file !=null }">
mostraDados('<c:out value="${  cadObdocpjemlBean.obdocpj_id }" />','<c:out value="${  cadObdocpjemlBean.obdocpj_cl_type }" />','<c:out value="${  cadObdocpjemlBean.obdocpj_nm }" />','<c:out value="${  cadObdocpjemlBean.obdocpj_ds }" />');
</c:if>
</script>
