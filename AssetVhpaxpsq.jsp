...
<%session.setAttribute("cadbeanx","cadAssetVhpaxBean");%>
...
<link rel="stylesheet" href="../AssetVhpaxpsq.css" type="text/css">
...
function fPgAssist() {
page_assist = <%= session.getAttribute("assetvhpaxpsq") %>;
return page_assist;
}
function loadPage() {
hovDtTable('dtDados');
...
<title>
<h:outputText value="#{cadAssetVhpaxBean.trans_tt}"/>
</title>
</head>
<body onload="window.focus();loadPage();loading();fcf('cadForm:p_asset_nu_ident');helpcd='AssetVhpaxSfm';;tran='assetvhpaxpsq'; vl='';cadbeanx='cadAssetVhpaxBean';<%session.setAttribute("tipo","assetvhpaxpsq");%>">
<h:form id="cadForm">
...
<div class="row-offcanvas row-offcanvas-left">
  <div id="sidebar" class="sidebar-offcanvas">
      <div class="col-md-12">
		...
		<%@include file="AssetVhpaxpsq_param2.jsp"%>
...
<!-- Principal -->
	<div class="container expand-max bg-transparent mt-3">
	  <div class="row">
		...
		<div class="col-sm-10">
		<h2 class="title" style="font-size: 35px;"><h:outputText value="#{cadAssetVhpaxBean.trans_tt}"/></h2>
		<p class="subtitle"></p>
		</div>
		<div class="col-sm-1">
		<h:commandButton id="aBackToSearch"  styleClass="btn btn-outline-dark" value="Voltar"  onmousedown="document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+''+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadAssetVhpaxBean.doReturnMenu}"/>
		</div>
	</div>
	</div>
...
<tr>
	...
	<div class="containermod expand-max bg-transparent">
	  <div class="row">
	  <div class="col-sm-6">
<h:commandButton id="aPrev" styleClass="btp"  image="../imagens/btPgAnterior.gif" title="#{iimsg.botao_anterior}" rendered="#{cadAssetVhpaxBean.hasPrevPage}" action="#{cadAssetVhpaxBean.doPaginaAnterior}"/>
<h:commandButton id="aNext" styleClass="btp"  image="../imagens/btPgProxima.gif" title="#{iimsg.botao_proxima}" rendered="#{cadAssetVhpaxBean.hasNextPage}" action="#{cadAssetVhpaxBean.doProximaPagina}"/>
<h:outputText id="label_fill" style="display:none" value="#{iimsg.label_fill}" />
<h:outputText id="label_notfound" style="display:none" value="#{iimsg.label_notfound}" />
<h:outputText id="sys_openning_form" style="display:none" value="#{iimsg.sys_openning_form}" />
<h:commandButton id="aFiltrar" value="Filtrar"  styleClass="btn btn-outline-dark"  title="#{iimsg.botao_filtrar}" action="#{cadAssetVhpaxBean.doSelecionar}"/>
<h:commandButton id="aLimpar" value="Limpar"  styleClass="btn btn-outline-dark" rendered="#{cadAssetVhpaxBean.canPesquisar}"  title="#{iimsg.botao_limpar}" action="#{cadAssetVhpaxBean.doLimparPesq}"/>
<h:commandButton id="aNew" value="Inserir"  styleClass="btn btn-outline-dark" rendered="#{cadAssetVhpaxBean.canInserir}"  onmousedown="fNovorwpp('assetvhpaxcad', tran, this.id, 'yes', fPgAssist());" title="#{iimsg.botao_novo}" action="#{cadAssetVhpaxBean.doNovo}"/>
<h:commandButton id="XlsExport_xls_stb"  value="Exportar"  styleClass="btn btn-outline-dark" rendered="#{cadAssetVhpaxBean.canPesquisar}" title="#{iimsg.AssetVhpax_XlsExport_xls_stb_tt}"  action="#{cadAssetVhpaxBean.doXlsExport_xls_stb}"/>
...
<h:commandButton id="aHelpAssetComRollsSfm" styleClass="d-none"  tabindex="-1" rendered="#{cadAssetVhpaxBean.hasHelpComSfm}" immediate="true" title="#{iimsg.botao_help_com}" onmousedown="pw('helpcad', tran, this.id, 'yes','AssetComRollsSfm');" />
...
<h:inputHidden id="xmesg_rc" value="#{cadAssetVhpaxBean.xmesg_rc}" />
<h:inputHidden id="xhelp_rc" value="#{cadAssetVhpaxBean.xhelp_rc}" />
<h:commandButton id="aClose" styleClass="d-none" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
	...
	<div class="col-sm-6" align="right">
		<h:outputLabel  styleClass="h6 text-secondary"  id="lbl_asset_in_ultvist" for="asset_in_ultvist"  value="#{iimsg.AssetVhpax_asset_in_ultvist_tt}"/>
		<h:inputHidden id="asset_in_ultvist_bol" value="#{cadAssetVhpaxBean.asset_in_ultvist}"/>
		<h:selectBooleanCheckbox id="asset_in_ultvist" tabindex="13"  value="#{cadAssetVhpaxBean.asset_in_ultvist_bol}" onclick="chkBoolean(this, 'cadForm:asset_in_ultvist_bol');"/>
	</div>
...
<h:outputText id="hd_asset_nu_ident_tt_xide" title="#{iimsg.AssetVhpax_asset_nu_ident_tt}" value="#{iimsg.AssetVhpax_asset_nu_ident_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_nu_tt_xide" title="#{iimsg.AssetVhpax_asset_nu_tt}" value="#{iimsg.AssetVhpax_asset_nu_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_cd_serie_tt_xide" title="#{iimsg.AssetVhpax_asset_cd_serie_tt}" value="#{iimsg.AssetVhpax_asset_cd_serie_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_tp_propriedade_tt" title="#{iimsg.AssetVhpax_asset_tp_propriedade_tt}" value="#{iimsg.AssetVhpax_asset_tp_propriedade_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_corredor_tt" title="#{iimsg.AssetVhpax_asset_cd_corredor_tt}" value="#{iimsg.AssetVhpax_asset_cd_corredor_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_px_local_vistoria_tt" title="#{iimsg.AssetVhpax_asset_px_local_vistoria_tt}" value="#{iimsg.AssetVhpax_asset_px_local_vistoria_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_dt_vistoria_tt_xide" title="#{iimsg.AssetVhpax_asset_dt_vistoria_tt}" value="#{iimsg.AssetVhpax_asset_dt_vistoria_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_nu_imobilizado_tt_xide" title="#{iimsg.AssetVhpax_asset_nu_imobilizado_tt}" value="#{iimsg.AssetVhpax_asset_nu_imobilizado_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_cd_plaqueta_erp_tt_xide" title="#{iimsg.AssetVhpax_asset_cd_plaqueta_erp_tt}" value="#{iimsg.AssetVhpax_asset_cd_plaqueta_erp_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_proprietaria_erp_tt" title="#{iimsg.AssetVhpax_asset_cd_proprietaria_erp_tt}" value="#{iimsg.AssetVhpax_asset_cd_proprietaria_erp_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_vl_aquisicao_tt_xide" title="#{iimsg.AssetVhpax_asset_vl_aquisicao_tt}" value="#{iimsg.AssetVhpax_asset_vl_aquisicao_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_vl_deprec_mensal_tt_xide" title="#{iimsg.AssetVhpax_asset_vl_deprec_mensal_tt}" value="#{iimsg.AssetVhpax_asset_vl_deprec_mensal_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_vl_deprec_acumulada_tt_xide" title="#{iimsg.AssetVhpax_asset_vl_deprec_acumulada_tt}" value="#{iimsg.AssetVhpax_asset_vl_deprec_acumulada_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_vl_contabil_tt_xide" title="#{iimsg.AssetVhpax_asset_vl_contabil_tt}" value="#{iimsg.AssetVhpax_asset_vl_contabil_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenTransGen -->
...
<h:outputText id="hd_asset_images_ongrid_tt_xide" title="#{iimsg.AssetVhpax_asset_images_ongrid_tt}" value="#{iimsg.AssetVhpax_asset_images_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
...
<h:outputText id="hd_asset_docs_ongrid_tt_xide" title="#{iimsg.AssetVhpax_asset_docs_ongrid_tt}" value="#{iimsg.AssetVhpax_asset_docs_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenTransGen -->
...
<h:outputText id="hd_asset_geo_ongrid_tt_xide" title="#{iimsg.AssetVhpax_asset_geo_ongrid_tt}" value="#{iimsg.AssetVhpax_asset_geo_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- recdWdColumnGen -->
...
<!-- Dados -->
<h:dataTable
value="#{cadAssetVhpaxBean.pesqData}"
var="Asset"
binding="#{cadAssetVhpaxBean.pesqTable}"
rowClasses="tre9mod, tro9mod"
headerClass="tbh9"
footerClass="tbf9"
id="dtDados"
rows="#{cadAssetVhpaxBean.pageLength}"
first="#{cadAssetVhpaxBean.currentLine}">
<!-- propColumnGen -->
<h:column id="asset_nu_ident">
...
<h:commandButton id="flag_imgrecd_wd_asset_images_ongrid" action="#{cadObimgBean.doObternull}"  image="imagens/picture2.png"  onmousedown="wtran='obimgcad';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_asset_idasset_images_ongrid_bt').value;el('fiiSaveType').src = 'iiSaveType.jsp?tbak=assetvhpaxpsq&tipo='+wtran+'&valor='+valor1;" onmouseup="this.form.target='_blank';" onblur="this.form.target='_self';"/>
</h:panelGroup>
</h:column>
<!-- buttonOpenChildTransGen -->
<h:column id="asset_docs_ongrid_bt">
...
<h:commandButton id="flag_imgrecd_wd_asset_docs_ongrid" action="#{cadObdocBean.doSelecionar}" image="imagens/folder.png" onmousedown="wtran='obdocpsq';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_asset_idasset_docs_ongrid_bt').value;el('fiiSaveTypex').src = 'iiSaveTypex.jsp?tbak=assetvhpaxpsq&tipo='+wtran+'&valor='+valor1;el('fiiSaveField').src='iiSaveField.jsp?campo=campo1&valor='+valor1;" onmouseup="this.form.target='_blank';" onblur="this.form.target='_self';"/>
</h:panelGroup>
</h:column>
<!-- buttonOpenTransGen -->
<h:column id="asset_geo_ongrid_bt">
...
<h:outputLink id="flag_imggeo_asset_geo_ongrid" value="mapa.jsp?bp=" target="_blank" onclick="aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_asset_idasset_geo_ongrid_bt').value;valor1=valor1.slice(0,valor1.length - 5);this.href='mapa.jsp?bp='+valor1+'&type=VP';">
...
<!-- REC-30-->  <h:commandButton id="flag_imgrecd_wd" image="../imagens/file.png"  action="#{cadAssetVhpaxBean.doObternullSearchBack}" onmousedown="wtran='assetvhpaxcad';aa=this.id.slice(0,this.id.search('flag_img'));valor1=rpel(aa+'sel_asset_id');selDtTableOneRow(aa);el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1;"/>
</h:panelGroup>
</h:column>
<!-- propSearchChildTableGen -->
</h:dataTable>
...
<!-- Conteudo -->
<iframe id="AssetVhpax" width="0" height="0" frameborder="0"> </iframe>
...
<iframe id="InvtyVP" width="0" height="0" frameborder="0"> </iframe>
<iframe id="InvtyVP" width="0" height="0" frameborder="0"> </iframe>
...
<h:commandLink id="xrec_obob" action="#{cadAssetVhpaxBean.doObternull}" immediate="true"/>
<h:commandLink id="xrec_obnv" action="#{cadAssetVhpaxBean.doNovo}" immediate="true"/>
...
<h:commandLink id="xsel_invtyvp" action="#{cadInvtyVPBean.doSelecionar}" immediate="true"/>
<h:commandLink id="xrec_invtyvp" action="#{cadInvtyVPBean.doObternull}" immediate="true"/>
<h:commandLink id="xnew_invtyvp" action="#{cadInvtyVPBean.doObternull}" immediate="true"/>
