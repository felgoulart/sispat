...
<%
    ...
    //Scriplet JSP igual a java
    String src = "";
	String pk = "asset_id";
    String ds = "asset_cd_geourl";
    ...
    if (dsvl == null) {dsvl = "sys_notfound";}
    System.out.println("dsvl: "+dsvl);
    if (dsvl.indexOf("sys_notfound") >= 0) {
    	src = "";
   	} else { 
   	    final char data[] = {'"'};
   	    final String dq = new String(data);
...
<body bgcolor="D4DDE6">
	<div >
		<iframe  bgcolor="D4DDE6" allowtransparency="true" width="425" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="<%=src%>"></iframe>
	</div>
</body>
</html>