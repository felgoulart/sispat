...
arAbas[2] = new stAba('aba_pjdet','abc_pjdet','flg_pjdet','u','a','aba_pjdet');
...
<title><h:outputText value="#{cadPjausPapusBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();"  onload="window.focus();loading();PjausPapus_hl();ufmvini();tran='pjauspapuscad';cadbeanx='cadPjausPapusBean'; loadPage(<%= request.getAttribute("pagina") %>); AlternarAbas(parent.cadbeanx, <%=(Object)session.getAttribute(("cadPjausPapusBeanx"))%>);AlternarSubAbas();">
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspapuspsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadPjausPapusBean.doSelecionarNullOnly}"/>
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspapuscad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadPjausPapusBean.doReturnMenu}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadPjausPapusBean.canUpdate}" image="../imagens/btSave.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspapuscad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadPjausPapusBean.doUpdate}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadPjausPapusBean.canUpdate}" image="../imagens/btCancel.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadPjausPapusBean.doCancelar}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadPjausPapusBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadPjausPapusBean.doExcluir}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}"  action="#{cadPjausPapusBean.doObter}"  onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspapuscad'+'&ufmv='+stx"/>
...
<h:commandButton id="aHelpPjausRfm" tabindex="-1" immediate="true" rendered="#{cadPjausPapusBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'PjausRfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:commandButton id="aClose" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
<h:inputHidden id="tabsvf" value="#{cadPjausPapusBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadPjausPapusBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadPjausPapusBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadPjausPapusBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadPjausPapusBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadPjausPapusBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadPjausPapusBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadPjausPapusBean.xmesg_st}" />
...
<h:outputText value="#{iimsg.PjausPapus_D00_REGISTER_UV_st}"/>
</h:outputLink>
</td>
<td width="" id="aba_pjdet" style="display: none">
<A href="#" onclick="msgwv('xsel_vali')"><img id="flg_pjdet" class="btp" align="absmiddle" style="padding:5px; float:left" /></A>
<h:outputLink value="#" onclick="AlternarAbas(parent.cadbeanx, 2);" styleClass="mnt">
<h:outputText value="#{iimsg.PjausPapus_D00_DETAIL_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.PjausPapus_D00_ANALISE_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.PjausPapus_D00_CONTRACT_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.PjausPapus_D00_REQUEST_UV_st}"/>
</h:outputLink>
</td>
...
<%@include file="PjausPapuscadpjtrg.jsp"%>
</div>
<!-- UV-UV-Stubs/MV D00_DETAIL_UV-->
<div id="abc_pjdet" style="display: none">
<%@include file="PjausPapuscadpjdet.jsp"%>
</div>
<!-- UV-UV-Stubs/MV D00_ANALISE_UV-->
<div id="abc_pjana" style="display: none">
<%@include file="PjausPapuscadpjana.jsp"%>
</div>
<!-- UV-UV-Stubs/MV D00_CONTRACT_UV-->
<div id="abc_pjtct" style="display: none">
<%@include file="PjausPapuscadpjtct.jsp"%>
</div>
<!-- UV-UV-Stubs/MV D00_REQUEST_UV-->
<div id="abc_pjtrq" style="display: none">
<%@include file="PjausPapuscadpjtrq.jsp"%>
</div>
<!-- D00_NOTR -->
...
<h:commandLink id="xsel_vali" action="#{cadPjausPapusBean.doValidate}" immediate="true"/>
...
<!-- for fkstransGen -->
<h:commandLink id="xsel_ObxlsPapus" action="#{cadObxlsPapusBean.doSelecionarOnly}" immediate="true"/>
