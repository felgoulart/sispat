...
<link rel="stylesheet" href="../Obdocpjpsq.css" type="text/css">
...
<body onload="window.focus();loadPage();loading();helpcd='ObdocpjSfm';;tran='obdocpjpsq'; vl='';cadbeanx='cadObdocpjBean';<%session.setAttribute("tipo","obdocpjpsq");%>">
<h:form id="cadForm">
...
<h:commandButton id="aBackToSearch" styleClass="btp" rendered="#{cadObdocpjBean.goBackx}" image="../imagens/btVoltar.gif" onmousedown="document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauscad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadPjausBean.doObterBack}"/>
<h:commandButton id="aBackToSearchx" styleClass="btp" rendered="#{cadObdocpjBean.goBackxx}" image="../imagens/btVoltar.gif" onmousedown="document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjhsogpxcadcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadPjhsogpxBean.doObter}"/>
<h:commandButton id="aBackToSearchMenu" styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obdocpjcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadObdocpjBean.doReturnMenu}"/>
<h:commandButton id="aPrev" styleClass="btp"  image="../imagens/btPgAnterior.gif" title="#{iimsg.botao_anterior}" rendered="#{cadObdocpjBean.hasPrevPage}" action="#{cadObdocpjBean.doPaginaAnterior}"/>
<h:commandButton id="aNext" styleClass="btp"  image="../imagens/btPgProxima.gif" title="#{iimsg.botao_proxima}" rendered="#{cadObdocpjBean.hasNextPage}" action="#{cadObdocpjBean.doProximaPagina}"/>
<h:outputText id="label_fill" style="display:none" value="#{iimsg.label_fill}" />
<h:outputText id="label_notfound" style="display:none" value="#{iimsg.label_notfound}" />
<h:outputText id="sys_openning_form" style="display:none" value="#{iimsg.sys_openning_form}" />
<h:commandButton id="aFiltrar" styleClass="btp"  image="../imagens/btFilter.gif" title="#{iimsg.botao_filtrar}" action="#{cadObdocpjBean.doSelecionar}"/>
<h:commandButton id="aLimpar" styleClass="btp" rendered="#{cadObdocpjBean.canPesquisar}" image="../imagens/btCancel.gif" title="#{iimsg.botao_limpar}" action="#{cadObdocpjBean.doLimparPesq}"/>
<h:commandButton id="aNew" styleClass="btp" rendered="#{cadObdocpjBean.canInserir}" image="../imagens/btNew.gif" onmousedown="fNovorwpp('obdocpjcad', tran, this.id, 'yes', fPgAssist());" title="#{iimsg.botao_novo}" action="#{cadObdocpjBean.doNovoUpload}"/>
...
<h:commandButton id="aHelpObdocpjSfm" tabindex="-1" rendered="#{cadObdocpjBean.hasHelpSpcSfm}" immediate="true" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes','ObdocpjSfm');" image="../imagens/btHelpSpc.gif"/>
...
<h:outputLabel  styleClass="tip txr pl0"  id="lbl_obdocpj_id" for="obdocpj_id"  title="#{iimsg.Obdocpj_obdocpj_id_tt}"  value="#{iimsg.Obdocpj_obdocpj_id_tt}"/>  </td> <%-- <top> --%>
<td      width="400" >
<h:inputText id="obdocpj_id" tabindex="-1" readonly="true" value="#{cadObdocpjBean.obdocpj_id}" size="20" maxlength="20" onkeydown="keypress=1;"  styleClass="tbxr"/>
<h:commandLink id="obdocpj_id_desc" value="#{cadObdocpjBean.obdocpj_id_desc}" styleClass="dsp"  onmousedown="pwfk('assetcad', tran, this.id, 'no')"/>
</td> <%-- <close td> pKey --%>
<td   > <h:commandButton id="AnnexFilesFromSList" title="#{iimsg.Obdocpj_AnnexFilesFromSList_tt}" value="#{iimsg.Obdocpj_AnnexFilesFromSList_ta}" styleClass="btnBox160"  action="#{cadObdocpjBean.AnnexFilesFromSList}" onmousedown="ckbSelListx__a('obdocpj_nm_file')"/>
<h:inputHidden id="selection_list_var" value="#{cadObdocpjBean.selection_list_var}"/>
<td   ><h:outputLabel  styleClass="tip txl pl0"  id="lbl_p_seltype" for="p_seltype"  value="#{iimsg.Obdocpj_p_seltype_tt}"/>
</td> <%-- <close td> selectBoolean --%>
<td   width="200"   >
<h:inputHidden id="p_seltype_bol" value="#{cadObdocpjBean.p_seltype}"/>
<h:selectBooleanCheckbox id="p_seltype" value="#{cadObdocpjBean.p_seltype_bol}" onclick="chkBoolean(this, 'cadForm:p_seltype_bol');"/>
</td> <%-- <close td> selectBoolean --%>
</td> <%-- <close td> Button --%>
</tr> <%-- <tr close> pKey--%>
...
<h:inputText id="mesg_var" value="#{cadObdocpjBean.mesg_var}"  styleClass="txrr pr5 tb600r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> msg --%>
<td> &nbsp&nbsp </td>
<td      width="50" > <%-- open w/ inputText 222--%>
<%-- outputLabel msg --%>
...
<%-- outputText --%>
<td    width="100" > <h:inputText id="codfqt" onfocus="this.blur()" value="#{cadObdocpjBean.codfqt}" size="5" maxlength="5"  styleClass="txl pl5 tbxr"/>
</td> <%-- <close td> msg --%>
</tr> <%-- <tr close> msg--%>
...
<!--   // 444-->
<h:inputText id="obdocpj_cd_solct_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('obcntpjselpsq', tran, this.id, 'no', vl);" onblur="cfb(this.id, 'pfdb9', 'pfd9');" onfocus="this.className='pfd9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadObdocpjBean.fil_obdocpj_cd_solct}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- fkeyColumnGen -->
...
<!--   // 444-->
<h:inputText id="obdocpj_cd_destino_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('obcntpjselpsq', tran, this.id, 'no', vl);" onblur="cfb(this.id, 'pfdb9', 'pfd9');" onfocus="this.className='pfd9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadObdocpjBean.fil_obdocpj_cd_destino}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="obdocpj_vc_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadObdocpjBean.fil_obdocpj_vc}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- recdWdColumnGen -->
...
<!-- Dados -->
<h:dataTable
value="#{cadObdocpjBean.pesqData}"
var="Obdocpj"
binding="#{cadObdocpjBean.pesqTable}"
rowClasses="tre9, tro9"
headerClass="tbh9"
footerClass="tbf9"
id="dtDados"
rows="#{cadObdocpjBean.pageLength}"
first="#{cadObdocpjBean.currentLine}">
<!-- codfColumnGen -->
...
<h:commandLink id="flag_imgObdocpj" onmousedown="wtran='obdocpjcad';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_obdocpj_id').value;valor2=el(aa+'sel_obdocpj_sq').value;el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1+','+valor2;showpopup(tran,'xrec_obob',this.id,wtran,'yes');">
...
<h:commandLink id="xrec_obnv" action="#{cadObdocpjBean.doObterParentForCancel}" immediate="true"/>
