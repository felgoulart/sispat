...
<title><h:outputText value="#{cadHelpdtrBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();" onload="window.focus();loading();ufmvini();tran='helpdtrcad';cadbeanx='cadHelpdtrBean';loadPage(<%= request.getAttribute("pagina") %>);">
...
<h:outputText value=":"/>
<h:outputText value="#{cadHelpdtrBean.help_nm}"/>
</td>
...
<h:commandButton id="aHelpHelpdtrRfm" tabindex="-1" immediate="true" rendered="#{cadHelpdtrBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'HelpdtrRfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:commandButton id="aClose" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
<h:inputHidden id="tabsvf" value="#{cadHelpdtrBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadHelpdtrBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadHelpdtrBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadHelpdtrBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadHelpdtrBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadHelpdtrBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadHelpdtrBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadHelpdtrBean.xmesg_st}" />
...
<td   colspan="2"    >
<h:inputText id="mesg_var" value="#{cadHelpdtrBean.mesg_var}"  styleClass="txrr pr5 tb450r" tabindex="-1" readonly="true"/>
<ps:psCommandLink id="aMessage" rendered="#{cadHelpdtrBean.canUpdate}" action="#{cadHelpdtrBean.doValidate}" onmousedown="msgw('aMessage');">
...
<%-- outputLabel aaa --%>
<h:outputLabel  styleClass="tip txl pl0"  id="lbl_help_cd" for="help_cd"  value="#{iimsg.Helpdtr_help_cd_tt}"/>  </td> <%-- <top> --%>
<%-- prop Primary Key --%>
<%-- Processing Pk --%>
<%-- Processing Pk ccc --%>
<td  width="200" > <h:inputText id="help_cd" tabindex="-1"  readonly="true" value="#{cadHelpdtrBean.help_cd}"  styleClass="txl pl5 tbxr" size="20" maxlength="20"/>
</td> <%-- <close td> ccc --%>
<%-- Hidden --%>
<h:inputHidden id="help_lg" value="#{cadHelpdtrBean.help_lg}"/>
<%-- Hidden --%>
<h:inputHidden id="help_tp" value="#{cadHelpdtrBean.help_tp}"/>
<%-- Hidden --%>
<h:inputHidden id="help_st" value="#{cadHelpdtrBean.help_st}"/>
<%-- inputText --%>
<%-- nowrap 5676 --%>
<td  colspan ="2" width="520"   >
<h:inputText id="help_nm" tabindex="-1"  readonly="true" value="#{cadHelpdtrBean.help_nm}" size="100" maxlength="100"  styleClass="txl pl5 tbxr"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
...
<tr>   <%-- <tr open> vvv --%>
<%-- inputTextArea --%>
<td   colspan="4" >  <h:inputTextarea id="help_ds" tabindex="3"  value="#{cadHelpdtrBean.help_ds}" cols="100" rows="33" styleClass="help_ds_rtfReadOnly"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
...
<h:commandLink id="xsel_vali" action="#{cadHelpdtrBean.doValidate}" immediate="true"/>
