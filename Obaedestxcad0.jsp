...
<%session.setAttribute("cadbeanx","cadObaedestxBean");%>
...
<title><h:outputText value="#{cadObaedestxBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();" onload="window.focus();loading();ufmvini();tran='obaedestcad';cadbeanx='cadObaedestxBean';loadPage(<%= request.getAttribute("pagina") %>);">
...
<h:outputText value="#{cadObaedestxBean.trans_tt}"/>
</td>
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obaedestxpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadObaedestxBean.doSelecionarBackx}"/>
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obaedestxcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadObaedestxBean.doReturnMenu}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadObaedestxBean.canUpdate}" image="../imagens/btSave.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obaedestcad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadObaedestxBean.doUpdate1Chld}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadObaedestxBean.canUpdate}" image="../imagens/btNew.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadObaedestxBean.doObterParentForCancel}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadObaedestxBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadObaedestxBean.doExcluirChld}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}"  action="#{cadObaedestxBean.doObter}"  onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obaedestcad'+'&ufmv='+stx"/>
...
<h:inputHidden id="tabsvf" value="#{cadObaedestxBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadObaedestxBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadObaedestxBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadObaedestxBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadObaedestxBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadObaedestxBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadObaedestxBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadObaedestxBean.xmesg_st}" />
...
<td   colspan="2"    >
<h:inputText id="mesg_var" value="#{cadObaedestxBean.mesg_var}"  styleClass="txrr pr5 tb450r" tabindex="-1" readonly="true"/>
<h:commandButton id="aMessage" image="../imagens/btMessage_off.gif" styleClass="btp" title="#{iimsg.botao_message}" rendered="#{cadObaedestxBean.canUpdate}" action="#{cadObaedestxBean.doValidate}" onmousedown="msgw('aMessage');"/>
</td> <%-- <close td> bbb --%>
</tr> <%-- <tr close> bbb --%>
<tr>   <%-- <tr open> vvv --%>
...
<%-- Processing Fk --%>
<%-- Processing Fk 333--%>
<h:inputText id="obaed_id" tabindex="-1"  onclick="clf(this);" readonly="true" value="#{cadObaedestxBean.obaed_id}"  styleClass="tbxr" onkeydown="keypress=1;" size="20" maxlength="20" />
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
<%-- prop Primary Key --%>
<%-- Processing Pk --%>
<h:inputHidden id="obaed_sq" value="#{cadObaedestxBean.obaed_sq}"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<h:inputText  id="obaed_tp" onclick="clf(this);" value="#{cadObaedestxBean.obaed_tp}" onkeydown="keypress=1;"  styleClass="tbx" onchange="bdcd('','obaed_tp','0','TPAED',this.value);;" size="7" maxlength="5" tabindex="1" />
...
<ps:psGraphicImage id="obaed_tp_vc" flagType="val" flag="#{cadObaedestxBean.obaed_tp_vc}" styleClass="btp"/>
<%-- Processing Codf 1 AAA --%>
<h:inputText id="obaed_tp_desc" tabindex="-1" onfocus="this.blur()" value="#{cadObaedestxBean.obaed_tp_desc}" styleClass="txlr pr5 tb90r"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<%-- Processing Codf 1--%>
<%-- Processing Codf 1 HLFN --%>
<h:inputText  id="obaed_vl" onclick="clf(this);" value="#{cadObaedestxBean.obaed_vl}" onkeydown="keypress=1;"  styleClass="tbx" onchange="bdcd('','obaed_vl','0','ANEST',this.value);;" size="7" maxlength="5" tabindex="2" />
...
<ps:psGraphicImage id="obaed_vl_vc" flagType="val" flag="#{cadObaedestxBean.obaed_vl_vc}" styleClass="btp"/>
<%-- Processing Codf 1 AAA --%>
<h:inputText id="obaed_vl_desc" tabindex="-1" onfocus="this.blur()" value="#{cadObaedestxBean.obaed_vl_desc}" styleClass="txlr pr5 tb90r"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<!-- D00_NOTR -->
...
<h:commandLink id="xsel_vali" action="#{cadObaedestxBean.doValidate}" immediate="true"/>
<h:commandLink id="xsel_codf" action="#{cadCodfBean.doSelecionarOnly}" immediate="true"/>
<h:commandLink id="xrec_obob" action="#{cadObaedestxBean.doObternull}" immediate="true"/>
...
<!-- for current oabv -->
<h:commandLink id="xsel_obaedest" action="#{cadObaedestxBean.doSelecionar}" immediate="true"/>
<h:commandLink id="xrec_obaedest" action="#{cadObaedestxBean.doObternull}" immediate="true"/>
</h:form>
