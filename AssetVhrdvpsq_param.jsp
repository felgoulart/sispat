...
<div class="containermod expand-max bg-transparent mt-3 mb-3">
  ...
  <div class="row text-left">
	...
	<div class="col-sm-2">
		<h:outputLabel  styleClass="h6"  id="lbl_asset_in_ultvist" for="asset_in_ultvist"  value="#{iimsg.AssetVhrdv_asset_in_ultvist_tt}"/>
	</div>
	<div class="col-sm-2">
	  <div class="input-group input-group-sm mb-2">
	   
		<h:inputHidden id="asset_in_ultvist_bol" value="#{cadAssetVhrdvBean.asset_in_ultvist}"/>
		<h:selectBooleanCheckbox id="asset_in_ultvist" tabindex="11"  value="#{cadAssetVhrdvBean.asset_in_ultvist_bol}" onclick="chkBoolean(this, 'cadForm:asset_in_ultvist_bol');"/>
	   </div>
	   </div>
