...
<title><h:outputText value="#{cadAssetViadtBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();"  onload="window.focus();loading();ufmvini();tran='assetviadtcad';cadbeanx='cadAssetViadtBean'; loadPage(<%= request.getAttribute("pagina") %>); AlternarAbas(parent.cadbeanx, <%=(Object)session.getAttribute(("cadAssetViadtBeanx"))%>);AlternarSubAbas();">
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetviadtpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadAssetViadtBean.doSelecionar}"/>
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetviadtcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadAssetViadtBean.doReturnMenu}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadAssetViadtBean.canUpdate}" image="../imagens/btSave.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetviadtcad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadAssetViadtBean.doUpdate}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadAssetViadtBean.canUpdate}" image="../imagens/btNew.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadAssetViadtBean.doCancelar}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadAssetViadtBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadAssetViadtBean.doExcluir}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}"  action="#{cadAssetViadtBean.doObter}"  onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetviadtcad'+'&ufmv='+stx"/>
...
<h:commandButton id="aHelpAssetComRfm" tabindex="-1" immediate="true" rendered="#{cadAssetViadtBean.hasHelpComRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'AssetComRfm');" image="../imagens/btHelpCom.gif"/>
<h:commandButton id="aHelpAssetObratRfm" tabindex="-1" immediate="true" rendered="#{cadAssetViadtBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'AssetObratRfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:commandButton id="aClose" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
<h:inputHidden id="tabsvf" value="#{cadAssetViadtBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadAssetViadtBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadAssetViadtBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadAssetViadtBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadAssetViadtBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadAssetViadtBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadAssetViadtBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadAssetViadtBean.xmesg_st}" />
...
<h:outputText id="sys_confirm" style="display:none" value="#{iimsg.AssetViadt_sys_confirm_tt}" />
</td>
...
<h:outputText value="#{iimsg.AssetViadt_D00_REGISTER_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetViadt_D00_LOCATION_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetViadt_D00_ATTRIBUTES_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetViadt_D00_SURVEY_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetViadt_D00_OCCUPDOC_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetViadt_D00_EVALUATION_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetViadt_D00_EXPERTS_UV_st}"/>
</h:outputLink>
</td>
...
<iframe id="fInvtyVDsak" width="0" height="0" frameborder="0"> </iframe>
<iframe id="fInvtyVDsfk" width="0" height="0" frameborder="0"> </iframe>
<iframe id="InvtyVD" width="0" height="0" frameborder="0"> </iframe>
<iframe id="invty" width="0" height="0" frameborder="0"> </iframe>
<iframe id="fInvtyVDsak" width="0" height="0" frameborder="0"> </iframe>
<iframe id="fInvtyVDsfk" width="0" height="0" frameborder="0"> </iframe>
...
<h:commandLink id="xsel_vali" action="#{cadAssetViadtBean.doValidate}" immediate="true"/>
...
<h:commandLink id="xsel_invtyvd" action="#{cadInvtyVDBean.doSelecionarOnly}" immediate="true"/>
