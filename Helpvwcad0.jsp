...
<title><h:outputText value="#{cadHelpvwBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();" onload="window.focus();loading();ufmvini();tran='helpvwcad';cadbeanx='cadHelpvwBean';loadPage(<%= request.getAttribute("pagina") %>);">
...
<h:outputText value=":"/>
<h:outputText value="#{cadHelpvwBean.help_nm}"/>
</td>
...
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'helpvwcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadHelpvwBean.doReturnMenu}"/>
<h:commandButton id="aHelpHelpvwRfm" tabindex="-1" immediate="true" rendered="#{cadHelpvwBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'HelpvwRfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:commandButton id="aClose" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
<h:inputHidden id="tabsvf" value="#{cadHelpvwBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadHelpvwBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadHelpvwBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadHelpvwBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadHelpvwBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadHelpvwBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadHelpvwBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadHelpvwBean.xmesg_st}" />
...
<td   colspan="2"    >
<h:inputText id="mesg_var" value="#{cadHelpvwBean.mesg_var}"  styleClass="txrr pr5 tb450r" tabindex="-1" readonly="true"/>
<h:commandButton id="aMessage" image="../imagens/btMessage_off.gif" styleClass="btp" title="#{iimsg.botao_message}" rendered="#{cadHelpvwBean.canUpdate}" action="#{cadHelpvwBean.doValidate}" onmousedown="msgw('aMessage');"/>
</td> <%-- <close td> bbb --%>
</tr> <%-- <tr close> bbb --%>
...
<%-- outputLabel aaa --%>
<h:outputLabel  styleClass="tip txl pl0"  id="lbl_help_cd" for="help_cd"  value="#{iimsg.Helpvw_help_cd_tt}"/>  </td> <%-- <top> --%>
<%-- prop Primary Key --%>
<%-- Processing Pk --%>
<%-- Processing Pk ccc --%>
<td  width="200" > <h:inputText id="help_cd" tabindex="-1"  readonly="true" value="#{cadHelpvwBean.help_cd}"  styleClass="txl pl5 tbxr" size="35" maxlength="35"/>
</td> <%-- <close td> ccc --%>
<%-- Hidden --%>
<h:inputHidden id="help_lg" value="#{cadHelpvwBean.help_lg}"/>
<%-- Hidden --%>
<h:inputHidden id="help_tp" value="#{cadHelpvwBean.help_tp}"/>
<%-- Hidden --%>
<h:inputHidden id="help_st" value="#{cadHelpvwBean.help_st}"/>
<%-- inputText --%>
<%-- nowrap 5676 --%>
<td  colspan ="2" width="520"   >
<h:inputText id="help_nm" tabindex="-1"  readonly="true" value="#{cadHelpvwBean.help_nm}" size="100" maxlength="100"  styleClass="txl pl5 tbxr"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
...
<tr>   <%-- <tr open> vvv --%>
<%-- inputTextArea --%>
<td   colspan="4" >  <h:inputTextarea id="help_ds" tabindex="3"  value="#{cadHelpvwBean.help_ds}" cols="100" rows="33" styleClass="help_ds_rtfReadOnly"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
...
<h:commandLink id="xsel_vali" action="#{cadHelpvwBean.doValidate}" immediate="true"/>
