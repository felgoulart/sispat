...
<title><h:outputText value="#{cadHelpBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();" onload="window.focus();loading();ufmvini();tran='helpcad';cadbeanx='cadHelpBean';loadPage(<%= request.getAttribute("pagina") %>);">
...
<h:outputText value=":"/>
<h:outputText value="#{cadHelpBean.help_nm}"/>
</td>
...
<h:commandButton id="aHelpHelpRfm" tabindex="-1" immediate="true" rendered="#{cadHelpBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'HelpRfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:commandButton id="aClose" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
<h:inputHidden id="tabsvf" value="#{cadHelpBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadHelpBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadHelpBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadHelpBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadHelpBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadHelpBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadHelpBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadHelpBean.xmesg_st}" />
...
<td   colspan="2"    >
<h:inputText id="mesg_var" value="#{cadHelpBean.mesg_var}"  styleClass="txrr pr5 tb450r" tabindex="-1" readonly="true"/>
<ps:psCommandLink id="aMessage" rendered="#{cadHelpBean.canUpdate}" action="#{cadHelpBean.doValidate}" onmousedown="msgw('aMessage');">
...
<%-- outputLabel aaa --%>
<h:outputLabel  styleClass="tip txl pl0"  id="lbl_help_cd" for="help_cd"  value="#{iimsg.Help_help_cd_tt}"/>  </td> <%-- <top> --%>
<%-- prop Primary Key --%>
<%-- Processing Pk --%>
<%-- Processing Pk ccc --%>
<td  width="200" > <h:inputText id="help_cd" tabindex="-1"  readonly="true" value="#{cadHelpBean.help_cd}"  styleClass="txl pl5 tbxr" size="35" maxlength="35"/>
</td> <%-- <close td> ccc --%>
<%-- Hidden --%>
<h:inputHidden id="help_lg" value="#{cadHelpBean.help_lg}"/>
<%-- Hidden --%>
<h:inputHidden id="help_tp" value="#{cadHelpBean.help_tp}"/>
<%-- Hidden --%>
<h:inputHidden id="help_st" value="#{cadHelpBean.help_st}"/>
<%-- inputText --%>
<%-- nowrap 5676 --%>
<td  colspan ="2" width="520"   >
<h:inputText id="help_nm" tabindex="-1"  readonly="true" value="#{cadHelpBean.help_nm}" size="100" maxlength="100"  styleClass="txl pl5 tbxr"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
...
<tr>   <%-- <tr open> vvv --%>
<%-- inputTextArea --%>
<td   colspan="4" >  <h:inputTextarea id="help_ds" tabindex="3"  value="#{cadHelpBean.help_ds}" cols="100" rows="33" styleClass="help_ds_rtfReadOnly"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
...
<h:commandLink id="xsel_vali" action="#{cadHelpBean.doValidate}" immediate="true"/>
