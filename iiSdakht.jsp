...
<%
  ...
  if ( ch.equals("") ) {
      ch = "x";
      jscampo="cadForm:"+field2+"_desc";
      jscampo1="cadForm:"+field;
      jscampo2="cadForm:"+field2;
  } else if ( ch.equals("t") ) {
      ch = "x";
      jscampo="cadForm:dtDados:"+field2+"_desc";
      jscampo1="cadForm:dtDados:"+field;
      jscampo2="cadForm:dtDados:"+field2;
  } else {
...
<script  type="text/javascript"  >
    parent.if_pel('<%= jscampo1 %>', '<%= valor_hidden %>');
    parent.if_pel('<%= jscampo2 %>', '<%= valor %>');
    parent.if_pel('<%= jscampo %>', '<%= descricao %>');
