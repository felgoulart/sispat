...
<table width="100%" height="25" border="0" cellspacing="0" cellpadding="0" background="imagens/pixel_barra.gif">
  <tr>
    <td nowrap="nowrap" valign="middle" class="txtSystem">&nbsp; <h:outputText value="#{iimsg.sys_header}"/> &nbsp;</td>
    <td nowrap="nowrap" valign="middle" class="txtSystem" align="right">&nbsp;<%=tipotran%>&nbsp;<h:outputText value="#{cadHelpBean.help_cd}"/>&nbsp;<h:outputText value="|"/>&nbsp;<h:outputText value="#{iimsg.lbl_usuario}"/> <%=func_login%>&nbsp;|&nbsp;<%=date%>&nbsp;</td>
  </tr>
</table>
