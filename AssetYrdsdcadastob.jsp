...
<h:inputText id="mesg_varastob" rendered="#{cadAssetYrdsdBean.canUpdate}" value="#{cadAssetYrdsdBean.mesg_var}"  styleClass="txrr pr5 tb450r" tabindex="-1" readonly="true"/>
<ps:psCommandLink id="aMessageastob" rendered="#{cadAssetYrdsdBean.canUpdate}" action="#{cadAssetYrdsdBean.doValidate}" onmousedown="msgw('aMessageastob');">
...
<h:outputText value="#{iimsg.AssetYrdsd_obsrv_tt_tt}"/>
</td>
...
<tr>  <%-- <tr open> vvv --%>
<%-- inputTextArea --%>
<td   colspan="4" >  <h:inputTextarea id="asset_ob" tabindex="71"  value="#{cadAssetYrdsdBean.asset_ob}" cols="100" rows="8" styleClass="rtfFontChoice" onchange="bv('','asset_ob','7',this.value);"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
