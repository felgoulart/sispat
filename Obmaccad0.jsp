...
<title><h:outputText value="#{cadObmacBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();" onload="window.focus();loading();ufmvini();tran='obmaccad';cadbeanx='cadObmacBean';loadPage(<%= request.getAttribute("pagina") %>);">
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obmacpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadObmacBean.doSelecionarBackx}"/>
<h:commandButton id="aBackToSearchPar" immediate="true"  styleClass="btp" image="../imagens/btReturnxParent.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obmacpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToParent_tt}" action="#{cadObmacBean.doReturn}"/>
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obmaccad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadObmacBean.doReturnMenu}"/>
<h:commandButton id="aPrev" immediate="true" styleClass="btp" rendered="#{cadObmacBean.idxflag}" image="../imagens/btPgAnterior.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_anterior}" action="#{cadObmacBean.doObternullPrev}"/>
<h:commandButton id="aNext" immediate="true" styleClass="btp" rendered="#{cadObmacBean.idxflag}" image="../imagens/btPgProxima.gif" onmousedown="msgwr()" title="#{iimsg.botao_proxima}" action="#{cadObmacBean.doObternullNext}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadObmacBean.canUpdate}" image="../imagens/btSave.gif"onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obmaccad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadObmacBean.doUpdate1Chld}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadObmacBean.canUpdate}" image="../imagens/btCancel.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadObmacBean.doObterParentForCancel}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadObmacBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadObmacBean.doExcluirChld}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}" action="#{cadObmacBean.doObter}" onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obmaccad'+'&ufmv='+stx"/>
...
<h:inputHidden id="tabsvf" value="#{cadObmacBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadObmacBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadObmacBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadObmacBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadObmacBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadObmacBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadObmacBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadObmacBean.xmesg_st}" />
...
<td   colspan="2"    >
<h:inputText id="mesg_var" value="#{cadObmacBean.mesg_var}"  styleClass="txrr pr5 tb450r" tabindex="-1" readonly="true"/>
<h:commandButton id="aMessage" image="../imagens/btMessage_off.gif" styleClass="btp" title="#{iimsg.botao_message}" rendered="#{cadObmacBean.canUpdate}" action="#{cadObmacBean.doValidate}" onmousedown="msgw('aMessage');"/>
<h:inputText id="idxm" value="#{cadObmacBean.idxm}"  styleClass="txrr pr5 tb50r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> bbb --%>
</tr> <%-- <tr close> bbb --%>
<tr>   <%-- <tr open> vvv --%>
...
<%-- Processing Fk --%>
<%-- Processing Fk 333--%>
<h:inputText id="obmac_id" tabindex="-1"  onclick="clf(this);" readonly="true" value="#{cadObmacBean.obmac_id}"  styleClass="tbxr" onkeydown="keypress=1;" size="20" maxlength="20" />
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
<%-- prop Primary Key --%>
<%-- Processing Pk --%>
<h:inputHidden id="obmac_sq" value="#{cadObmacBean.obmac_sq}"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<h:inputText id="obmac_dt_str" tabindex="1"  value="#{cadObmacBean.obmac_dt_str}"  styleClass="tbDt" size="14" maxlength="12" onkeydown="formataData('cadForm:obmac_dt_str', event);" onkeyup="SaltaCampo('cadForm:obmac_dt_str', 'cadForm:obmac_tp_acao', 8 , event);" onchange="validaDatas2(this);bv('','obmac_dt_str','0',this.value);"  />
<img src="../imagens/btCalendar.gif" onclick="mostraCalendario('cadForm:obmac_dt_str', 'obmac_dtCal');" style="cursor: hand"/>
<ps:psGraphicImage id="obmac_dt_vc" flagType="val" flag="#{cadObmacBean.obmac_dt_vc}" styleClass="btp"/>
...
<h:inputText  id="obmac_tp_acao" onclick="clf(this);" value="#{cadObmacBean.obmac_tp_acao}" onkeydown="keypress=1;"  styleClass="tbx" onchange="bdcd('','obmac_tp_acao','0','TPACO',this.value);;" size="7" maxlength="5" tabindex="2" />
...
<ps:psGraphicImage id="obmac_tp_acao_vc" flagType="val" flag="#{cadObmacBean.obmac_tp_acao_vc}" styleClass="btp"/>
<%-- Processing Codf 1 AAA --%>
<h:inputText id="obmac_tp_acao_desc" tabindex="-1" onfocus="this.blur()" value="#{cadObmacBean.obmac_tp_acao_desc}" styleClass="txlr pr5 tb90r"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<%-- inputTextArea --%>
<td  > <h:inputTextarea id="obmac_ds" tabindex="3"  value="#{cadObmacBean.obmac_ds}" cols="70" rows="10" styleClass="obmac_ds_" onchange="bv('','obmac_ds','0',this.value);"/>
<ps:psGraphicImage id="obmac_ds_vc" flagType="val" flag="#{cadObmacBean.obmac_ds_vc}" styleClass="btp"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<%-- Hidden --%>
<h:inputHidden id="obmac_tp_cfasttp" value="#{cadObmacBean.obmac_tp_cfasttp}"/>
<!-- D00_NOTR -->
...
<h:commandLink id="xsel_vali" action="#{cadObmacBean.doValidate}" immediate="true"/>
