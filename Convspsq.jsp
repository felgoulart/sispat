...
<body onload="window.focus();loadPage();loading();helpcd='ConvsSfm';;tran='convspsq'; vl='';cadbeanx='cadConvsBean';<%session.setAttribute("tipo","convspsq");%>">
<h:form id="cadForm">
...
<h:commandButton id="aBackToSearch" styleClass="btp" image="../imagens/btVoltar.gif" onmousedown="document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'impexcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadImpexBean.doObterBack}"/>
<h:commandButton id="aBackToSearchMenu" styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'convscad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadConvsBean.doReturnMenu}"/>
<h:commandButton id="aPrev" styleClass="btp"  image="../imagens/btPgAnterior.gif" title="#{iimsg.botao_anterior}" rendered="#{cadConvsBean.hasPrevPage}" action="#{cadConvsBean.doPaginaAnterior}"/>
<h:commandButton id="aNext" styleClass="btp"  image="../imagens/btPgProxima.gif" title="#{iimsg.botao_proxima}" rendered="#{cadConvsBean.hasNextPage}" action="#{cadConvsBean.doProximaPagina}"/>
<h:outputText id="label_fill" style="display:none" value="#{iimsg.label_fill}" />
<h:outputText id="label_notfound" style="display:none" value="#{iimsg.label_notfound}" />
<h:outputText id="sys_openning_form" style="display:none" value="#{iimsg.sys_openning_form}" />
<ps:psCommandLink id="aFiltrar" styleClass="btp"  ativo="../imagens/btFilter.gif" title="#{iimsg.botao_filtrar}" action="#{cadConvsBean.doSelecionar}">
<f:param name="campo8" value=""/>
<f:param name="tipo" value="convspsq"/>
</ps:psCommandLink>
<h:commandButton id="aLimpar" styleClass="btp" rendered="#{cadConvsBean.canPesquisar}" image="../imagens/btCancel.gif" title="#{iimsg.botao_limpar}" action="#{cadConvsBean.doLimparPesq}"/>
<ps:psCommandLink id="aNew" styleClass="btp" enabled="#{cadConvsBean.canInserir}" ativo="../imagens/btNew.gif"  disabled="" onmousedown="fNovorwpp('convscad', tran, this.id, 'yes', fPgAssist());" title="#{iimsg.botao_novo}" action="#{cadConvsBean.doObterParent}">
</ps:psCommandLink>
...
<h:commandButton id="aHelpConvsSfm" tabindex="-1" rendered="#{cadConvsBean.hasHelpSpcSfm}" immediate="true" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes','ConvsSfm');" image="../imagens/btHelpSpc.gif"/>
...
<h:outputLabel  styleClass="tip txr pl0"  id="lbl_convs_id_impex" for="convs_id_impex"  title="#{iimsg.Convs_convs_id_impex_tt}"  value="#{iimsg.Convs_convs_id_impex_tt}"/>  </td> <%-- <top> --%>
<td      width="400" >
<h:inputText id="convs_id_impex" tabindex="-1" readonly="true" value="#{cadConvsBean.convs_id_impex}" size="20" maxlength="20" onkeydown="keypress=1;"  styleClass="tbxr"/>
<h:commandLink id="convs_id_impex_desc" value="#{cadConvsBean.convs_id_impex_desc}" styleClass="dsp"  onmousedown="pwfk('assetcad', tran, this.id, 'no')"/>
</td> <%-- <close td> pKey --%>
</td> <%-- <close td> Button --%>
</tr> <%-- <tr close> pKey--%>
...
<h:inputText id="mesg_var" value="#{cadConvsBean.mesg_var}"  styleClass="txrr pr5 tb600r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> msg --%>
<td> &nbsp&nbsp </td>
<td      width="50" > <%-- open w/ inputText 222--%>
<%-- outputLabel msg --%>
...
<%-- outputText --%>
<td    width="100" > <h:inputText id="codfqt" onfocus="this.blur()" value="#{cadConvsBean.codfqt}" size="5" maxlength="5"  styleClass="txl pl5 tbxr"/>
</td> <%-- <close td> msg --%>
</tr> <%-- <tr close> msg--%>
...
<h:commandLink id="hoord_convs_sq" action="#{cadConvsBean.doOrd_convs_sq}">
<ps:psGraphicImage id="hord_convs_sq_desc" url="../imagens/btOrder_up.gif" border="0" rendered="#{cadConvsBean.ord_convs_sq_desc}"/>
<ps:psGraphicImage id="hord_convs_sq" url="../imagens/btOrder_down.gif" border="0" rendered="#{cadConvsBean.ord_convs_sq}"/>
...
<h:inputText id="convs_sq_xfil" onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadConvsBean.fil_convs_sq}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="convs_cd_xfil" onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadConvsBean.fil_convs_cd}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="convs_tt_orgdes_xfil" onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadConvsBean.fil_convs_tt_orgdes}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_convs_tp_sispat_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'TPVAL', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadConvsBean.fil_convs_tp_sispat}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_convs_tp_orgdes_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'TPVAL', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadConvsBean.fil_convs_tp_orgdes}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_convs_tp_regra_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'TPCNV', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadConvsBean.fil_convs_tp_regra}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="convs_cd_codffk_xfil" onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadConvsBean.fil_convs_cd_codffk}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="convs_lg_xfil" onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadConvsBean.fil_convs_lg}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="tabs_vc_xfil" onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadConvsBean.fil_tabs_vc}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- recdWdColumnGen -->
...
<!-- Dados -->
<h:dataTable
value="#{cadConvsBean.pesqData}"
var="Convs"
binding="#{cadConvsBean.pesqTable}"
rowClasses="tre9, tro9"
headerClass="tbh9"
footerClass="tbf9"
id="dtDados"
rows="#{cadConvsBean.pageLength}"
first="#{cadConvsBean.currentLine}">
<!-- propColumnGen -->
<h:column id="convs_sq">
...
<h:commandLink id="flag_imgrecd_wd" action="#{cadConvsBean.doObternullSearchBack}" onmousedown="wtran='convscad';aa=this.id.slice(0,this.id.search('flag_img'));valor1=rpel(aa+'sel_convs_id_impex');valor2=rpel(aa+'sel_convs_sq');selDtTableOneRow(aa);el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1+','+valor2;">
...
<h:commandLink id="xrec_obnv" action="#{cadConvsBean.doObterParent}" immediate="true"/>
