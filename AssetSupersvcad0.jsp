...
<title><h:outputText value="#{cadAssetSupersvBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();"  onload="window.focus();loading();ufmvini();tran='assetsupersvcad';cadbeanx='cadAssetSupersvBean'; loadPage(<%= request.getAttribute("pagina") %>); AlternarAbas(parent.cadbeanx, <%=(Object)session.getAttribute(("cadAssetSupersvBeanx"))%>);AlternarSubAbas();">
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetsupersvpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadAssetSupersvBean.doSelecionar}"/>
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetsupersvcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadAssetSupersvBean.doReturnMenu}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadAssetSupersvBean.canUpdate}" image="../imagens/btSave.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetsupersvcad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadAssetSupersvBean.doUpdate}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadAssetSupersvBean.canUpdate}" image="../imagens/btNew.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadAssetSupersvBean.doCancelar}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadAssetSupersvBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadAssetSupersvBean.doExcluir}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}"  action="#{cadAssetSupersvBean.doObter}"  onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetsupersvcad'+'&ufmv='+stx"/>
...
<h:commandButton id="aHelpAssetSupersvRfm" tabindex="-1" immediate="true" rendered="#{cadAssetSupersvBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'AssetSupersvRfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:commandButton id="aClose" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
<h:inputHidden id="tabsvf" value="#{cadAssetSupersvBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadAssetSupersvBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadAssetSupersvBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadAssetSupersvBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadAssetSupersvBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadAssetSupersvBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadAssetSupersvBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadAssetSupersvBean.xmesg_st}" />
...
<h:outputText value="#{iimsg.AssetSupersv_D00_REGISTER_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetSupersv_D00_DETAIL_UV_st}"/>
</h:outputLink>
</td>
...
<%@include file="AssetSupersvcadastrg.jsp"%>
</div>
<!-- UV-UV-Stubs/MV D00_DETAIL_UV-->
<div id="abc_astlc" style="display: none">
<%@include file="AssetSupersvcadastlc.jsp"%>
</div>
<!-- D00_NOTR -->
...
<h:commandLink id="xsel_vali" action="#{cadAssetSupersvBean.doValidate}" immediate="true"/>
