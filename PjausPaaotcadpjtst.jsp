...
<h:inputText id="mesg_varpjtst" rendered="#{cadPjausPaaotBean.canUpdate}" value="#{cadPjausPaaotBean.mesg_var}"  styleClass="txrr pr5 tb450r" tabindex="-1" readonly="true"/>
<h:commandButton id="aMessagepjtst" image="../imagens/btMessage_off.gif" styleClass="btp" title="#{iimsg.botao_message}" rendered="#{cadPjausPaaotBean.canUpdate}" action="#{cadPjausPaaotBean.doValidate}" onmousedown="msgw('aMessagepjtst');"/>
</td> <%-- <close td> aaa --%>
</tr> <%-- <tr close aaa> --%>
...
<h:outputText id="pjaus_id_dsc1" value="#{cadPjausPaaotBean.pjaus_nu_pasta}" styleClass="tip"/>
</td> </tr>
...
<h:inputText  id="pjaus_st" onclick="clf(this);" value="#{cadPjausPaaotBean.pjaus_st}" onkeydown="keypress=1;"  styleClass="txl pl5 tbx" onchange="bdcd('','pjaus_st','1','STPRJ',this.value);;" size="7" maxlength="5" tabindex="4" />
...
<%-- current Date --%>
<td  width="700" > <h:inputText id="pjaus_dt_abertura_str" tabindex="-1"  onfocus="this.blur()" value="#{cadPjausPaaotBean.pjaus_dt_abertura_str}" onchange="uf();" size="0" maxlength="10"  styleClass="txl pl5 tbDtr"/>
...
<%-- Processing Codf 1--%>
<%-- Processing Codf 1 HLFN --%>
<h:inputText  id="pjaus_in_emergencial" onclick="clf(this);" value="#{cadPjausPaaotBean.pjaus_in_emergencial}" onkeydown="keypress=1;"  styleClass="txl pl5 tbx" onchange="bdcd('','pjaus_in_emergencial','1','TPAEM',this.value);;" size="7" maxlength="5" tabindex="5" />
...
<td        width="300" > <%-- open w/ inputText 222a--%>
<%-- outputLabel aaa --%>
<h:outputLabel  styleClass="tip txl pl0"  id="lbl_pjaus_tp_solicitante" for="pjaus_tp_solicitante"  value="#{iimsg.PjausPaaot_pjaus_tp_solicitante_tt}"/>  </td> <%-- <top> --%>
<%-- Processing Codf --%>
<td   width="700"   >
<%-- Processing Codf 1--%>
<%-- Processing Codf 1 HLFN --%>
<h:inputText  id="pjaus_tp_solicitante" onclick="clf(this);" value="#{cadPjausPaaotBean.pjaus_tp_solicitante}" onkeydown="keypress=1;"  styleClass="txl pl5 tbx" onchange="clFields(1);cleSubSel_uv('pjaus_id_solicitante');bdcd('','pjaus_tp_solicitante','1','TPIOE',this.value);;" size="7" maxlength="5" tabindex="6" />
...
<ps:psGraphicImage id="pjaus_tp_solicitante_vc" flagType="val" flag="#{cadPjausPaaotBean.pjaus_tp_solicitante_vc}" styleClass="btp"/>
<%-- Processing Codf 1 AAA --%>
<h:inputText id="pjaus_tp_solicitante_desc" tabindex="-1" onfocus="this.blur()" value="#{cadPjausPaaotBean.pjaus_tp_solicitante_desc}" styleClass="txlr pr5 tb200r"/>
</td> <%-- <close td> ccc --%>
<td        width="300" > <%-- open w/ inputText 222a--%>
<%-- outputLabel aaa --%>
...
<%-- Processing Fk --%>
<%-- Processing Fk 333--%>
<h:inputText id="pjaus_id_solicitante" tabindex="7"  onclick="clf(this);" value="#{cadPjausPaaotBean.pjaus_id_solicitante}"  styleClass="txl pl5 tbx" onkeydown="keypress=1;" onchange="if(!valSubSel('pjaus_tp_solicitante')){this.value='';}Transfk('','','1','pjaus_id_solicitante','Solic','solic_cd','solic_nm_razaosocial',this.value);" size="12" maxlength="10" />
...
<%-- Processing Codf 1--%>
<%-- Processing Codf 1 HLFN --%>
<h:inputText  id="pjaus_tp_investimento1" onclick="clf(this);" value="#{cadPjausPaaotBean.pjaus_tp_investimento1}" onkeydown="keypress=1;"  styleClass="txl pl5 tbx" onchange="bdcd('','pjaus_tp_investimento1','1','TPINV',this.value);;" size="7" maxlength="5" tabindex="8" />
...
<%-- Processing Codf 1--%>
<%-- Processing Codf 1 HLFN --%>
<h:inputText  id="pjaus_tp_contrapartida_fin" onclick="clf(this);" value="#{cadPjausPaaotBean.pjaus_tp_contrapartida_fin}" onkeydown="keypress=1;"  styleClass="txl pl5 tbx" onchange="bdcd('','pjaus_tp_contrapartida_fin','1','TPCPF',this.value);;" size="7" maxlength="5" tabindex="9" />
...
<td        width="300" > <%-- open w/ inputText 222a--%>
<%-- outputLabel aaa --%>
<h:outputLabel  styleClass="tip txl pl0"  id="lbl_pjaus_dt_lim_envio_doc" for="pjaus_dt_lim_envio_doc"  value="#{iimsg.PjausPaaot_pjaus_dt_lim_envio_doc_tt}"/>  </td> <%-- <top> --%>
<%-- selDate / Time --%>
<td colspan=""  width="700"   >
<h:inputText id="pjaus_dt_lim_envio_doc_str" tabindex="11"  value="#{cadPjausPaaotBean.pjaus_dt_lim_envio_doc_str}"  styleClass="txl pl5 tbDt" size="14" maxlength="12" onkeydown="formataData('cadForm:pjaus_dt_lim_envio_doc_str', event);" onkeyup="SaltaCampo('cadForm:pjaus_dt_lim_envio_doc_str', 'cadForm:pjaus_dd_atraso', 8 , event);" onchange="validaDatas2(this);bv('','pjaus_dt_lim_envio_doc_str','1',this.value);"  />
...
<ps:psGraphicImage id="pjaus_dt_lim_envio_doc_vc" flagType="val" flag="#{cadPjausPaaotBean.pjaus_dt_lim_envio_doc_vc}" styleClass="btp"/>
...
<td colspan ="4"  width="300"  > <h:inputText id="pjaus_dd_atraso" tabindex="12"  value="#{cadPjausPaaotBean.pjaus_dd_atraso}"  styleClass="txr pr5 tbx" size="5" maxlength="3" onchange="bv('','pjaus_dd_atraso','1',valNum(this.value));"/>
...
<tr>
<td align="left"  colspan ="4" width="0%"  class="tts"> <%-- tittle underlined --%>
<h:outputText value="#{iimsg.PjausPaaot_statux_id_tt_tt}"/>
</td>
</td>  <%-- <close a Toolbar /td--%>
</tr>
</table >
...
<h:inputText id="pjaus_st_checklist" tabindex="13"  value="#{cadPjausPaaotBean.pjaus_st_checklist}" size="152" maxlength="150"  styleClass="txl pl5 tbx" onchange="bv('','pjaus_st_checklist','1',this.value);"/>
<ps:psGraphicImage id="pjaus_st_checklist_vc" flagType="val" flag="#{cadPjausPaaotBean.pjaus_st_checklist_vc}" styleClass="btp"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="300" > <%-- open w/ inputText 222a--%>
...
<%-- nowrap 5676 --%>
<td  colspan ="4" width="300"   >
<h:inputText id="pjaus_st_analise" tabindex="14"  value="#{cadPjausPaaotBean.pjaus_st_analise}" size="152" maxlength="150"  styleClass="txl pl5 tbx" onchange="bv('','pjaus_st_analise','1',this.value);"/>
...
<td        width="300" > <%-- open w/ inputText 222a--%>
<%-- outputLabel aaa --%>
<h:outputLabel  styleClass="tip txl pl0"  id="lbl_pjaus_st_antt" for="pjaus_st_antt"  value="#{iimsg.PjausPaaot_pjaus_st_antt_tt}"/>  </td> <%-- <top> --%>
<%-- inputText --%>
<%-- nowrap 5676 --%>
<td  colspan ="4" width="300"   >
<h:inputText id="pjaus_st_antt" tabindex="15"  value="#{cadPjausPaaotBean.pjaus_st_antt}" size="152" maxlength="150"  styleClass="txl pl5 tbx" onchange="bv('','pjaus_st_antt','1',this.value);"/>
<ps:psGraphicImage id="pjaus_st_antt_vc" flagType="val" flag="#{cadPjausPaaotBean.pjaus_st_antt_vc}" styleClass="btp"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
