...
<link rel="stylesheet" href="../PjausPaaitpspsq.css" type="text/css">
...
function fPgAssist() {
page_assist = <%= session.getAttribute("pjauspaaitpspsq") %>;
return page_assist;
}
function loadPage() {
hovDtTable('dtDados');
...
<body onload="window.focus();loadPage();loading();helpcd='PjausPaaitpsSfm';;tran='pjauspaaitpspsq'; vl='';cadbeanx='cadPjausPaaitpsBean';<%session.setAttribute("tipo","pjauspaaitpspsq");%>">
<h:form id="cadForm">
...
<h:commandButton id="aBackToSearch" styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+''+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadPjausPaaitpsBean.doReturnMenu}"/>
<h:commandButton id="aPrev" styleClass="btp"  image="../imagens/btPgAnterior.gif" title="#{iimsg.botao_anterior}" rendered="#{cadPjausPaaitpsBean.hasPrevPage}" action="#{cadPjausPaaitpsBean.doPaginaAnterior}"/>
<h:commandButton id="aNext" styleClass="btp"  image="../imagens/btPgProxima.gif" title="#{iimsg.botao_proxima}" rendered="#{cadPjausPaaitpsBean.hasNextPage}" action="#{cadPjausPaaitpsBean.doProximaPagina}"/>
<h:outputText id="label_fill" style="display:none" value="#{iimsg.label_fill}" />
<h:outputText id="label_notfound" style="display:none" value="#{iimsg.label_notfound}" />
<h:outputText id="sys_openning_form" style="display:none" value="#{iimsg.sys_openning_form}" />
<h:commandButton id="aFiltrar" styleClass="btp"  image="../imagens/btFilter.gif" title="#{iimsg.botao_filtrar}" action="#{cadPjausPaaitpsBean.doSelecionar}"/>
<h:commandButton id="aLimpar" styleClass="btp" rendered="#{cadPjausPaaitpsBean.canPesquisar}" image="../imagens/btCancel.gif" title="#{iimsg.botao_limpar}" action="#{cadPjausPaaitpsBean.doLimparPesq}"/>
<h:commandButton id="aNew" styleClass="btp" rendered="#{cadPjausPaaitpsBean.canInserir}" image="../imagens/btNew.gif" onmousedown="fNovorwpp('pjauspaaitpscad', tran, this.id, 'yes', fPgAssist());" title="#{iimsg.botao_novo}" action="#{cadPjausPaaitpsBean.doNovo}"/>
<%-- prop buttonLink 4577--%>
<h:commandButton id="XlsImport_xls_stb" rendered="#{cadPjausPaaitpsBean.assist}" title="#{iimsg.PjausPaaitps_XlsImport_xls_stb_tt}" image="../imagens/excellYellow.jpg" onmousedown="fExecx('obxlspaaitpscad', tran, this.id, 'no', '', 'false');" action="#{cadObxlsPaaitpsBean.doObternull}"/>
<h:commandButton id="XlsExport_xls_stb" rendered="#{cadPjausPaaitpsBean.assist}" title="#{iimsg.PjausPaaitps_XlsExport_xls_stb_tt}" image="../imagens/excellRed.jpg" action="#{cadPjausPaaitpsBean.doXlsExport_xls_stb}"/>
...
<h:inputText id="mesg_var" value="#{cadPjausPaaitpsBean.mesg_var}"  styleClass="txrr pr5 tb600r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> msg --%>
<td> &nbsp&nbsp </td>
<td      width="50" > <%-- open w/ inputText 222--%>
<%-- outputLabel msg --%>
...
<%-- outputText --%>
<td    width="100" > <h:inputText id="codfqt" onfocus="this.blur()" value="#{cadPjausPaaitpsBean.codfqt}" size="5" maxlength="5"  styleClass="txl pl5 tbxr"/>
</td> <%-- <close td> msg --%>
</tr> <%-- <tr close> msg--%>
...
<h:outputText id="hd_pjaus_id_tt" title="#{iimsg.PjausPaaitps_pjaus_id_tt}" value="#{iimsg.PjausPaaitps_pjaus_id_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_pjaus_st_tt" title="#{iimsg.PjausPaaitps_pjaus_st_tt}" value="#{iimsg.PjausPaaitps_pjaus_st_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- fkeyColumnGen -->
...
<h:outputText id="hd_pjaus_id_solicitante_tt" title="#{iimsg.PjausPaaitps_pjaus_id_solicitante_tt}" value="#{iimsg.PjausPaaitps_pjaus_id_solicitante_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_pjaus_in_ocup_area_terc_tt" title="#{iimsg.PjausPaaitps_pjaus_in_ocup_area_terc_tt}" value="#{iimsg.PjausPaaitps_pjaus_in_ocup_area_terc_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_pjaus_tp_investimento_tt" title="#{iimsg.PjausPaaitps_pjaus_tp_investimento_tt}" value="#{iimsg.PjausPaaitps_pjaus_tp_investimento_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_pjaus_vl_contrato_tt_xide" title="#{iimsg.PjausPaaitps_pjaus_vl_contrato_tt}" value="#{iimsg.PjausPaaitps_pjaus_vl_contrato_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_pjaus_in_parc_fixa_tt" title="#{iimsg.PjausPaaitps_pjaus_in_parc_fixa_tt}" value="#{iimsg.PjausPaaitps_pjaus_in_parc_fixa_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_pjaus_nu_prss_antt_tt_xide" title="#{iimsg.PjausPaaitps_pjaus_nu_prss_antt_tt}" value="#{iimsg.PjausPaaitps_pjaus_nu_prss_antt_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenTransGen -->
...
<h:outputText id="hd_pjaus_images_ongrid_tt_xide" title="#{iimsg.PjausPaaitps_pjaus_images_ongrid_tt}" value="#{iimsg.PjausPaaitps_pjaus_images_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
...
<h:outputText id="hd_pjaus_docs_ongrid_tt_xide" title="#{iimsg.PjausPaaitps_pjaus_docs_ongrid_tt}" value="#{iimsg.PjausPaaitps_pjaus_docs_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_tabs_vc_tt_xide" title="#{iimsg.PjausPaaitps_tabs_vc_tt}" value="#{iimsg.PjausPaaitps_tabs_vc_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- recdWdColumnGen -->
...
<h:inputText id="pjaus_id_xfil" styleClass="pfd9" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" onclick="this.value=''" value="#{cadPjausPaaitpsBean.fil_pjaus_id}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_pjaus_st_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'STPRJ', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadPjausPaaitpsBean.fil_pjaus_st}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- fkeyColumnGen -->
...
<!--   // 444-->
<h:inputText id="pjaus_id_solicitante_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('solicpsq', tran, this.id, 'no', vl);" onblur="cfb(this.id, 'pfdb9', 'pfd9');" onfocus="this.className='pfd9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadPjausPaaitpsBean.fil_pjaus_id_solicitante}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_pjaus_in_ocup_area_terc_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GENYN', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadPjausPaaitpsBean.fil_pjaus_in_ocup_area_terc}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_pjaus_tp_investimento_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'TPIVT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadPjausPaaitpsBean.fil_pjaus_tp_investimento}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="fil_pjaus_in_parc_fixa_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'SNNAP', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadPjausPaaitpsBean.fil_pjaus_in_parc_fixa}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="pjaus_nu_prss_antt_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadPjausPaaitpsBean.fil_pjaus_nu_prss_antt}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenTransGen -->
...
<h:inputText id="tabs_vc_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadPjausPaaitpsBean.fil_tabs_vc}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- recdWdColumnGen -->
...
<!-- Dados -->
<h:dataTable
value="#{cadPjausPaaitpsBean.pesqData}"
var="Pjaus"
binding="#{cadPjausPaaitpsBean.pesqTable}"
rowClasses="tre9, tro9"
headerClass="tbh9"
footerClass="tbf9"
id="dtDados"
rows="#{cadPjausPaaitpsBean.pageLength}"
first="#{cadPjausPaaitpsBean.currentLine}">
<!-- fkeyColumnGen -->
...
<h:commandButton id="flag_imgrecd_wd_pjaus_images_ongrid" action="#{cadObimgpjBean.doObternull}"  image="#{Pjaus.imag_im}"  onmousedown="wtran='obimgpjcad';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_pjaus_idpjaus_images_ongrid_bt').value;el('fiiSaveTypex').src = 'iiSaveTypex.jsp?tbak=pjauspaaitpspsq&tipo='+wtran+'&valor='+valor1;"/>
</h:panelGroup>
</h:column>
<!-- buttonOpenChildTransGen -->
<h:column id="pjaus_docs_ongrid_bt">
...
<h:commandButton id="flag_imgrecd_wd_pjaus_docs_ongrid" action="#{cadObdocpjBean.doSelecionar}" image="#{Pjaus.obdocpj_im}"  onmousedown="wtran='obdocpjpsq';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_pjaus_idpjaus_docs_ongrid_bt').value;el('fiiSaveTypex').src = 'iiSaveTypex.jsp?tbak=pjauspaaitpspsq&tipo='+wtran+'&valor='+valor1;el('fiiSaveField').src='iiSaveField.jsp?campo=campo1&valor='+valor1;"/>
</h:panelGroup>
</h:column>
<!-- propColumnGen -->
<h:column id="tabs_vc">
<h:panelGroup id="pg_tabs_vc_sg">
<h:commandLink id="flag_imgPjausPaaitps" onmousedown="wtran='pjauspaaitpscad';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_pjaus_id').innerHTML;el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1;showpopup(tran,'xrec_obob',this.id,wtran,'yes');">
...
<!-- BBB--> <h:commandLink id="flag_imgrecd_wd" action="#{cadPjausPaaitpsBean.doObternullSearchBack}" onmousedown="wtran='pjauspaaitpscad';aa=this.id.slice(0,this.id.search('flag_img'));valor1=rpel(aa+'sel_pjaus_id');selDtTableOneRow(aa);el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1;">
...
<!-- Conteudo -->
<iframe id="PjausPaaitps" width="0" height="0" frameborder="0"> </iframe>
...
<h:commandLink id="xrec_obnv" action="#{cadPjausPaaitpsBean.doNovo}" immediate="true"/>
