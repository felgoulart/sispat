...
<%session.setAttribute("cadbeanx","cadProssMrbxaBean");%>
...
<link rel="stylesheet" href="../ProssMrbxapsq.css" type="text/css">
...
<script src="../ProssMrbxafunctions.js" type="text/javascript" language="javascript"></script>
<SCRIPT type="text/javascript">
function fPgAssist() {
page_assist = <%= session.getAttribute("prossmrbxapsq") %>;
return page_assist;
}
function loadPage() {
hovDtTable('dtDados');
...
<title>
<h:outputText value="#{cadProssMrbxaBean.trans_tt}"/>
</title>
</head>
<body onload="window.focus();loadPage();loading();helpcd='ProssMrbxaSfm';;tran='prossmrbxapsq'; vl='';cadbeanx='cadProssMrbxaBean';<%session.setAttribute("tipo","prossmrbxapsq");%>">
<h:form id="cadForm">
...
<!-- Principal -->
	<div class="container expand-max bg-transparent mt-3">
	  <div class="row">
		...
		<div class="col-sm-10">
		<h2 class="title" style="font-size: 35px;"><h:outputText styleClass="h2" value="#{cadProssMrbxaBean.trans_tt}"/></h2>
		...
		<div class="row" align="center">
			<div class="col">
			<h:outputLabel id="mesg_var" value="#{cadProssMrbxaBean.mesg_var}"  styleClass="alert alert-primary" tabindex="-1" />
			</div>
	   </div>			
	   </p>
		</div>
		<div class="col-sm-1">
		<h:commandButton id="aBackToSearch" styleClass="btn btn-outline-dark" rendered="#{cadProssMrbxaBean.assistx}" value ="Voltar" onmousedown="document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+''+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadProssMrbxaBean.doReturnMenu}"/>
		</div>
	</div>
	</div>
...
<h:commandButton id="aPrev" styleClass="d-none"  image="../imagens/btPgAnterior.gif" title="#{iimsg.botao_anterior}" rendered="#{cadProssMrbxaBean.hasPrevPage}" action="#{cadProssMrbxaBean.doPaginaAnterior}"/>
<h:commandButton id="aNext" styleClass="d-none"  image="../imagens/btPgProxima.gif" title="#{iimsg.botao_proxima}" rendered="#{cadProssMrbxaBean.hasNextPage}" action="#{cadProssMrbxaBean.doProximaPagina}"/>
<h:outputText id="label_fill" style="display:none" value="#{iimsg.label_fill}" />
<h:outputText id="label_notfound" style="display:none" value="#{iimsg.label_notfound}" />
<h:outputText id="sys_openning_form" style="display:none" value="#{iimsg.sys_openning_form}" />
<h:commandButton id="aFiltrar"  styleClass="btn btn-outline-dark"  value="Filtrar"  title="#{iimsg.botao_filtrar}" action="#{cadProssMrbxaBean.doSelecionar}"/>
<h:commandButton id="aLimpar"  styleClass="btn btn-outline-dark"  value="Limpar"  rendered="#{cadProssMrbxaBean.canPesquisar}"  title="#{iimsg.botao_limpar}" action="#{cadProssMrbxaBean.doLimparPesq}"/>
<h:commandButton id="aNew"  styleClass="btn btn-outline-dark"  value="Inserir"  rendered="#{cadProssMrbxaBean.canInserir}"  onmousedown="fNovorwpp('prossmrbxacad', tran, this.id, 'yes', fPgAssist());" title="#{iimsg.botao_novo}" action="#{cadProssMrbxaBean.doNovo}"/>
<%-- prop buttonLink 4577--%>
<h:commandButton id="XlsImport_xls_stb" styleClass="d-none" rendered="#{cadProssMrbxaBean.assist}" title="#{iimsg.ProssMrbxa_XlsImport_xls_stb_tt}" image="../imagens/excellYellow.jpg" onmousedown="fExecx('obxlsppaobtvcad', tran, this.id, 'no', '', 'false');" action="#{cadObxlsPpaobtvBean.doObternull}"/>
<h:commandButton id="XlsExport_xls_stb"  styleClass="btn btn-outline-dark"  value="Exportar"  rendered="#{cadProssMrbxaBean.canPesquisar}" title="#{iimsg.ProssMrbxa_XlsExport_xls_stb_tt}"  action="#{cadProssMrbxaBean.doXlsExport_xls_stb}"/>
...
<h:inputHidden id="xmesg_rc" value="#{cadProssMrbxaBean.xmesg_rc}" />
<h:inputHidden id="xhelp_rc" value="#{cadProssMrbxaBean.xhelp_rc}" />
<h:commandButton id="aClose" styleClass="d-none" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
    ...
    <div class="col-3 text-white" align="right" style="vertical-align: text-bottom;">
		  ...
		  <h:outputLabel id="codfqt" onfocus="this.blur()" value="#{cadProssMrbxaBean.codfqt}"   styleClass="h6 text-secondary"/>
	</div>
</div>
...
<h:outputText id="hd_pross_id_tt" title="#{iimsg.ProssMrbxa_pross_id_tt}" value="#{iimsg.ProssMrbxa_pross_id_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- fkeyColumnGen -->
...
<h:outputText id="hd_pross_id_solicitante_tt" title="#{iimsg.ProssMrbxa_pross_id_solicitante_tt}" value="#{iimsg.ProssMrbxa_pross_id_solicitante_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_pross_ds_suscinta_tt_xide" title="#{iimsg.ProssMrbxa_pross_ds_suscinta_tt}" value="#{iimsg.ProssMrbxa_pross_ds_suscinta_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_pross_st_geral_tt_xide" title="#{iimsg.ProssMrbxa_pross_st_geral_tt}" value="#{iimsg.ProssMrbxa_pross_st_geral_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_pross_st_analise_tt" title="#{iimsg.ProssMrbxa_pross_st_analise_tt}" value="#{iimsg.ProssMrbxa_pross_st_analise_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_pross_cd_proprio_pj_tt_xide" title="#{iimsg.ProssMrbxa_pross_cd_proprio_pj_tt}" value="#{iimsg.ProssMrbxa_pross_cd_proprio_pj_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_pross_nu_prss_antt_tt_xide" title="#{iimsg.ProssMrbxa_pross_nu_prss_antt_tt}" value="#{iimsg.ProssMrbxa_pross_nu_prss_antt_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
...
<h:outputText id="hd_pross_conts_ongrid_tt_xide" title="#{iimsg.ProssMrbxa_pross_conts_ongrid_tt}" value="#{iimsg.ProssMrbxa_pross_conts_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenChildTransGen -->
...
<h:outputText id="hd_pross_docseml_ongrid_tt_xide" title="#{iimsg.ProssMrbxa_pross_docseml_ongrid_tt}" value="#{iimsg.ProssMrbxa_pross_docseml_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenChildTransGen -->
...
<h:outputText id="hd_pross_pjhsogpp_ongrid_tt_xide" title="#{iimsg.ProssMrbxa_pross_pjhsogpp_ongrid_tt}" value="#{iimsg.ProssMrbxa_pross_pjhsogpp_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- recdWdColumnGen -->
...
<h:inputText id="pross_id_xfil" styleClass="pfd9" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" onclick="this.value=''" value="#{cadProssMrbxaBean.fil_pross_id}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- fkeyColumnGen -->
...
<!--   // 444-->
<h:inputText id="pross_id_solicitante_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('solinpsq', tran, this.id, 'no', vl);" onblur="cfb(this.id, 'pfdb9', 'pfd9');" onfocus="this.className='pfd9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadProssMrbxaBean.fil_pross_id_solicitante}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="pross_ds_suscinta_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadProssMrbxaBean.fil_pross_ds_suscinta}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="pross_st_geral_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadProssMrbxaBean.fil_pross_st_geral}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_pross_st_analise_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'STAOP', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadProssMrbxaBean.fil_pross_st_analise}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="pross_cd_proprio_pj_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadProssMrbxaBean.fil_pross_cd_proprio_pj}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="pross_nu_prss_antt_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadProssMrbxaBean.fil_pross_nu_prss_antt}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenChildTransGen -->
...
<!-- Dados -->
<h:dataTable
value="#{cadProssMrbxaBean.pesqData}"
var="Pross"
binding="#{cadProssMrbxaBean.pesqTable}"
rowClasses="tre9mod, tro9mod"
headerClass="tbh9"
footerClass="tbf9"
id="dtDados"
rows="#{cadProssMrbxaBean.pageLength}"
first="#{cadProssMrbxaBean.currentLine}">
<!-- fkeyColumnGen -->
...
<h:commandButton id="flag_imgrecd_wd_pross_pjhsogpp_ongrid" action="#{cadPrhsogpBean.doSelecionar}" image="../imagens/process.ico" onmousedown="wtran='prhsogppsq';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_pross_idpross_pjhsogpp_ongrid_bt').value;el('fiiSaveTypex').src = 'iiSaveTypex.jsp?tbak=prossmrbxapsq&tipo='+wtran+'&valor='+valor1;el('fiiSaveField').src='iiSaveField.jsp?campo=campo1&valor='+valor1;" onmouseup="this.form.target='_blank';" onblur="this.form.target='_self';"/>
</h:panelGroup>
</h:column>
<!-- recdWdColumnGen -->
<h:column id="recd_wd">
<h:panelGroup id="pg_recd_wd_sg">
<!-- REC-30-->  <h:commandButton id="flag_imgrecd_wd" image="../imagens/btRecd.gif" action="#{cadProssMrbxaBean.doObternullSearchBack}" onmousedown="wtran='prossmrbxacad';aa=this.id.slice(0,this.id.search('flag_img'));valor1=rpel(aa+'sel_pross_id');selDtTableOneRow(aa);el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1;"/>
</h:panelGroup>
</h:column>
<!-- propSearchChildTableGen -->
</h:dataTable>
...
<!-- Conteudo -->
<iframe id="ProssMrbxa" width="0" height="0" frameborder="0"> </iframe>
...
<h:commandLink id="xrec_obob" action="#{cadProssMrbxaBean.doObternull}" immediate="true"/>
<h:commandLink id="xrec_obnv" action="#{cadProssMrbxaBean.doNovo}" immediate="true"/>
