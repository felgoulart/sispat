...
<title><h:outputText value="#{cadPjausPaepbBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();"  onload="window.focus();loading();PjausPaepb_hl();ufmvini();tran='pjauspaepbcad';cadbeanx='cadPjausPaepbBean'; loadPage(<%= request.getAttribute("pagina") %>); AlternarAbas(parent.cadbeanx, <%=(Object)session.getAttribute(("cadPjausPaepbBeanx"))%>);AlternarSubAbas();">
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspaepbpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadPjausPaepbBean.doSelecionarNullOnly}"/>
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspaepbcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadPjausPaepbBean.doReturnMenu}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadPjausPaepbBean.canUpdate}" image="../imagens/btSave.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspaepbcad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadPjausPaepbBean.doUpdate}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadPjausPaepbBean.canUpdate}" image="../imagens/btCancel.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadPjausPaepbBean.doCancelar}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadPjausPaepbBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadPjausPaepbBean.doExcluir}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}"  action="#{cadPjausPaepbBean.doObter}"  onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspaepbcad'+'&ufmv='+stx"/>
...
<h:commandButton id="aHelpPjausRfm" tabindex="-1" immediate="true" rendered="#{cadPjausPaepbBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'PjausRfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:commandButton id="aClose" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
<h:inputHidden id="tabsvf" value="#{cadPjausPaepbBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadPjausPaepbBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadPjausPaepbBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadPjausPaepbBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadPjausPaepbBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadPjausPaepbBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadPjausPaepbBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadPjausPaepbBean.xmesg_st}" />
...
<h:outputText value="#{iimsg.PjausPaepb_D00_REGISTER_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.PjausPaepb_D00_DETAIL_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.PjausPaepb_D00_ANALISE_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.PjausPaepb_D00_CONTRACT_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.PjausPaepb_D00_REQUEST_UV_st}"/>
</h:outputLink>
</td>
...
<h:commandLink id="xsel_vali" action="#{cadPjausPaepbBean.doValidate}" immediate="true"/>
...
<!-- for fkstransGen -->
<h:commandLink id="xsel_ObxlsPaepb" action="#{cadObxlsPaepbBean.doSelecionarOnly}" immediate="true"/>
