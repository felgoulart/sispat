...
<link rel="stylesheet" href="../Pjhsogpxpsq.css" type="text/css">
...
function loadPage() {
hovDtTable('dtDados');
cfb('cadForm:dtDados_ft:pjhso_id_pjaus_xfil', 'pfdb9', 'pfd9');
...
<body onload="window.focus();loadPage();loading();helpcd='PjhsogpxSfm';;tran='pjhsogpxpsq'; vl='';cadbeanx='cadPjhsogpxBean';<%session.setAttribute("tipo","pjhsogpxpsq");%>">
<h:form id="cadForm">
...
<h:commandButton id="aBackToSearchMenu" styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjhsogpxcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadPjhsogpxBean.doReturnMenu}"/>
<h:commandButton id="aPrev" styleClass="btp"  image="../imagens/btPgAnterior.gif" title="#{iimsg.botao_anterior}" rendered="#{cadPjhsogpxBean.hasPrevPage}" action="#{cadPjhsogpxBean.doPaginaAnterior}"/>
<h:commandButton id="aNext" styleClass="btp"  image="../imagens/btPgProxima.gif" title="#{iimsg.botao_proxima}" rendered="#{cadPjhsogpxBean.hasNextPage}" action="#{cadPjhsogpxBean.doProximaPagina}"/>
<h:outputText id="label_fill" style="display:none" value="#{iimsg.label_fill}" />
<h:outputText id="label_notfound" style="display:none" value="#{iimsg.label_notfound}" />
<h:outputText id="sys_openning_form" style="display:none" value="#{iimsg.sys_openning_form}" />
<h:commandButton id="aFiltrar" styleClass="btp"  image="../imagens/btFilter.gif" title="#{iimsg.botao_filtrar}" action="#{cadPjhsogpxBean.doSelecionar}"/>
<h:commandButton id="aLimpar" styleClass="btp" rendered="#{cadPjhsogpxBean.canPesquisar}" image="../imagens/btCancel.gif" title="#{iimsg.botao_limpar}" action="#{cadPjhsogpxBean.doLimparPesq}"/>
<h:commandButton id="aNew" styleClass="btp" rendered="#{cadPjhsogpxBean.canInserir}" image="../imagens/btNew.gif" onmousedown="fNovorwpp('pjhsogpcad', tran, this.id, 'yes', fPgAssist());" title="#{iimsg.botao_novo}" action="#{cadPjhsogpxBean.doNovoUpload}"/>
<h:commandButton id="XlsExport_xls_stb" rendered="#{cadPjhsogpxBean.canPesquisar}" title="#{iimsg.Pjhsogp_XlsExport_xls_stb_tt}" image="../imagens/excellRed.jpg" action="#{cadPjhsogpxBean.doXlsExport_xls_stb}"/>
...
<h:commandButton id="aHelpPjhsogpxSfm" tabindex="-1" rendered="#{cadPjhsogpxBean.hasHelpSpcSfm}" immediate="true" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes','PjhsogpxSfm');" image="../imagens/btHelpSpc.gif"/>
...
<h:selectOneMenu value="#{cadPjhsogpxBean.selectedItem}">
<f:selectItems value="#{cadPjhsogpxBean.selectItems}" />
</h:selectOneMenu>
<h:commandButton value="Selecione um Processo" action="#{cadPjhsogpxBean.action}" />
<h:messages />
<h:inputText id="mesg_var" value="#{cadPjhsogpxBean.mesg_var}"  styleClass="txrr pr5 tb600r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> msg --%>
<td> &nbsp&nbsp </td>
<td      width="50" > <%-- open w/ inputText 222--%>
<%-- outputLabel msg --%>
...
<%-- outputText --%>
<td    width="100" > <h:inputText id="codfqt" onfocus="this.blur()" value="#{cadPjhsogpxBean.codfqt}" size="5" maxlength="5"  styleClass="txl pl5 tbxr"/>
</td> <%-- <close td> msg --%>
</tr> <%-- <tr close> msg--%>
...
id="dtDados_tt">
<!-- fkeyColumnGen -->
<h:column id="pjhso_id_pjaus_tt_fk">
<f:facet name="header">
<h:panelGroup id="pg_pjhso_id_pjaus_tt">
<h:outputText id="hd_pjhso_id_pjaus_tt" title="#{iimsg.Pjhsogp_pjhso_id_pjaus_tt}" value="#{iimsg.Pjhsogp_pjhso_id_pjaus_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
id="dtDados_ft">
<!-- fkeyColumnGen -->
<h:column id="pjhso_id_pjaus_ft_fk">
<f:facet name="footer">
<h:panelGroup id="fpg_pjhso_id_pjaus">
<!--   // 444-->
<h:inputText id="pjhso_id_pjaus_xfil" title="#{iimsg.hint_dblclick}" ondblclick="this.value=''" onblur="cfb(this.id, 'pfdb9', 'pfd9');" onfocus="this.className='pfd9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadPjhsogpxBean.fil_pjhso_id_pjaus}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="pjhso_tp_entidade_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadPjhsogpxBean.fil_pjhso_tp_entidade}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_pjhso_tp_acao_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'TPAPS', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadPjhsogpxBean.fil_pjhso_tp_acao}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="pjhso_cd_de_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadPjhsogpxBean.fil_pjhso_cd_de}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="pjhso_cd_para_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadPjhsogpxBean.fil_pjhso_cd_para}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="pjhso_cd_prcc_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadPjhsogpxBean.fil_pjhso_cd_prcc}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_pjhso_st_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'STPRC', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadPjhsogpxBean.fil_pjhso_st}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="pjhso_ds_assunto_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadPjhsogpxBean.fil_pjhso_ds_assunto}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="tabs_vc_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadPjhsogpxBean.fil_tabs_vc}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- recdWdColumnGen -->
...
<!-- Dados -->
<h:dataTable
value="#{cadPjhsogpxBean.pesqData}"
var="Pjhso"
binding="#{cadPjhsogpxBean.pesqTable}"
rowClasses="tre9, tro9"
headerClass="tbh9"
footerClass="tbf9"
id="dtDados"
rows="#{cadPjhsogpxBean.pageLength}"
first="#{cadPjhsogpxBean.currentLine}">
<!-- fkeyColumnGen -->
<h:column id="pjhso_id_pjaus_fk">
<h:panelGroup id="pg_pjhso_id_pjaus_sg">
<!--   // 333-->
<h:outputText id="sel_pjhso_id_pjaus" value="#{Pjhso.pjhso_id_pjaus}"/>
</h:panelGroup>
</h:column>
<!-- propColumnGen -->
<h:column id="pjhso_dt_evento">
...
<h:commandLink id="flag_imgPjhsogp" onmousedown="wtran='pjhsogpcad';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_pjhso_id_pjaus').innerHTML;valor2=el(aa+'sel_pjhso_sq').value;el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1+','+valor2;showpopup(tran,'xrec_obob',this.id,wtran,'yes');">
...
<!-- CRX-30-->  <h:commandButton id="flag_imgrecd_wd" image="../imagens/btRecd.gif" action="#{cadPjhsogpxBean.doObternullSearchBack}" onmousedown="wtran='pjhsogpxcad';aa=this.id.slice(0,this.id.search('flag_img'));valor1=rpel(aa+'sel_pjhso_id_pjaus');valor2=rpel(aa+'sel_pjhso_sq');selDtTableOneRow(aa);el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1+','+valor2;"/>
</h:panelGroup>
</h:column>
<!-- recdWdColumnGen -->
<h:column id="recd_wdpk">
...
<f:param name="tipoant" value="pjhsogpxpsq"/>
</h:commandLink>
...
<h:commandLink id="xrec_obnv" action="#{cadPjhsogpxBean.doObterParentForCancel}" immediate="true"/>
