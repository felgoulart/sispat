...
<%session.setAttribute("cadbeanx","cadHelppusBean");%>
...
<link rel="stylesheet" href="../Helppuspsq.css" type="text/css">
...
function fPgAssist() {
page_assist = <%= session.getAttribute("helppuspsq") %>;
return page_assist;
}
function loadPage() {
hovDtTable('dtDados');
...
<title>
<h:outputText value="#{cadHelppusBean.trans_tt}"/>
</title>
</head>
<body onload="window.focus();loadPage();loading();helpcd='';;tran='helppuspsq'; vl='';cadbeanx='cadHelppusBean';<%session.setAttribute("tipo","helppuspsq");%>">
<h:form id="cadForm">
...
<h:commandButton id="aPrev" styleClass="btp"  image="../imagens/btPgAnterior.gif" title="#{iimsg.botao_anterior}" rendered="#{cadHelppusBean.hasPrevPage}" action="#{cadHelppusBean.doPaginaAnterior}"/>
<h:commandButton id="aNext" styleClass="btp"  image="../imagens/btPgProxima.gif" title="#{iimsg.botao_proxima}" rendered="#{cadHelppusBean.hasNextPage}" action="#{cadHelppusBean.doProximaPagina}"/>
<h:outputText id="label_fill" style="display:none" value="#{iimsg.label_fill}" />
<h:outputText id="label_notfound" style="display:none" value="#{iimsg.label_notfound}" />
<h:outputText id="sys_openning_form" style="display:none" value="#{iimsg.sys_openning_form}" />
<ps:psCommandLink id="aFiltrar" styleClass="btp"  ativo="../imagens/btFilter.gif" title="#{iimsg.botao_filtrar}" action="#{cadHelppusBean.doSelecionar}">
<f:param name="campo5" value=""/>
<f:param name="campo6" value=""/>
<f:param name="tipo" value="helppuspsq"/>
</ps:psCommandLink>
<h:commandButton id="aHelp" tabindex="-1" immediate="true" title="#{iimsg.botao_help}" onmousedown="pw('helpcad', tran, this.id, 'yes','Helppus');" image="../imagens/btHelp.gif"/>
...
<h:commandButton id="aHelpHelppusSfm" tabindex="-1" rendered="#{cadHelppusBean.hasHelpSpcSfm}" immediate="true" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes','HelppusSfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aHelpgSearch" tabindex="-1" immediate="true" title="#{iimsg.button_help_repository}" onmousedown="pw('helpsearchpsq', tran, this.id, 'yes', 'HelpSearch');" image="../imagens/btHelpRep.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:inputHidden id="xmesg_rc" value="#{cadHelppusBean.xmesg_rc}" />
<h:inputHidden id="xhelp_rc" value="#{cadHelppusBean.xhelp_rc}" />
...
<h:inputText id="mesg_var" value="#{cadHelppusBean.mesg_var}"  styleClass="txrr pr5 tb600r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> msg --%>
<td> &nbsp&nbsp </td>
<td      width="50" > <%-- open w/ inputText 222--%>
<%-- outputLabel msg --%>
...
<%-- outputText --%>
<td    width="100" > <h:inputText id="codfqt" onfocus="this.blur()" value="#{cadHelppusBean.codfqt}" size="5" maxlength="5"  styleClass="txl pl5 tbxr"/>
</td> <%-- <close td> msg --%>
</tr> <%-- <tr close> msg--%>
...
<h:outputText id="hd_help_cd_tt_xide" title="#{iimsg.Helppus_help_cd_tt}" value="#{iimsg.Helppus_help_cd_ta}"/>
<f:verbatim>&nbsp;&nbsp;</f:verbatim>
<h:commandLink id="hoord_help_cd" action="#{cadHelppusBean.doOrd_help_cd}">
<ps:psGraphicImage id="hord_help_cd_desc" url="../imagens/btOrder_up.gif" border="0" rendered="#{cadHelppusBean.ord_help_cd_desc}"/>
<ps:psGraphicImage id="hord_help_cd" url="../imagens/btOrder_down.gif" border="0" rendered="#{cadHelppusBean.ord_help_cd}"/>
...
<h:outputText id="hd_help_nm_tt_xide" title="#{iimsg.Helppus_help_nm_tt}" value="#{iimsg.Helppus_help_nm_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenTransGen -->
...
<h:outputText id="hd_buttonHelp_tt_xide" title="#{iimsg.Helppus_buttonHelp_tt}" value="#{iimsg.Helppus_buttonHelp_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propSearchChildTableGen -->
<!-- assist 1 -->
<h:column rendered="#{cadHelppusBean.assist}">
<f:facet name="header">
...
<h:inputText id="help_cd_xfil" onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadHelppusBean.fil_help_cd}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="help_nm_xfil" onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadHelppusBean.fil_help_nm}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenTransGen -->
...
<!-- Dados -->
<h:dataTable
value="#{cadHelppusBean.pesqData}"
var="Help"
binding="#{cadHelppusBean.pesqTable}"
rowClasses="tre9, tro9"
headerClass="tbh9"
footerClass="tbf9"
id="dtDados"
rows="#{cadHelppusBean.pageLength}"
first="#{cadHelppusBean.currentLine}">
<!-- propColumnGen -->
<h:column id="help_cd">
...
<h:commandLink id="xrec_obob" action="#{cadHelppusBean.doObternull}" immediate="true"/>
<h:commandLink id="xrec_obnv" action="#{cadHelppusBean.doNovo}" immediate="true"/>
