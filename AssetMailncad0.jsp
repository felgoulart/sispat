...
<title><h:outputText value="#{cadAssetMailnBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();"  onload="window.focus();loading();ufmvini();tran='assetmailncad';cadbeanx='cadAssetMailnBean'; loadPage(<%= request.getAttribute("pagina") %>); AlternarAbas(parent.cadbeanx, <%=(Object)session.getAttribute(("cadAssetMailnBeanx"))%>);AlternarSubAbas();">
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetmailnpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadAssetMailnBean.doSelecionar}"/>
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetmailncad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadAssetMailnBean.doReturnMenu}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadAssetMailnBean.canUpdate}" image="../imagens/btSave.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetmailncad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadAssetMailnBean.doUpdate}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadAssetMailnBean.canUpdate}" image="../imagens/btNew.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadAssetMailnBean.doCancelar}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadAssetMailnBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadAssetMailnBean.doExcluir}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}"  action="#{cadAssetMailnBean.doObter}"  onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetmailncad'+'&ufmv='+stx"/>
...
<h:commandButton id="aHelpAssetRfm" tabindex="-1" immediate="true" rendered="#{cadAssetMailnBean.hasHelpComRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'AssetRfm');" image="../imagens/btHelpCom.gif"/>
<h:commandButton id="aHelpAssetViapmRfm" tabindex="-1" immediate="true" rendered="#{cadAssetMailnBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'AssetViapmRfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:commandButton id="aClose" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
<h:inputHidden id="tabsvf" value="#{cadAssetMailnBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadAssetMailnBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadAssetMailnBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadAssetMailnBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadAssetMailnBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadAssetMailnBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadAssetMailnBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadAssetMailnBean.xmesg_st}" />
...
<h:outputText id="sys_confirm" style="display:none" value="#{iimsg.AssetMailn_sys_confirm_tt}" />
</td>
...
<h:outputText value="#{iimsg.AssetMailn_D00_REGISTER_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetMailn_D00_LOCATION_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetMailn_D00_ATTRIBUTES_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetMailn_D00_SURVEY_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetMailn_D00_OCCUPDOC_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetMailn_D00_EVALUATION_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetMailn_D00_EXPERTS_UV_st}"/>
</h:outputLink>
</td>
...
<iframe id="fInvtyLPsak" width="0" height="0" frameborder="0"> </iframe>
<iframe id="fInvtyLPsfk" width="0" height="0" frameborder="0"> </iframe>
<iframe id="InvtyLP" width="0" height="0" frameborder="0"> </iframe>
<iframe id="invty" width="0" height="0" frameborder="0"> </iframe>
<iframe id="fInvtyLPsak" width="0" height="0" frameborder="0"> </iframe>
<iframe id="fInvtyLPsfk" width="0" height="0" frameborder="0"> </iframe>
...
<h:commandLink id="xsel_vali" action="#{cadAssetMailnBean.doValidate}" immediate="true"/>
...
<h:commandLink id="xsel_invtylp" action="#{cadInvtyLPBean.doSelecionarOnly}" immediate="true"/>
