...
<link rel="stylesheet" href="../InvtyPNpsq.css" type="text/css">
...
function fPgAssist() {
page_assist = <%= session.getAttribute("invtypnpsq") %>;
return page_assist;
}
function loadPage() {
hovDtTable('dtDados');
...
<body onload="window.focus();loadPage();loading();helpcd='InvtyPNSfm';;tran='invtypnpsq'; vl='';cadbeanx='cadInvtyPNBean';<%session.setAttribute("tipo","invtypnpsq");%>">
<h:form id="cadForm">
...
<h:commandButton id="aBackToSearch" styleClass="btp" rendered="#{cadInvtyPNBean.assistx}" image="../imagens/btReturnxMenu.gif" onmousedown="document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+''+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadInvtyPNBean.doReturnMenu}"/>
<h:commandButton id="aPrev" styleClass="btp"  image="../imagens/btPgAnterior.gif" title="#{iimsg.botao_anterior}" rendered="#{cadInvtyPNBean.hasPrevPage}" action="#{cadInvtyPNBean.doPaginaAnterior}"/>
<h:commandButton id="aNext" styleClass="btp"  image="../imagens/btPgProxima.gif" title="#{iimsg.botao_proxima}" rendered="#{cadInvtyPNBean.hasNextPage}" action="#{cadInvtyPNBean.doProximaPagina}"/>
<h:outputText id="label_fill" style="display:none" value="#{iimsg.label_fill}" />
<h:outputText id="label_notfound" style="display:none" value="#{iimsg.label_notfound}" />
<h:outputText id="sys_openning_form" style="display:none" value="#{iimsg.sys_openning_form}" />
<h:commandButton id="aFiltrar" styleClass="btp"  image="../imagens/btFilter.gif" title="#{iimsg.botao_filtrar}" action="#{cadInvtyPNBean.doSelecionar}"/>
<h:commandButton id="aLimpar" styleClass="btp" rendered="#{cadInvtyPNBean.canPesquisar}" image="../imagens/btCancel.gif" title="#{iimsg.botao_limpar}" action="#{cadInvtyPNBean.doLimparPesq}"/>
<h:commandButton id="aNew" styleClass="btp" rendered="#{cadInvtyPNBean.canInserir}" image="../imagens/btNew.gif" onmousedown="fNovorwpp('invtypncad', tran, this.id, 'yes', fPgAssist());" title="#{iimsg.botao_novo}" action="#{cadInvtyPNBean.doNovo}"/>
...
<h:inputText id="mesg_var" value="#{cadInvtyPNBean.mesg_var}"  styleClass="txrr pr5 tb600r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> msg --%>
<td> &nbsp&nbsp </td>
<td      width="50" > <%-- open w/ inputText 222--%>
<%-- outputLabel msg --%>
...
<%-- outputText --%>
<td    width="100" > <h:inputText id="codfqt" onfocus="this.blur()" value="#{cadInvtyPNBean.codfqt}" size="5" maxlength="5"  styleClass="txl pl5 tbxr"/>
</td> <%-- <close td> msg --%>
</tr> <%-- <tr close> msg--%>
...
<h:outputText id="hd_invty_cd_tt_xide" title="#{iimsg.InvtyPN_invty_cd_tt}" value="#{iimsg.InvtyPN_invty_cd_ta}"/>
...
<h:outputText id="hd_invty_tp_tt" title="#{iimsg.InvtyPN_invty_tp_tt}" value="#{iimsg.InvtyPN_invty_tp_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_invty_nm_tt_xide" title="#{iimsg.InvtyPN_invty_nm_tt}" value="#{iimsg.InvtyPN_invty_nm_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_invty_dt_tt_xide" title="#{iimsg.InvtyPN_invty_dt_tt}" value="#{iimsg.InvtyPN_invty_dt_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_vg_tt" title="#{iimsg.InvtyPN_invty_tp_vg_tt}" value="#{iimsg.InvtyPN_invty_tp_vg_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_lc_tt" title="#{iimsg.InvtyPN_invty_tp_lc_tt}" value="#{iimsg.InvtyPN_invty_tp_lc_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_lp_tt" title="#{iimsg.InvtyPN_invty_tp_lp_tt}" value="#{iimsg.InvtyPN_invty_tp_lp_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_lr_tt" title="#{iimsg.InvtyPN_invty_tp_lr_tt}" value="#{iimsg.InvtyPN_invty_tp_lr_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_dp_tt" title="#{iimsg.InvtyPN_invty_tp_dp_tt}" value="#{iimsg.InvtyPN_invty_tp_dp_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_dc_tt" title="#{iimsg.InvtyPN_invty_tp_dc_tt}" value="#{iimsg.InvtyPN_invty_tp_dc_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_pn_tt" title="#{iimsg.InvtyPN_invty_tp_pn_tt}" value="#{iimsg.InvtyPN_invty_tp_pn_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_ps_tt" title="#{iimsg.InvtyPN_invty_tp_ps_tt}" value="#{iimsg.InvtyPN_invty_tp_ps_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_pi_tt" title="#{iimsg.InvtyPN_invty_tp_pi_tt}" value="#{iimsg.InvtyPN_invty_tp_pi_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_pt_tt" title="#{iimsg.InvtyPN_invty_tp_pt_tt}" value="#{iimsg.InvtyPN_invty_tp_pt_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_tu_tt" title="#{iimsg.InvtyPN_invty_tp_tu_tt}" value="#{iimsg.InvtyPN_invty_tp_tu_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_vd_tt" title="#{iimsg.InvtyPN_invty_tp_vd_tt}" value="#{iimsg.InvtyPN_invty_tp_vd_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_bu_tt" title="#{iimsg.InvtyPN_invty_tp_bu_tt}" value="#{iimsg.InvtyPN_invty_tp_bu_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_ed_tt" title="#{iimsg.InvtyPN_invty_tp_ed_tt}" value="#{iimsg.InvtyPN_invty_tp_ed_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_tp_tt" title="#{iimsg.InvtyPN_invty_tp_tp_tt}" value="#{iimsg.InvtyPN_invty_tp_tp_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_invty_tp_tl_tt" title="#{iimsg.InvtyPN_invty_tp_tl_tt}" value="#{iimsg.InvtyPN_invty_tp_tl_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- recdWdColumnGen -->
...
<!-- assist 1 -->
<h:column rendered="#{cadInvtyPNBean.assist}">
<f:facet name="header">
...
<h:inputText id="invty_cd_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_cd}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'INVTP', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="invty_nm_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_nm}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="fil_invty_tp_vg_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_vg}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_lc_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_lc}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_lp_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_lp}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_lr_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_lr}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_dp_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_dp}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_dc_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_dc}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_pn_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_pn}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_ps_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_ps}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_pi_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_pi}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_pt_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_pt}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_tu_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_tu}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_vd_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_vd}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_bu_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_bu}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_ed_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_ed}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_tp_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_tp}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_invty_tp_tl_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadInvtyPNBean.fil_invty_tp_tl}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- recdWdColumnGen -->
...
<!-- Dados -->
<h:dataTable
value="#{cadInvtyPNBean.pesqData}"
var="Invty"
binding="#{cadInvtyPNBean.pesqTable}"
rowClasses="tre9, tro9"
headerClass="tbh9"
footerClass="tbf9"
id="dtDados"
rows="#{cadInvtyPNBean.pageLength}"
first="#{cadInvtyPNBean.currentLine}">
<!-- propColumnGen -->
<h:column id="invty_cd">
...
<!-- REC-30-->  <h:commandButton id="flag_imgrecd_wd" image="../imagens/btRecd.gif" action="#{cadInvtyPNBean.doObternullSearchBack}" onmousedown="wtran='invtypncad';aa=this.id.slice(0,this.id.search('flag_img'));valor1=rpel(aa+'sel_invty_cd');selDtTableOneRow(aa);el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1;"/>
</h:panelGroup>
</h:column>
<!-- propSearchChildTableGen -->
<!-- assist 1 -->
...
<h:commandLink id="xrec_obnv" action="#{cadInvtyPNBean.doNovo}" immediate="true"/>
