...
<title><h:outputText value="#{cadAssetLbdldBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();"  onload="window.focus();loading();ufmvini();tran='assetlbdldcad';cadbeanx='cadAssetLbdldBean'; loadPage(<%= request.getAttribute("pagina") %>); AlternarAbas(parent.cadbeanx, <%=(Object)session.getAttribute(("cadAssetLbdldBeanx"))%>);AlternarSubAbas();">
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetlbdldpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadAssetLbdldBean.doSelecionar}"/>
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetlbdldcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadAssetLbdldBean.doReturnMenu}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadAssetLbdldBean.canUpdate}" image="../imagens/btSave.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetlbdldcad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadAssetLbdldBean.doUpdate}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadAssetLbdldBean.canUpdate}" image="../imagens/btNew.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadAssetLbdldBean.doCancelar}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadAssetLbdldBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadAssetLbdldBean.doExcluir}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}"  action="#{cadAssetLbdldBean.doObter}"  onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetlbdldcad'+'&ufmv='+stx"/>
...
<h:commandButton id="aHelpAssetRfm" tabindex="-1" immediate="true" rendered="#{cadAssetLbdldBean.hasHelpComRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'AssetRfm');" image="../imagens/btHelpCom.gif"/>
<h:commandButton id="aHelpAssetTerrnRfm" tabindex="-1" immediate="true" rendered="#{cadAssetLbdldBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'AssetTerrnRfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:commandButton id="aClose" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
<h:inputHidden id="tabsvf" value="#{cadAssetLbdldBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadAssetLbdldBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadAssetLbdldBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadAssetLbdldBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadAssetLbdldBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadAssetLbdldBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadAssetLbdldBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadAssetLbdldBean.xmesg_st}" />
...
<A href="#" onclick="msgwv('xsel_vali')"><img id="flg_astif" class="btp" align="absmiddle" style="padding:5px; float:left" /></A>
<h:outputLink value="#" onclick="AlternarAbas(parent.cadbeanx, 1);" styleClass="mnt">
<h:outputText value="#{iimsg.AssetLbdld_D00_INFGR_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetLbdld_D00_CARAC_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetLbdld_D00_OCUP_UV_st}"/>
</h:outputLink>
</td>
...
<iframe id="fInvtyTLsak" width="0" height="0" frameborder="0"> </iframe>
<iframe id="fInvtyTLsfk" width="0" height="0" frameborder="0"> </iframe>
<iframe id="InvtyTL" width="0" height="0" frameborder="0"> </iframe>
<iframe id="invty" width="0" height="0" frameborder="0"> </iframe>
<iframe id="fInvtyTLsak" width="0" height="0" frameborder="0"> </iframe>
<iframe id="fInvtyTLsfk" width="0" height="0" frameborder="0"> </iframe>
...
<h:commandLink id="xsel_vali" action="#{cadAssetLbdldBean.doValidate}" immediate="true"/>
...
<h:commandLink id="xsel_invtytl" action="#{cadInvtyTLBean.doSelecionarOnly}" immediate="true"/>
