...
<title><h:outputText value="#{cadZMenuAssetbpadmBean.role}"/></title>
<style>
.menu-group {
	...
	<div class="container bg-transparent minExpand">
		<div class="row">
			<div class="col twelve-mobile text-center">
				...
				<p class="subtitle"><h:outputText value="#{cadZMenuAssetbpadmBean.role}"/></p>
			</div>
		</div>
	<div align="center" class="mt-5">
	<h:selectOneMenu styleClass="btn btn-outline-secondary dropdown-toggle" value="#{cadZMenuAssetbpadmBean.selectedItem}">
	<f:selectItems value="#{cadZMenuAssetbpadmBean.selectItems}" />
	</h:selectOneMenu>
	<h:commandButton value="ativar" styleClass="btn btn-primary" action="#{cadZMenuAssetbpadmBean.action}" />
	<h:messages />
	&nbsp&nbsp&nbsp&nbsp
	<h:inputText id="mesg_var" value="#{cadZMenuAssetbpadmBean.mesg_var}"  styleClass="d-none" tabindex="-1" readonly="true"/>
	</div>
		<div class="row" style="margin-top:50px">						
			<div class="col-sm-3">
					...
					<div class="dropdown-menu rounded" aria-labelledby="dropdownMenuLink" >
							...
							<a class="dropdown-item" href="#">
									<div class="col-12 text-center">
									<h:commandLink id="aExeAssetVhrdv" rendered="#{cadZMenuAssetbpadmBean.canac_assetvhrdv}" onmousedown="fExecx('assetvhrdvpsq', tran, this.id, 'no', '', 'false');" immediate="true" styleClass="mnt" action="#{cadAssetVhrdvBean.doSelecionar}">
			...
			<div class="col-sm-3">
				<div class="mx-auto p-3 text-center">
				<a href="#">
						<h:commandLink id="aExeAssetInvas" rendered="#{cadZMenuAssetbpadmBean.canac_assetinvas}" onmousedown="fExecx('assetinvaspsq', tran, this.id, 'no', '', 'false');" immediate="true" styleClass="mnt" action="#{cadAssetInvasBean.doSelecionar}">
			...
			<div class="col-sm-3">
				<div class="mx-auto p-3 text-center">
				<a href="#">
						<h:commandLink id="aExeAssetEqgpt" rendered="#{cadZMenuAssetbpadmBean.canac_asseteqgpt}" onmousedown="fExecx('asseteqgptpsq', tran, this.id, 'no', '', 'false');" immediate="true" styleClass="mnt" action="#{cadAssetEqgptBean.doSelecionar}">
						<h:graphicImage  url="imagens/GrandePorte.png" height="150px" />
						</h:commandLink>
					<h5 class="mt-3"><h:outputText styleClass="list-inline-item" value="#{iimsg.asseteqgpt_TT_ta}"/></h5>
				</a>
				</div>
			</div>
...
<div class="container bg-transparent minExpand">
		<div class="row" style="margin-top:50px">								
			<div class="col-sm-4">
				<div class="mx-auto p-3 text-center">
				<a href="#">
				<h:commandLink id="aExeImportsq" rendered="#{cadZMenuAssetbpadmBean.canac_importsq}" onmousedown="fExecx('importsqcad', tran, this.id, 'no', '', 'false');" immediate="true" styleClass="mnt" action="#{cadImportsqBean.doObternull}">
				<h:graphicImage  url="imagens/impExcel.png" height="100px" />
				</h:commandLink>
					<h6 class="mt-3"><h:outputText styleClass="list-inline-item" value=" #{iimsg.importat_TT_ta}"/></h5>
				</a>
				</div>			
			</div>			
			<div class="col-sm-4">
				<div class="mx-auto p-3 text-center">
				<a href="#">
				<h:commandLink id="aExeImportat" rendered="#{cadZMenuAssetbpadmBean.canac_importat}" onmousedown="fExecx('importatcad', tran, this.id, 'no', '', 'false');" immediate="true" styleClass="mnt" action="#{cadImportatBean.doObternull}">
				<h:graphicImage  url="imagens/celular.png" height="100px" />
				</h:commandLink>
					<h6 class="mt-3"><h:outputText styleClass="list-inline-item" value="#{iimsg.importsq_TT_ta}"/></h5>
				</a>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="mx-auto p-3 text-center">
				<a href="#">
				<h:commandLink id="aExeObdocrb" rendered="#{cadZMenuAssetbpadmBean.canac_obdocrb}" onmousedown="fExecx('obdocrbpsq', tran, this.id, 'no', '', 'false');" immediate="true" styleClass="mnt" action="#{cadObdocrbBean.doSelecionar}">
				<h:graphicImage  url="imagens/biblio.png" height="100px" />
				</h:commandLink>
					<h6 class="mt-3"><h:outputText styleClass="list-inline-item" value="#{iimsg.obdocrb_TT_ta}"/></h5>
				</a>
				</div>
			</div>
...
<h:inputHidden id="tabsvf" value="#{cadZMenuAssetbpadmBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadZMenuAssetbpadmBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadZMenuAssetbpadmBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadZMenuAssetbpadmBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadZMenuAssetbpadmBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadZMenuAssetbpadmBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadZMenuAssetbpadmBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadZMenuAssetbpadmBean.xmesg_st}" />
...
<h:commandLink id="xsel_vali" action="#{cadZMenuAssetbpadmBean.doValidate}" immediate="true"/>
<h:commandLink id="xsel_codf" action="#{cadCodfBean.doSelecionarOnly}" immediate="true"/>
<h:commandLink id="xrec_obob" action="#{cadZMenuAssetbpadmBean.doObternull}" immediate="true"/>
...
<!-- for current oabv -->
<h:commandLink id="xsel_zmenuassetbpadm" action="#{cadZMenuAssetbpadmBean.doSelecionar}" immediate="true"/>
<h:commandLink id="xrec_zmenuassetbpadm" action="#{cadZMenuAssetbpadmBean.doObternull}" immediate="true"/>
</h:form>
