...
<title><h:outputText value="#{cadAssetVhwagBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();"  onload="window.focus();loading();ufmvini();tran='assetvhwagcad';cadbeanx='cadAssetVhwagBean'; loadPage(<%= request.getAttribute("pagina") %>); AlternarAbas(parent.cadbeanx, <%=(Object)session.getAttribute(("cadAssetVhwagBeanx"))%>);AlternarSubAbas();">
...
<div id="loading" class="loading" align="center"><h:outputText id="label_wait" value="#{iimsg.msg_wait}"/></div>
	<div class="container expand-max bg-transparent mt-3">
	  <div class="row">
		...
		<div class="col-sm-10">
		<h2 class="title" style="font-size: 35px;"><h:outputText styleClass="h2 mt-3"  value="#{cadAssetVhwagBean.trans_tt}"/></h2>
		
		<p class="subtitle" style="text-align:center;color:#505050">
			<h:outputLabel for="asset_id111" >
			<h:outputText value="#{iimsg.AssetBldng_asset_id_tt}"/>
			</h:outputLabel> 
			<h:outputText id="asset_id111" value="#{cadAssetVhwagBean.asset_id}"  />
			<h:outputText value="#{iimsg.AssetBldng_asset_nu_tt}"/>
			<h:outputText id="asset_id_dsc111" value="#{cadAssetVhwagBean.asset_nu}" />
		</p>
		<p style="text-align:center;">
		<h:inputText id="mesg_varastif1" rendered="#{cadAssetVhwagBean.canUpdate}" value="#{cadAssetVhwagBean.mesg_var}"  styleClass="txrr pr5 tb450r" tabindex="-1" readonly="true"/>
		<h:commandButton id="aMessageastif1" image="../imagens/btMessage_off.gif" styleClass="d-none" title="#{iimsg.botao_message}" rendered="#{cadAssetVhwagBean.canUpdate}" action="#{cadAssetVhwagBean.doValidate}" onmousedown="msgw('aMessageastif1');"/>
		</p>
		</div>
		<div class="col-sm-1">
		<h:commandButton id="aBackToSearch11" immediate="true"  styleClass="btn btn-outline-dark" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetbldngpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" value="Voltar" action="#{cadAssetVhwagBean.doSelecionar}"/>
		</div>
	</div>
	</div>
...
<h:commandButton id="aBackToSearch1" immediate="true"  styleClass="d-none" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetvhwagpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadAssetVhwagBean.doSelecionar}"/>
<h:commandButton id="aBackToSearch1Menu" immediate="true"  styleClass="d-none" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetvhwagcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadAssetVhwagBean.doReturnMenu}"/>
<h:commandButton id="aUpdate" styleClass="d-none" rendered="#{cadAssetVhwagBean.canUpdate}" image="../imagens/btSave.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetvhwagcad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadAssetVhwagBean.doUpdate}"/>
<h:commandButton id="aCancelar" styleClass="d-none" rendered="#{cadAssetVhwagBean.canUpdate}" image="../imagens/btNew.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadAssetVhwagBean.doCancelar}"/>
<h:commandButton id="aExcluir" styleClass="d-none" title="#{iimsg.botao_excluir}" rendered="#{cadAssetVhwagBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadAssetVhwagBean.doExcluir}"/>
<h:commandButton id="aRefresh" styleClass="d-none"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}"  action="#{cadAssetVhwagBean.doObter}"  onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetvhwagcad'+'&ufmv='+stx"/>
...
<h:commandButton id="aHelpAssetComRollsRfm" styleClass="d-none" tabindex="-1" immediate="true" rendered="#{cadAssetVhwagBean.hasHelpComRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'AssetComRollsRfm');" image="../imagens/btHelpCom.gif"/>
<h:commandButton id="aHelpAssetRollsRfm" styleClass="d-none" tabindex="-1" immediate="true" rendered="#{cadAssetVhwagBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'AssetRollsRfm');" image="../imagens/btHelpSpc.gif"/>
...
<h:inputHidden id="tabsvf" value="#{cadAssetVhwagBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadAssetVhwagBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadAssetVhwagBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadAssetVhwagBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadAssetVhwagBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadAssetVhwagBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadAssetVhwagBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadAssetVhwagBean.xmesg_st}" />
...
<h:outputText value="#{iimsg.AssetVhwag_D00_INFGERR_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetVhwag_D00_CTB_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetVhwag_D00_STATUS_UV_st}"/>
</h:outputLink>
</td>
...
<iframe id="fInvtyVGsak" width="0" height="0" frameborder="0"> </iframe>
<iframe id="fInvtyVGsfk" width="0" height="0" frameborder="0"> </iframe>
<iframe id="InvtyVG" width="0" height="0" frameborder="0"> </iframe>
<iframe id="invty" width="0" height="0" frameborder="0"> </iframe>
<iframe id="fInvtyVGsak" width="0" height="0" frameborder="0"> </iframe>
<iframe id="fInvtyVGsfk" width="0" height="0" frameborder="0"> </iframe>
...
<h:commandLink id="xsel_vali" action="#{cadAssetVhwagBean.doValidate}" immediate="true"/>
...
<h:commandLink id="xsel_invtyvg" action="#{cadInvtyVGBean.doSelecionarOnly}" immediate="true"/>
