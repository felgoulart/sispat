...
<%@include file="projHeader1.jsp"%>
   <div class="wrapper">
        ...
        <%@include file="AssetMenuLateral.jsp"%>
		                <li>
                    <h:commandButton id="aBackToSearch1" immediate="true"  styleClass="btnvoltar" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetvhwagpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" value="Voltar" action="#{cadAssetVhwagBean.doSelecionar}"/>
                </li>
            </ul>
        </nav>
        <!-- Page Content  -->
				...
				<div class="row">
					...
					<div class="col-sm-10">
						<h2 class="title" style="font-size: 35px;">
							<h:outputText styleClass="h2 mt-3"  value="#{cadAssetVhwagBean.trans_tt}"/>
						</h2>		
					</div>
					<div class="col-sm-1">
							...
							<div class="collapse navbar-collapse" id="navbarSupportedContent">
								<ul class="nav navbar-nav ml-auto">
									...
									<li class="nav-item">
										...
										<a class="nav-link" onclick="AlternarAbas(parent.cadbeanx, 3);"  href="#">Estado de Conservação</a>
									</li>
								</ul>
							</div>
						</div>
