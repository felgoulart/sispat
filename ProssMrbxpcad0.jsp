...
<title><h:outputText value="#{cadProssMrbxpBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();"  onload="window.focus();loading();ufmvini();tran='prossmrbxpcad';cadbeanx='cadProssMrbxpBean'; loadPage(<%= request.getAttribute("pagina") %>); AlternarAbas(parent.cadbeanx, <%=(Object)session.getAttribute(("cadProssMrbxpBeanx"))%>);AlternarSubAbas();">
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'prossmrbxppsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadProssMrbxpBean.doSelecionar}"/>
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'prossmrbxpcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadProssMrbxpBean.doReturnMenu}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadProssMrbxpBean.canUpdate}" image="../imagens/btSave.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'prossmrbxpcad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadProssMrbxpBean.doUpdate}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadProssMrbxpBean.canUpdate}" image="../imagens/btNew.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadProssMrbxpBean.doCancelar}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadProssMrbxpBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadProssMrbxpBean.doExcluir}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}"  action="#{cadProssMrbxpBean.doObter}"  onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'prossmrbxpcad'+'&ufmv='+stx"/>
...
<h:commandButton id="aHelpProssRfm" tabindex="-1" immediate="true" rendered="#{cadProssMrbxpBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'ProssRfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:commandButton id="aClose" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
<h:inputHidden id="tabsvf" value="#{cadProssMrbxpBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadProssMrbxpBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadProssMrbxpBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadProssMrbxpBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadProssMrbxpBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadProssMrbxpBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadProssMrbxpBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadProssMrbxpBean.xmesg_st}" />
...
<h:outputText value="#{iimsg.ProssMrbxp_D00_REGISTER_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.ProssMrbxp_D00_REQUEST_UV_st}"/>
</h:outputLink>
</td>
...
<%@include file="ProssMrbxpcadpjtrg.jsp"%>
</div>
<!-- UV-UV-Stubs/MV D00_REQUEST_UV-->
<div id="abc_pjtrq" style="display: none">
<%@include file="ProssMrbxpcadpjtrq.jsp"%>
</div>
<!-- D00_NOTR -->
...
<h:commandLink id="xsel_vali" action="#{cadProssMrbxpBean.doValidate}" immediate="true"/>
