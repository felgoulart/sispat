...
arCleFields[9][0] = new stCleFields('pjaus_tp_infc_viaferrea', '');
// pjaus_tp_doc_linc_amb 
arCleFields[10] = new Array();
arCleFields[10][0] = new stCleFields('pjaus_tp_doc_linc_amb', '');
// pjaus_id_org_linc_amb 
arCleFields[11] = new Array();
arCleFields[11][0] = new stCleFields('pjaus_id_org_linc_amb', '');
arCleFields[11][1] = new stCleFields('pjaus_id_org_linc_amb_nap', '');
arCleFields[11][2] = new stCleFields('pjaus_id_org_linc_amb_nap_desc', '');
// pjaus_id_org_linc_amb_nap 
arCleFields[12] = new Array();
arCleFields[12][0] = new stCleFields('pjaus_id_org_linc_amb_nap', '');
arCleFields[12][1] = new stCleFields('pjaus_id_org_linc_amb', '');
// pjaus_nu_doc_linc_amb 
arCleFields[13] = new Array();
arCleFields[13][0] = new stCleFields('pjaus_nu_doc_linc_amb', '');
arCleFields[13][1] = new stCleFields('pjaus_nu_doc_linc_amb_nap', '');
arCleFields[13][2] = new stCleFields('pjaus_nu_doc_linc_amb_nap_desc', '');
// pjaus_nu_doc_linc_amb_nap 
arCleFields[14] = new Array();
arCleFields[14][0] = new stCleFields('pjaus_nu_doc_linc_amb_nap', '');
arCleFields[14][1] = new stCleFields('pjaus_nu_doc_linc_amb', '');
// pjaus_dt_exp_linc_amb 
arCleFields[15] = new Array();
arCleFields[15][0] = new stCleFields('pjaus_dt_exp_linc_amb', '');
arCleFields[15][1] = new stCleFields('pjaus_dt_exp_linc_amb_nap', '');
arCleFields[15][2] = new stCleFields('pjaus_dt_exp_linc_amb_nap_desc', '');
// pjaus_dt_exp_linc_amb_nap 
arCleFields[16] = new Array();
arCleFields[16][0] = new stCleFields('pjaus_dt_exp_linc_amb_nap', '');
arCleFields[16][1] = new stCleFields('pjaus_dt_exp_linc_amb', '');
// pjaus_pz_val_linc_amb 
arCleFields[17] = new Array();
arCleFields[17][0] = new stCleFields('pjaus_pz_val_linc_amb', '');
arCleFields[17][1] = new stCleFields('pjaus_pz_val_linc_amb_nap', '');
arCleFields[17][2] = new stCleFields('pjaus_pz_val_linc_amb_nap_desc', '');
// pjaus_pz_val_linc_amb_nap 
arCleFields[18] = new Array();
arCleFields[18][0] = new stCleFields('pjaus_pz_val_linc_amb_nap', '');
arCleFields[18][1] = new stCleFields('pjaus_pz_val_linc_amb', '');
// pjaus_nu_art_proj 
arCleFields[19] = new Array();
arCleFields[19][0] = new stCleFields('pjaus_nu_art_proj', '');
arCleFields[19][1] = new stCleFields('pjaus_nu_art_proj_nap', '');
arCleFields[19][2] = new stCleFields('pjaus_nu_art_proj_nap_desc', '');
// pjaus_nu_art_proj_nap 
arCleFields[20] = new Array();
arCleFields[20][0] = new stCleFields('pjaus_nu_art_proj_nap', '');
arCleFields[20][1] = new stCleFields('pjaus_nu_art_proj', '');
// pjaus_dt_art_proj 
arCleFields[21] = new Array();
arCleFields[21][0] = new stCleFields('pjaus_dt_art_proj', '');
arCleFields[21][1] = new stCleFields('pjaus_dt_art_proj_nap', '');
arCleFields[21][2] = new stCleFields('pjaus_dt_art_proj_nap_desc', '');
// pjaus_dt_art_proj_nap 
arCleFields[22] = new Array();
arCleFields[22][0] = new stCleFields('pjaus_dt_art_proj_nap', '');
arCleFields[22][1] = new stCleFields('pjaus_dt_art_proj', '');
// pjaus_nu_art_exe 
arCleFields[23] = new Array();
arCleFields[23][0] = new stCleFields('pjaus_nu_art_exe', '');
arCleFields[23][1] = new stCleFields('pjaus_nu_art_exe_nap', '');
arCleFields[23][2] = new stCleFields('pjaus_nu_art_exe_nap_desc', '');
// pjaus_nu_art_exe_nap 
arCleFields[24] = new Array();
arCleFields[24][0] = new stCleFields('pjaus_nu_art_exe_nap', '');
arCleFields[24][1] = new stCleFields('pjaus_nu_art_exe', '');
// pjaus_dt_art_exe 
arCleFields[25] = new Array();
arCleFields[25][0] = new stCleFields('pjaus_dt_art_exe', '');
arCleFields[25][1] = new stCleFields('pjaus_dt_art_exe_nap', '');
arCleFields[25][2] = new stCleFields('pjaus_dt_art_exe_nap_desc', '');
// pjaus_dt_art_exe_nap 
arCleFields[26] = new Array();
arCleFields[26][0] = new stCleFields('pjaus_dt_art_exe_nap', '');
arCleFields[26][1] = new stCleFields('pjaus_dt_art_exe', '');
// pjaus_nu_art_fisc 
arCleFields[27] = new Array();
arCleFields[27][0] = new stCleFields('pjaus_nu_art_fisc', '');
arCleFields[27][1] = new stCleFields('pjaus_nu_art_fisc_nap', '');
arCleFields[27][2] = new stCleFields('pjaus_nu_art_fisc_nap_desc', '');
// pjaus_nu_art_fisc_nap 
arCleFields[28] = new Array();
arCleFields[28][0] = new stCleFields('pjaus_nu_art_fisc_nap', '');
arCleFields[28][1] = new stCleFields('pjaus_nu_art_fisc', '');
// pjaus_dt_art_fisc 
arCleFields[29] = new Array();
arCleFields[29][0] = new stCleFields('pjaus_dt_art_fisc', '');
arCleFields[29][1] = new stCleFields('pjaus_dt_art_fisc_nap', '');
arCleFields[29][2] = new stCleFields('pjaus_dt_art_fisc_nap_desc', '');
// pjaus_dt_art_fisc_nap 
arCleFields[30] = new Array();
arCleFields[30][0] = new stCleFields('pjaus_dt_art_fisc_nap', '');
arCleFields[30][1] = new stCleFields('pjaus_dt_art_fisc', '');
// pjaus_tp_investimento 
arCleFields[31] = new Array();
arCleFields[31][0] = new stCleFields('pjaus_tp_investimento', '');
arCleFields[31][1] = new stCleFields('pjaus_vl_investimento', '');
arCleFields[31][2] = new stCleFields('pjaus_pc_investimento', '');
arCleFields[31][3] = new stCleFields('pjaus_qt_part_lucros', '');
// pjaus_vl_investimento 
arCleFields[32] = new Array();
arCleFields[32][0] = new stCleFields('pjaus_vl_investimento', '');
arCleFields[32][1] = new stCleFields('pjaus_vl_investimento_nap', '');
arCleFields[32][2] = new stCleFields('pjaus_vl_investimento_nap_desc', '');
// pjaus_vl_investimento_nap 
arCleFields[33] = new Array();
arCleFields[33][0] = new stCleFields('pjaus_vl_investimento_nap', '');
arCleFields[33][1] = new stCleFields('pjaus_vl_investimento', '');
// pjaus_pc_investimento 
arCleFields[34] = new Array();
arCleFields[34][0] = new stCleFields('pjaus_pc_investimento', '');
arCleFields[34][1] = new stCleFields('pjaus_pc_investimento_nap', '');
arCleFields[34][2] = new stCleFields('pjaus_pc_investimento_nap_desc', '');
// pjaus_pc_investimento_nap 
arCleFields[35] = new Array();
arCleFields[35][0] = new stCleFields('pjaus_pc_investimento_nap', '');
arCleFields[35][1] = new stCleFields('pjaus_pc_investimento', '');
// pjaus_qt_part_lucros 
arCleFields[36] = new Array();
arCleFields[36][0] = new stCleFields('pjaus_qt_part_lucros', '');
arCleFields[36][1] = new stCleFields('pjaus_qt_part_lucros_nap', '');
arCleFields[36][2] = new stCleFields('pjaus_qt_part_lucros_nap_desc', '');
// pjaus_qt_part_lucros_nap 
arCleFields[37] = new Array();
arCleFields[37][0] = new stCleFields('pjaus_qt_part_lucros_nap', '');
arCleFields[37][1] = new stCleFields('pjaus_qt_part_lucros', '');
// pjaus_dt_assinatura_ctr 
arCleFields[38] = new Array();
arCleFields[38][0] = new stCleFields('pjaus_dt_assinatura_ctr', '');
arCleFields[38][1] = new stCleFields('pjaus_dt_assinatura_ctr_nap', '');
arCleFields[38][2] = new stCleFields('pjaus_dt_assinatura_ctr_nap_desc', '');
// pjaus_dt_assinatura_ctr_nap 
arCleFields[39] = new Array();
arCleFields[39][0] = new stCleFields('pjaus_dt_assinatura_ctr_nap', '');
arCleFields[39][1] = new stCleFields('pjaus_dt_assinatura_ctr', '');
// pjaus_dt_ini_vigencia 
arCleFields[40] = new Array();
arCleFields[40][0] = new stCleFields('pjaus_dt_ini_vigencia', '');
arCleFields[40][1] = new stCleFields('pjaus_dt_ini_vigencia_nap', '');
arCleFields[40][2] = new stCleFields('pjaus_dt_ini_vigencia_nap_desc', '');
// pjaus_dt_ini_vigencia_nap 
arCleFields[41] = new Array();
arCleFields[41][0] = new stCleFields('pjaus_dt_ini_vigencia_nap', '');
arCleFields[41][1] = new stCleFields('pjaus_dt_ini_vigencia', '');
// pjaus_dt_trm_contrato 
arCleFields[42] = new Array();
arCleFields[42][0] = new stCleFields('pjaus_dt_trm_contrato', '');
arCleFields[42][1] = new stCleFields('pjaus_dt_trm_contrato_nap', '');
arCleFields[42][2] = new stCleFields('pjaus_dt_trm_contrato_nap_desc', '');
// pjaus_dt_trm_contrato_nap 
arCleFields[43] = new Array();
arCleFields[43][0] = new stCleFields('pjaus_dt_trm_contrato_nap', '');
arCleFields[43][1] = new stCleFields('pjaus_dt_trm_contrato', '');
// pjaus_tp_arrecadacao 
arCleFields[44] = new Array();
arCleFields[44][0] = new stCleFields('pjaus_tp_arrecadacao', '');
arCleFields[44][1] = new stCleFields('pjaus_vl_contrato', '');
arCleFields[44][2] = new stCleFields('pjaus_vl_aval_tecnica', '');
arCleFields[44][3] = new stCleFields('pjaus_vl_fiscalizacao', '');
arCleFields[44][4] = new stCleFields('pjaus_vl_uso_faixa_dominio', '');
arCleFields[44][5] = new stCleFields('pjaus_vl_parc_arrc', '');
arCleFields[44][6] = new stCleFields('pjaus_qt_parc_arrc', '');
arCleFields[44][7] = new stCleFields('pjaus_vl_prim_parc', '');
// pjaus_qt_part_lucros_arr 
arCleFields[45] = new Array();
arCleFields[45][0] = new stCleFields('pjaus_qt_part_lucros_arr', '');
arCleFields[45][1] = new stCleFields('pjaus_qt_part_lucros_arr_nap', '');
arCleFields[45][2] = new stCleFields('pjaus_qt_part_lucros_arr_nap_desc', '');
// pjaus_qt_part_lucros_arr_nap 
arCleFields[46] = new Array();
arCleFields[46][0] = new stCleFields('pjaus_qt_part_lucros_arr_nap', '');
arCleFields[46][1] = new stCleFields('pjaus_qt_part_lucros_arr', '');
// pjaus_dt_ini_arr 
arCleFields[47] = new Array();
arCleFields[47][0] = new stCleFields('pjaus_dt_ini_arr', '');
arCleFields[47][1] = new stCleFields('pjaus_dt_ini_arr_nap', '');
arCleFields[47][2] = new stCleFields('pjaus_dt_ini_arr_nap_desc', '');
// pjaus_dt_ini_arr_nap 
arCleFields[48] = new Array();
arCleFields[48][0] = new stCleFields('pjaus_dt_ini_arr_nap', '');
arCleFields[48][1] = new stCleFields('pjaus_dt_ini_arr', '');
// pjaus_dt_trm_arr 
arCleFields[49] = new Array();
arCleFields[49][0] = new stCleFields('pjaus_dt_trm_arr', '');
arCleFields[49][1] = new stCleFields('pjaus_dt_trm_arr_nap', '');
arCleFields[49][2] = new stCleFields('pjaus_dt_trm_arr_nap_desc', '');
// pjaus_dt_trm_arr_nap 
arCleFields[50] = new Array();
arCleFields[50][0] = new stCleFields('pjaus_dt_trm_arr_nap', '');
arCleFields[50][1] = new stCleFields('pjaus_dt_trm_arr', '');
...
function PjausPapus_pjtct_hl() {
    // alert('PjausPapus_pjtct_hl()'); // qqq 
    pjaus_tp_investimento_hl('');
    pjaus_tp_arrecadacao_hl('');
}
function PjausPapus_hl() {
    pjaus_tp_investimento_hl('');
    pjaus_tp_arrecadacao_hl('');
}
