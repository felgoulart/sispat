...
<title><h:outputText value="#{cadHelpSearchBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();" onload="window.focus();loading();ufmvini();tran='helpsearchcad';cadbeanx='cadHelpSearchBean';loadPage(<%= request.getAttribute("pagina") %>);">
...
<h:outputText value=":"/>
<h:outputText value="#{cadHelpSearchBean.help_nm}"/>
</td>
...
<h:commandButton id="aHelpHelpSearchRfm" tabindex="-1" immediate="true" rendered="#{cadHelpSearchBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'HelpSearchRfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:commandButton id="aClose" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
<h:inputHidden id="tabsvf" value="#{cadHelpSearchBean.tabsvf}" />
<h:inputHidden id="tabsvf_in" value="#{cadHelpSearchBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadHelpSearchBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadHelpSearchBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadHelpSearchBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadHelpSearchBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadHelpSearchBean.xmesg_st}" />
...
<td   colspan="2"    >
<h:inputText id="mesg_var" value="#{cadHelpSearchBean.mesg_var}"  styleClass="txrr pr5 tb450r" tabindex="-1" readonly="true"/>
<ps:psCommandLink id="aMessage" rendered="#{cadHelpSearchBean.canUpdate}" action="#{cadHelpSearchBean.doValidate}" onmousedown="msgw('aMessage');">
...
<%-- outputLabel aaa --%>
<h:outputLabel  styleClass="tip txl pl0"  id="lbl_help_cd" for="help_cd"  value="#{iimsg.HelpSearch_help_cd_tt}"/>  </td> <%-- <top> --%>
<%-- prop Primary Key --%>
<%-- Processing Pk --%>
<%-- Processing Pk ccc --%>
<td  width="100" > <h:inputText id="help_cd" tabindex="1"  value="#{cadHelpSearchBean.help_cd}"  styleClass="txl pl5 tbx" size="22" maxlength="20" onchange="bv('','help_cd','0',this.value);"/>
<ps:psGraphicImage id="help_cd_vc" flagType="val" flag="#{cadHelpSearchBean.help_cd_vc}" styleClass="btp"/>
</td> <%-- <close td> ccc --%>
<td        width="150" > <%-- open w/ inputText 222--%>
<%-- outputLabel aaa --%>
<h:outputLabel  styleClass="tip txl pl0"  id="lbl_help_lg" for="help_lg"  value="#{iimsg.HelpSearch_help_lg_tt}"/>  </td> <%-- <top> --%>
<%-- Processing Codf --%>
<td   width="100"   >
<%-- Processing Codf 1--%>
<h:inputText  id="help_lg" value="#{cadHelpSearchBean.help_lg}" onkeydown="keypress=1;"  styleClass="txl pl5 tbx" onchange="bdcd('','help_lg','0','GNLNG',this.value);" size="7" maxlength="5" tabindex="2" />
...
<ps:psGraphicImage id="help_lg_vc" flagType="val" flag="#{cadHelpSearchBean.help_lg_vc}" styleClass="btp"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<%-- Hidden --%>
<h:inputHidden id="help_st" value="#{cadHelpSearchBean.help_st}"/>
<td        width="60" > <%-- open w/ inputText 222--%>
<%-- outputLabel aaa --%>
<h:outputLabel  styleClass="tip txl pl0"  id="lbl_help_nm" for="help_nm"  value="#{iimsg.HelpSearch_help_nm_tt}"/>  </td> <%-- <top> --%>
<%-- inputText --%>
<%-- nowrap 5676 --%>
<td  colspan ="4" width="350"   >
<h:inputText id="help_nm" tabindex="3"  value="#{cadHelpSearchBean.help_nm}" size="102" maxlength="100"  styleClass="txl pl5 tbx" onchange="bv('','help_nm','0',this.value);"/>
<ps:psGraphicImage id="help_nm_vc" flagType="val" flag="#{cadHelpSearchBean.help_nm_vc}" styleClass="btp"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
...
<tr>   <%-- <tr open> vvv --%>
<%-- inputTextArea --%>
<td   colspan="4" >  <h:inputTextarea id="help_ds" tabindex="4"  value="#{cadHelpSearchBean.help_ds}" cols="100" rows="33" styleClass="help_ds_rtfFull" onchange="bv('','help_ds','0',this.value);"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
...
<h:commandLink id="xsel_vali" action="#{cadHelpSearchBean.doValidate}" immediate="true"/>
...
<h:commandLink id="xrec_Help" action="#{cadHelpBean.doObternull}" immediate="true"/>
<!-- for current oabv -->
<h:commandLink id="xsel_helpsearch" action="#{cadHelpSearchBean.doSelecionar}" immediate="true"/>
