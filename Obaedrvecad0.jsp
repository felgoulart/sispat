...
<%session.setAttribute("cadbeanx","cadObaedrveBean");%>
...
<title><h:outputText value="#{cadObaedrveBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();" onload="window.focus();loading();ufmvini();tran='obaedrvecad';cadbeanx='cadObaedrveBean';loadPage(<%= request.getAttribute("pagina") %>);">
...
<h:outputText value="#{cadObaedrveBean.trans_tt}"/>
</td>
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obaedrvepsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadObaedrveBean.doSelecionarBackx}"/>
...
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obaedrvecad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadObaedrveBean.doReturnMenu}"/>
<h:commandButton id="aPrev" immediate="true" styleClass="btp" rendered="#{cadObaedrveBean.idxflag}" image="../imagens/btPgAnterior.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_anterior}" action="#{cadObaedrveBean.doObternullPrev}"/>
<h:commandButton id="aNext" immediate="true" styleClass="btp" rendered="#{cadObaedrveBean.idxflag}" image="../imagens/btPgProxima.gif" onmousedown="msgwr()" title="#{iimsg.botao_proxima}" action="#{cadObaedrveBean.doObternullNext}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadObaedrveBean.canUpdate}" image="../imagens/btSave.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obaedrvecad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadObaedrveBean.doUpdate1Chld}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadObaedrveBean.canUpdate}" image="../imagens/btNew.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadObaedrveBean.doObterParentForCancel}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadObaedrveBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadObaedrveBean.doExcluirChld}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}"  action="#{cadObaedrveBean.doObter}"  onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obaedrvecad'+'&ufmv='+stx"/>
...
<h:inputHidden id="tabsvf" value="#{cadObaedrveBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadObaedrveBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadObaedrveBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadObaedrveBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadObaedrveBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadObaedrveBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadObaedrveBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadObaedrveBean.xmesg_st}" />
...
<td   colspan="2"    >
<h:inputText id="mesg_var" value="#{cadObaedrveBean.mesg_var}"  styleClass="txrr pr5 tb450r" tabindex="-1" readonly="true"/>
<h:commandButton id="aMessage" image="../imagens/btMessage_off.gif" styleClass="btp" title="#{iimsg.botao_message}" rendered="#{cadObaedrveBean.canUpdate}" action="#{cadObaedrveBean.doValidate}" onmousedown="msgw('aMessage');"/>
<h:inputText id="idxm" value="#{cadObaedrveBean.idxm}"  styleClass="txrr pr5 tb50r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> bbb --%>
</tr> <%-- <tr close> bbb --%>
<tr>   <%-- <tr open> vvv --%>
...
<%-- Processing Fk --%>
<%-- Processing Fk 333--%>
<h:inputText id="obaed_id" tabindex="-1"  onclick="clf(this);" readonly="true" value="#{cadObaedrveBean.obaed_id}"  styleClass="tbxr" onkeydown="keypress=1;" size="20" maxlength="20" />
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
<%-- prop Primary Key --%>
<%-- Processing Pk --%>
<h:inputHidden id="obaed_sq" value="#{cadObaedrveBean.obaed_sq}"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<h:inputText  id="obaed_tp" onclick="clf(this);" value="#{cadObaedrveBean.obaed_tp}" onkeydown="keypress=1;"  styleClass="tbx" onchange="bdcd('','obaed_tp','0','TPAED',this.value);;" size="7" maxlength="5" tabindex="1" />
...
<ps:psGraphicImage id="obaed_tp_vc" flagType="val" flag="#{cadObaedrveBean.obaed_tp_vc}" styleClass="btp"/>
<%-- Processing Codf 1 AAA --%>
<h:inputText id="obaed_tp_desc" tabindex="-1" onfocus="this.blur()" value="#{cadObaedrveBean.obaed_tp_desc}" styleClass="txlr pr5 tb90r"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<%-- Processing Codf 1--%>
<%-- Processing Codf 1 HLFN --%>
<h:inputText  id="obaed_vl" onclick="clf(this);" value="#{cadObaedrveBean.obaed_vl}" onkeydown="keypress=1;"  styleClass="tbx" onchange="bdcd('','obaed_vl','0','ANRVE',this.value);;" size="7" maxlength="5" tabindex="2" />
...
<ps:psGraphicImage id="obaed_vl_vc" flagType="val" flag="#{cadObaedrveBean.obaed_vl_vc}" styleClass="btp"/>
<%-- Processing Codf 1 AAA --%>
<h:inputText id="obaed_vl_desc" tabindex="-1" onfocus="this.blur()" value="#{cadObaedrveBean.obaed_vl_desc}" styleClass="txlr pr5 tb90r"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<!-- D00_NOTR -->
...
<h:commandLink id="xsel_vali" action="#{cadObaedrveBean.doValidate}" immediate="true"/>
<h:commandLink id="xsel_codf" action="#{cadCodfBean.doSelecionarOnly}" immediate="true"/>
<h:commandLink id="xrec_obob" action="#{cadObaedrveBean.doObternull}" immediate="true"/>
...
<!-- for current oabv -->
<h:commandLink id="xsel_obaedrve" action="#{cadObaedrveBean.doSelecionar}" immediate="true"/>
<h:commandLink id="xrec_obaedrve" action="#{cadObaedrveBean.doObternull}" immediate="true"/>
</h:form>
