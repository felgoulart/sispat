...
<%session.setAttribute("cadbeanx","cadAssetYrdsdBean");%>
...
<link rel="stylesheet" href="../AssetYrdsdpsq.css" type="text/css">
...
<script src="../AssetYrdsdfunctions.js" type="text/javascript" language="javascript"></script>
<SCRIPT type="text/javascript">
function fPgAssist() {
page_assist = <%= session.getAttribute("assetyrdsdpsq") %>;
return page_assist;
}
function loadPage() {
hovDtTable('dtDados');
...
<title>
<h:outputText value="#{cadAssetYrdsdBean.trans_tt}"/>
</title>
</head>
<body onload="window.focus();loadPage();loading();fcf('cadForm:asset_km_range_sqlparm');helpcd='AssetYrdsdSfm';;tran='assetyrdsdpsq'; vl='';cadbeanx='cadAssetYrdsdBean';<%session.setAttribute("tipo","assetyrdsdpsq");%>">
<h:form id="cadForm">
...
<h:commandButton id="aBackToSearch" styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+''+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadAssetYrdsdBean.doReturnMenu}"/>
<h:commandButton id="aPrev" styleClass="btp"  image="../imagens/btPgAnterior.gif" title="#{iimsg.botao_anterior}" rendered="#{cadAssetYrdsdBean.hasPrevPage}" action="#{cadAssetYrdsdBean.doPaginaAnterior}"/>
<h:commandButton id="aNext" styleClass="btp"  image="../imagens/btPgProxima.gif" title="#{iimsg.botao_proxima}" rendered="#{cadAssetYrdsdBean.hasNextPage}" action="#{cadAssetYrdsdBean.doProximaPagina}"/>
<h:outputText id="label_fill" style="display:none" value="#{iimsg.label_fill}" />
<h:outputText id="label_notfound" style="display:none" value="#{iimsg.label_notfound}" />
<h:outputText id="sys_openning_form" style="display:none" value="#{iimsg.sys_openning_form}" />
<h:commandButton id="aFiltrar" styleClass="btp"  image="../imagens/btFilter.gif" title="#{iimsg.botao_filtrar}" action="#{cadAssetYrdsdBean.doSelecionar}"/>
<h:commandButton id="aLimpar" styleClass="btp" rendered="#{cadAssetYrdsdBean.canPesquisar}" image="../imagens/btCancel.gif" title="#{iimsg.botao_limpar}" action="#{cadAssetYrdsdBean.doLimparPesq}"/>
<h:commandButton id="aNew" styleClass="btp" rendered="#{cadAssetYrdsdBean.canInserir}" image="../imagens/btNew.gif" onmousedown="fNovorwpp('assetyrdsdcad', tran, this.id, 'yes', fPgAssist());" title="#{iimsg.botao_novo}" action="#{cadAssetYrdsdBean.doNovo}"/>
<h:commandButton id="XlsExport_xls_stb" rendered="#{cadAssetYrdsdBean.canPesquisar}" title="#{iimsg.AssetYrdsd_XlsExport_xls_stb_tt}" image="../imagens/excellRed.jpg" action="#{cadAssetYrdsdBean.doXlsExport_xls_stb}"/>
...
<h:commandButton id="aHelpAssetComSfm" tabindex="-1" rendered="#{cadAssetYrdsdBean.hasHelpComSfm}" immediate="true" title="#{iimsg.botao_help_com}" onmousedown="pw('helpcad', tran, this.id, 'yes','AssetComSfm');" image="../imagens/btHelpCom.gif"/>
...
<h:inputHidden id="xmesg_rc" value="#{cadAssetYrdsdBean.xmesg_rc}" />
<h:inputHidden id="xhelp_rc" value="#{cadAssetYrdsdBean.xhelp_rc}" />
...
<%@include file="AssetYrdsdpsq_param.jsp"%>
<table    >  <%-- <search mesg frame open> --%>
<tr>  <%-- <tr open> msg --%>
<td      width="50" > <%-- open w/ inputText 222--%>
<h:inputText id="mesg_var" value="#{cadAssetYrdsdBean.mesg_var}"  styleClass="txrr pr5 tb600r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> msg --%>
<td> &nbsp&nbsp </td>
<td      width="50" > <%-- open w/ inputText 222--%>
<%-- outputLabel msg --%>
...
<%-- outputText --%>
<td    width="100" > <h:inputText id="codfqt" onfocus="this.blur()" value="#{cadAssetYrdsdBean.codfqt}" size="5" maxlength="5"  styleClass="txl pl5 tbxr"/>
</td> <%-- <close td> msg --%>
</tr> <%-- <tr close> msg--%>
...
<h:outputText id="hd_asset_nu_tt_xide" title="#{iimsg.AssetYrdsd_asset_nu_tt}" value="#{iimsg.AssetYrdsd_asset_nu_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_st_operacional_cfoperc_tt" title="#{iimsg.AssetYrdsd_asset_st_operacional_cfoperc_tt}" value="#{iimsg.AssetYrdsd_asset_st_operacional_cfoperc_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_tp_propriedade_tt" title="#{iimsg.AssetYrdsd_asset_tp_propriedade_tt}" value="#{iimsg.AssetYrdsd_asset_tp_propriedade_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- fkeyColumnGen -->
...
<h:outputText id="hd_asset_cd_ccusto_tt" title="#{iimsg.AssetYrdsd_asset_cd_ccusto_tt}" value="#{iimsg.AssetYrdsd_asset_cd_ccusto_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_uf_tt" title="#{iimsg.AssetYrdsd_asset_cd_uf_tt}" value="#{iimsg.AssetYrdsd_asset_cd_uf_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_cfresid_tt" title="#{iimsg.AssetYrdsd_asset_cd_cfresid_tt}" value="#{iimsg.AssetYrdsd_asset_cd_cfresid_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_trecho_tt" title="#{iimsg.AssetYrdsd_asset_cd_trecho_tt}" value="#{iimsg.AssetYrdsd_asset_cd_trecho_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_subtrecho_tt" title="#{iimsg.AssetYrdsd_asset_cd_subtrecho_tt}" value="#{iimsg.AssetYrdsd_asset_cd_subtrecho_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_km_ini_tt_xide" title="#{iimsg.AssetYrdsd_asset_km_ini_tt}" value="#{iimsg.AssetYrdsd_asset_km_ini_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_km_fim_tt_xide" title="#{iimsg.AssetYrdsd_asset_km_fim_tt}" value="#{iimsg.AssetYrdsd_asset_km_fim_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_cfreslc_tt" title="#{iimsg.AssetYrdsd_asset_cd_cfreslc_tt}" value="#{iimsg.AssetYrdsd_asset_cd_cfreslc_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_cfreslc_prx_tt" title="#{iimsg.AssetYrdsd_asset_cd_cfreslc_prx_tt}" value="#{iimsg.AssetYrdsd_asset_cd_cfreslc_prx_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_tp_trilho_tt" title="#{iimsg.AssetYrdsd_asset_tp_trilho_tt}" value="#{iimsg.AssetYrdsd_asset_tp_trilho_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_tp_ligacao_tt" title="#{iimsg.AssetYrdsd_asset_tp_ligacao_tt}" value="#{iimsg.AssetYrdsd_asset_tp_ligacao_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_tp_fixacao_tt" title="#{iimsg.AssetYrdsd_asset_tp_fixacao_tt}" value="#{iimsg.AssetYrdsd_asset_tp_fixacao_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_tp_dormente_tt" title="#{iimsg.AssetYrdsd_asset_tp_dormente_tt}" value="#{iimsg.AssetYrdsd_asset_tp_dormente_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_tp_lastro_tt" title="#{iimsg.AssetYrdsd_asset_tp_lastro_tt}" value="#{iimsg.AssetYrdsd_asset_tp_lastro_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_st_geral_tt" title="#{iimsg.AssetYrdsd_asset_st_geral_tt}" value="#{iimsg.AssetYrdsd_asset_st_geral_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_in_manut_tt" title="#{iimsg.AssetYrdsd_asset_in_manut_tt}" value="#{iimsg.AssetYrdsd_asset_in_manut_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_termo_devolucao_ckb_tt" title="#{iimsg.AssetYrdsd_asset_cd_termo_devolucao_ckb_has_tt}" value="#{iimsg.AssetYrdsd_asset_cd_termo_devolucao_ckb_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_termo_entrega_ckb_tt" title="#{iimsg.AssetYrdsd_asset_cd_termo_entrega_ckb_has_tt}" value="#{iimsg.AssetYrdsd_asset_cd_termo_entrega_ckb_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:outputText id="hd_asset_cd_tombamento_ckb_tt" title="#{iimsg.AssetYrdsd_asset_cd_tombamento_ckb_has_tt}" value="#{iimsg.AssetYrdsd_asset_cd_tombamento_ckb_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_asset_dt_vistoria_tt_xide" title="#{iimsg.AssetYrdsd_asset_dt_vistoria_tt}" value="#{iimsg.AssetYrdsd_asset_dt_vistoria_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenTransGen -->
...
<h:outputText id="hd_asset_images_ongrid_tt_xide" title="#{iimsg.AssetYrdsd_asset_images_ongrid_tt}" value="#{iimsg.AssetYrdsd_asset_images_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
...
<h:outputText id="hd_asset_docs_ongrid_tt_xide" title="#{iimsg.AssetYrdsd_asset_docs_ongrid_tt}" value="#{iimsg.AssetYrdsd_asset_docs_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenChildTransGen -->
...
<h:outputText id="hd_asset_ocrs_ongrid_tt_xide" title="#{iimsg.AssetYrdsd_asset_ocrs_ongrid_tt}" value="#{iimsg.AssetYrdsd_asset_ocrs_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenTransGen -->
...
<h:outputText id="hd_asset_geo_ongrid_tt_xide" title="#{iimsg.AssetYrdsd_asset_geo_ongrid_tt}" value="#{iimsg.AssetYrdsd_asset_geo_ongrid_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:outputText id="hd_tabs_vc_tt_xide" title="#{iimsg.AssetYrdsd_tabs_vc_tt}" value="#{iimsg.AssetYrdsd_tabs_vc_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- recdWdColumnGen -->
...
<h:inputText id="fil_asset_st_operacional_cfoperc_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'OPERC', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdsdBean.fil_asset_st_operacional_cfoperc}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<!--   // 444-->
<h:inputText id="asset_cd_ccusto_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('Ixccustpsq', tran, this.id, 'no', vl);" onblur="cfb(this.id, 'pfdb9', 'pfd9');" onfocus="this.className='pfd9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdsdBean.fil_asset_cd_ccusto}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_asset_tp_trilho_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'TRTPA', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdsdBean.fil_asset_tp_trilho}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_asset_tp_ligacao_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'TRITL', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdsdBean.fil_asset_tp_ligacao}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_asset_tp_fixacao_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'TRITF', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdsdBean.fil_asset_tp_fixacao}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_asset_tp_dormente_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'TPDOR', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdsdBean.fil_asset_tp_dormente}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_asset_tp_lastro_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'TPLST', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdsdBean.fil_asset_tp_lastro}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_asset_in_manut_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'SN', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdsdBean.fil_asset_in_manut}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_asset_cd_termo_devolucao_ckb_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdsdBean.fil_asset_cd_termo_devolucao_ckb}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_asset_cd_termo_entrega_ckb_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdsdBean.fil_asset_cd_termo_entrega_ckb}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- codfColumnGen -->
...
<h:inputText id="fil_asset_cd_tombamento_ckb_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('C'+'GNSIT', tran, this.id);" onblur="cfb(this.id, 'pfcfb9', 'pfcf9');" onfocus="this.className='pfcf9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadAssetYrdsdBean.fil_asset_cd_tombamento_ckb}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="tabs_vc_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadAssetYrdsdBean.fil_tabs_vc}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- recdWdColumnGen -->
...
<!-- Dados -->
<h:dataTable
value="#{cadAssetYrdsdBean.pesqData}"
var="Asset"
binding="#{cadAssetYrdsdBean.pesqTable}"
rowClasses="tre9, tro9"
headerClass="tbh9"
footerClass="tbf9"
id="dtDados"
rows="#{cadAssetYrdsdBean.pageLength}"
first="#{cadAssetYrdsdBean.currentLine}">
<!-- propColumnGen -->
<h:column id="asset_nu">
...
<h:commandButton id="flag_imgrecd_wd_asset_images_ongrid" action="#{cadObimgBean.doObternull}"  image="#{Asset.imag_im}"  onmousedown="wtran='obimgcad';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_asset_idasset_images_ongrid_bt').value;el('fiiSaveType').src = 'iiSaveType.jsp?tbak=assetyrdsdpsq&tipo='+wtran+'&valor='+valor1;" onmouseup="this.form.target='_blank';" onblur="this.form.target='_self';"/>
</h:panelGroup>
</h:column>
<!-- buttonOpenChildTransGen -->
<h:column id="asset_docs_ongrid_bt">
...
<h:commandButton id="flag_imgrecd_wd_asset_docs_ongrid" action="#{cadObdocBean.doSelecionar}" image="#{Asset.file_im}" onmousedown="wtran='obdocpsq';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_asset_idasset_docs_ongrid_bt').value;el('fiiSaveTypex').src = 'iiSaveTypex.jsp?tbak=assetyrdsdpsq&tipo='+wtran+'&valor='+valor1;el('fiiSaveField').src='iiSaveField.jsp?campo=campo1&valor='+valor1;" onmouseup="this.form.target='_blank';" onblur="this.form.target='_self';"/>
</h:panelGroup>
</h:column>
<!-- buttonOpenChildTransGen -->
<h:column id="asset_ocrs_ongrid_bt">
...
<h:outputLink id="flag_imggeo_asset_geo_ongrid" value="mapa.jsp?bp=" target="_blank" onclick="aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_asset_idasset_geo_ongrid_bt').value;valor1=valor1.slice(0,valor1.length - 5);this.href='mapa.jsp?bp='+valor1+'&type=DP';">
<ps:psGraphicImage  flagType="geo" flag="#{Asset.geo_vx}" title="#{iimsg.AssetYrdsd_asset_geo_ongrid_tt}" styleClass="btp" />
</h:outputLink>
</h:panelGroup>
</h:column>
<!-- propColumnGen -->
...
<h:commandLink id="flag_imgAssetYrdsd" onmousedown="wtran='assetyrdsdcad';el('hiddenform').target=tran;aa=this.id.slice(0,this.id.search('flag_img'));valor1=el(aa+'sel_asset_id').value;el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1;showpopup(tran,'xrec_obob',this.id,wtran,'yes');">
...
<!-- REC-30-->  <h:commandButton id="flag_imgrecd_wd" image="../imagens/btRecd.gif" action="#{cadAssetYrdsdBean.doObternullSearchBack}" onmousedown="wtran='assetyrdsdcad';aa=this.id.slice(0,this.id.search('flag_img'));valor1=rpel(aa+'sel_asset_id');selDtTableOneRow(aa);el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1;"/>
</h:panelGroup>
</h:column>
<!-- propSearchChildTableGen -->
</h:dataTable>
...
<iframe id="InvtyDP" width="0" height="0" frameborder="0"> </iframe>
<iframe id="InvtyDP" width="0" height="0" frameborder="0"> </iframe>
<iframe id="InvtyDP" width="0" height="0" frameborder="0"> </iframe>
...
<h:commandLink id="xrec_obob" action="#{cadAssetYrdsdBean.doObternull}" immediate="true"/>
<h:commandLink id="xrec_obnv" action="#{cadAssetYrdsdBean.doNovo}" immediate="true"/>
...
<h:commandLink id="xnew_invtydp" action="#{cadInvtyDPBean.doObternull}" immediate="true"/>
