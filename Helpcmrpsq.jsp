...
<%session.setAttribute("cadbeanx","cadHelpcmrBean");%>
...
<link rel="stylesheet" href="../Helpcmrpsq.css" type="text/css">
...
function fPgAssist() {
page_assist = <%= session.getAttribute("helpcmrpsq") %>;
return page_assist;
}
function loadPage() {
hovDtTable('dtDados');
...
<title>
<h:outputText value="#{cadHelpcmrBean.trans_tt}"/>
</title>
</head>
<body onload="window.focus();loadPage();loading();helpcd='';;tran='helpcmrpsq'; vl='';cadbeanx='cadHelpcmrBean';<%session.setAttribute("tipo","helpcmrpsq");%>">
<h:form id="cadForm">
...
<h:commandButton id="aPrev" styleClass="btp"  image="../imagens/btPgAnterior.gif" title="#{iimsg.botao_anterior}" rendered="#{cadHelpcmrBean.hasPrevPage}" action="#{cadHelpcmrBean.doPaginaAnterior}"/>
<h:commandButton id="aNext" styleClass="btp"  image="../imagens/btPgProxima.gif" title="#{iimsg.botao_proxima}" rendered="#{cadHelpcmrBean.hasNextPage}" action="#{cadHelpcmrBean.doProximaPagina}"/>
<h:outputText id="label_fill" style="display:none" value="#{iimsg.label_fill}" />
<h:outputText id="label_notfound" style="display:none" value="#{iimsg.label_notfound}" />
<h:outputText id="sys_openning_form" style="display:none" value="#{iimsg.sys_openning_form}" />
<ps:psCommandLink id="aFiltrar" styleClass="btp"  ativo="../imagens/btFilter.gif" title="#{iimsg.botao_filtrar}" action="#{cadHelpcmrBean.doSelecionar}">
<f:param name="campo5" value=""/>
<f:param name="campo6" value=""/>
<f:param name="tipo" value="helpcmrpsq"/>
</ps:psCommandLink>
<h:commandButton id="aHelp" tabindex="-1" immediate="true" title="#{iimsg.botao_help}" onmousedown="pw('helpcad', tran, this.id, 'yes','Helpcmr');" image="../imagens/btHelp.gif"/>
...
<h:commandButton id="aHelpHelpcmrSfm" tabindex="-1" rendered="#{cadHelpcmrBean.hasHelpSpcSfm}" immediate="true" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes','HelpcmrSfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aHelpgSearch" tabindex="-1" immediate="true" title="#{iimsg.button_help_repository}" onmousedown="pw('helpsearchpsq', tran, this.id, 'yes', 'HelpSearch');" image="../imagens/btHelpRep.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:inputHidden id="xmesg_rc" value="#{cadHelpcmrBean.xmesg_rc}" />
<h:inputHidden id="xhelp_rc" value="#{cadHelpcmrBean.xhelp_rc}" />
...
<h:inputText id="mesg_var" value="#{cadHelpcmrBean.mesg_var}"  styleClass="txrr pr5 tb600r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> msg --%>
<td> &nbsp&nbsp </td>
<td      width="50" > <%-- open w/ inputText 222--%>
<%-- outputLabel msg --%>
...
<%-- outputText --%>
<td    width="100" > <h:inputText id="codfqt" onfocus="this.blur()" value="#{cadHelpcmrBean.codfqt}" size="5" maxlength="5"  styleClass="txl pl5 tbxr"/>
</td> <%-- <close td> msg --%>
</tr> <%-- <tr close> msg--%>
...
<h:outputText id="hd_help_cd_tt_xide" title="#{iimsg.Helpcmr_help_cd_tt}" value="#{iimsg.Helpcmr_help_cd_ta}"/>
<f:verbatim>&nbsp;&nbsp;</f:verbatim>
<h:commandLink id="hoord_help_cd" action="#{cadHelpcmrBean.doOrd_help_cd}">
<ps:psGraphicImage id="hord_help_cd_desc" url="../imagens/btOrder_up.gif" border="0" rendered="#{cadHelpcmrBean.ord_help_cd_desc}"/>
<ps:psGraphicImage id="hord_help_cd" url="../imagens/btOrder_down.gif" border="0" rendered="#{cadHelpcmrBean.ord_help_cd}"/>
...
<h:outputText id="hd_help_nm_tt_xide" title="#{iimsg.Helpcmr_help_nm_tt}" value="#{iimsg.Helpcmr_help_nm_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenTransGen -->
...
<h:outputText id="hd_buttonHelp_tt_xide" title="#{iimsg.Helpcmr_buttonHelp_tt}" value="#{iimsg.Helpcmr_buttonHelp_ta}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propSearchChildTableGen -->
<!-- assist 1 -->
<h:column rendered="#{cadHelpcmrBean.assist}">
<f:facet name="header">
...
<h:inputText id="help_cd_xfil" onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadHelpcmrBean.fil_help_cd}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="help_nm_xfil" onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadHelpcmrBean.fil_help_nm}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- buttonOpenTransGen -->
...
<!-- Dados -->
<h:dataTable
value="#{cadHelpcmrBean.pesqData}"
var="Help"
binding="#{cadHelpcmrBean.pesqTable}"
rowClasses="tre9, tro9"
headerClass="tbh9"
footerClass="tbf9"
id="dtDados"
rows="#{cadHelpcmrBean.pageLength}"
first="#{cadHelpcmrBean.currentLine}">
<!-- propColumnGen -->
<h:column id="help_cd">
...
<h:commandLink id="xrec_obob" action="#{cadHelpcmrBean.doObternull}" immediate="true"/>
<h:commandLink id="xrec_obnv" action="#{cadHelpcmrBean.doNovo}" immediate="true"/>
