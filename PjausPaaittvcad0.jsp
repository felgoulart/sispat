...
<title><h:outputText value="#{cadPjausPaaittvBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();"  onload="window.focus();loading();PjausPaaittv_hl();ufmvini();tran='pjauspaaittvcad';cadbeanx='cadPjausPaaittvBean'; loadPage(<%= request.getAttribute("pagina") %>); AlternarAbas(parent.cadbeanx, <%=(Object)session.getAttribute(("cadPjausPaaittvBeanx"))%>);AlternarSubAbas();">
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspaaittvpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadPjausPaaittvBean.doSelecionarNullOnly}"/>
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspaaittvcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadPjausPaaittvBean.doReturnMenu}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadPjausPaaittvBean.canUpdate}" image="../imagens/btSave.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspaaittvcad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadPjausPaaittvBean.doUpdate}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadPjausPaaittvBean.canUpdate}" image="../imagens/btCancel.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadPjausPaaittvBean.doCancelar}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadPjausPaaittvBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadPjausPaaittvBean.doExcluir}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}"  action="#{cadPjausPaaittvBean.doObter}"  onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspaaittvcad'+'&ufmv='+stx"/>
...
<h:commandButton id="aHelpPjausRfm" tabindex="-1" immediate="true" rendered="#{cadPjausPaaittvBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'PjausRfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:commandButton id="aClose" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
<h:inputHidden id="tabsvf" value="#{cadPjausPaaittvBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadPjausPaaittvBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadPjausPaaittvBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadPjausPaaittvBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadPjausPaaittvBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadPjausPaaittvBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadPjausPaaittvBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadPjausPaaittvBean.xmesg_st}" />
...
<tr> <td valign="top" >
<table class="tbab" width="1000" height="20" border="0" cellpadding="0" cellspacing="0">
<tr>
...
<h:outputText value="#{iimsg.PjausPaaittv_D00_REGISTER_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.PjausPaaittv_D00_INTERF_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.PjausPaaittv_D00_ANALISE_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.PjausPaaittv_D00_CONTRACT_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.PjausPaaittv_D00_REQUEST_UV_st}"/>
</h:outputLink>
</td>
...
<h:commandLink id="xsel_vali" action="#{cadPjausPaaittvBean.doValidate}" immediate="true"/>
...
<!-- for fkstransGen -->
<h:commandLink id="xsel_ObxlsPaaittv" action="#{cadObxlsPaaittvBean.doSelecionarOnly}" immediate="true"/>
