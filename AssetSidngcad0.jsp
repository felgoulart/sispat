...
<title><h:outputText value="#{cadAssetSidngBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();"  onload="window.focus();loading();ufmvini();tran='assetsidngcad';cadbeanx='cadAssetSidngBean'; loadPage(<%= request.getAttribute("pagina") %>); AlternarAbas(parent.cadbeanx, <%=(Object)session.getAttribute(("cadAssetSidngBeanx"))%>);AlternarSubAbas();">
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetsidngpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadAssetSidngBean.doSelecionar}"/>
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetsidngcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadAssetSidngBean.doReturnMenu}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadAssetSidngBean.canUpdate}" image="../imagens/btSave.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetsidngcad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadAssetSidngBean.doUpdate}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadAssetSidngBean.canUpdate}" image="../imagens/btNew.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadAssetSidngBean.doCancelar}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadAssetSidngBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadAssetSidngBean.doExcluir}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}"  action="#{cadAssetSidngBean.doObter}"  onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetsidngcad'+'&ufmv='+stx"/>
...
<h:commandButton id="aHelpAssetComRfm" tabindex="-1" immediate="true" rendered="#{cadAssetSidngBean.hasHelpComRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'AssetComRfm');" image="../imagens/btHelpCom.gif"/>
<h:commandButton id="aHelpAssetViapmRfm" tabindex="-1" immediate="true" rendered="#{cadAssetSidngBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'AssetViapmRfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:commandButton id="aClose" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
<h:inputHidden id="tabsvf" value="#{cadAssetSidngBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadAssetSidngBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadAssetSidngBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadAssetSidngBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadAssetSidngBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadAssetSidngBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadAssetSidngBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadAssetSidngBean.xmesg_st}" />
...
<h:outputText value="#{iimsg.AssetSidng_D00_REGISTER_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetSidng_D00_LOCATION_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetSidng_D00_ATTRIBUTES_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetSidng_D00_SURVEY_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetSidng_D00_OCCUPDOC_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetSidng_D00_EVALUATION_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetSidng_D00_EXPERTS_UV_st}"/>
</h:outputLink>
</td>
...
<iframe id="fInvtyDCsak" width="0" height="0" frameborder="0"> </iframe>
<iframe id="fInvtyDCsfk" width="0" height="0" frameborder="0"> </iframe>
<iframe id="InvtyDC" width="0" height="0" frameborder="0"> </iframe>
<iframe id="invty" width="0" height="0" frameborder="0"> </iframe>
<iframe id="fInvtyDCsak" width="0" height="0" frameborder="0"> </iframe>
<iframe id="fInvtyDCsfk" width="0" height="0" frameborder="0"> </iframe>
...
<h:commandLink id="xsel_vali" action="#{cadAssetSidngBean.doValidate}" immediate="true"/>
...
<h:commandLink id="xsel_invtydc" action="#{cadInvtyDCBean.doSelecionarOnly}" immediate="true"/>
