...
arAbas[4] = new stAba('aba_astdt','abc_astdt','flg_astdt','u','a','aba_astdt');
...
<title><h:outputText value="#{cadAssetLvlcrBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();"  onload="window.focus();loading();ufmvini();tran='assetlvlcrcad';cadbeanx='cadAssetLvlcrBean'; loadPage(<%= request.getAttribute("pagina") %>); AlternarAbas(parent.cadbeanx, <%=(Object)session.getAttribute(("cadAssetLvlcrBeanx"))%>);AlternarSubAbas();">
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetlvlcrpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadAssetLvlcrBean.doSelecionar}"/>
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetlvlcrcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadAssetLvlcrBean.doReturnMenu}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadAssetLvlcrBean.canUpdate}" image="../imagens/btSave.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetlvlcrcad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadAssetLvlcrBean.doUpdate}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadAssetLvlcrBean.canUpdate}" image="../imagens/btNew.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadAssetLvlcrBean.doCancelar}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadAssetLvlcrBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadAssetLvlcrBean.doExcluir}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}"  action="#{cadAssetLvlcrBean.doObter}"  onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetlvlcrcad'+'&ufmv='+stx"/>
...
<h:commandButton id="aHelpAssetRfm" tabindex="-1" immediate="true" rendered="#{cadAssetLvlcrBean.hasHelpComRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'AssetRfm');" image="../imagens/btHelpCom.gif"/>
<h:commandButton id="aHelpAssetLvlcrRfm" tabindex="-1" immediate="true" rendered="#{cadAssetLvlcrBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'AssetLvlcrRfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:commandButton id="aClose" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
<h:inputHidden id="tabsvf" value="#{cadAssetLvlcrBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadAssetLvlcrBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadAssetLvlcrBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadAssetLvlcrBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadAssetLvlcrBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadAssetLvlcrBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadAssetLvlcrBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadAssetLvlcrBean.xmesg_st}" />
...
<h:outputText value="#{iimsg.AssetLvlcr_D00_REGISTER_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetLvlcr_D00_LOCATION_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.AssetLvlcr_D00_ATTRIBUTES_UV_st}"/>
</h:outputLink>
</td>
<td width="" id="aba_astdt" style="display: none">
<A href="#" onclick="msgwv('xsel_vali')"><img id="flg_astdt" class="btp" align="absmiddle" style="padding:5px; float:left" /></A>
<h:outputLink value="#" onclick="AlternarAbas(parent.cadbeanx, 4);" styleClass="mnt">
<h:outputText value="#{iimsg.AssetLvlcr_D00_DETAIL_UV_st}"/>
</h:outputLink>
</td>
...
<%@include file="AssetLvlcrcadastrg.jsp"%>
</div>
<!-- UV-UV-Stubs/MV D00_LOCATION_UV-->
<div id="abc_astlc" style="display: none">
<%@include file="AssetLvlcrcadastlc.jsp"%>
</div>
<!-- UV-UV-Stubs/MV D00_ATTRIBUTES_UV-->
<div id="abc_astat" style="display: none">
<%@include file="AssetLvlcrcadastat.jsp"%>
</div>
<!-- UV-UV-Stubs/MV D00_DETAIL_UV-->
<div id="abc_astdt" style="display: none">
<%@include file="AssetLvlcrcadastdt.jsp"%>
</div>
<!-- D00_NOTR -->
...
<h:commandLink id="xsel_vali" action="#{cadAssetLvlcrBean.doValidate}" immediate="true"/>
