...
<title><h:outputText value="#{cadObocpxBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();" onload="window.focus();loading();ufmvini();tran='obocpcad';cadbeanx='cadObocpxBean';loadPage(<%= request.getAttribute("pagina") %>);">
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obocpxpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadObocpxBean.doSelecionarBackx}"/>
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obocpxcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadObocpxBean.doReturnMenu}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadObocpxBean.canUpdate}" image="../imagens/btSave.gif"onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obocpcad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadObocpxBean.doUpdate1Chld}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadObocpxBean.canUpdate}" image="../imagens/btCancel.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadObocpxBean.doObterParentForCancel}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadObocpxBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadObocpxBean.doExcluirChld}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}" action="#{cadObocpxBean.doObter}" onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'obocpcad'+'&ufmv='+stx"/>
...
<h:inputHidden id="tabsvf" value="#{cadObocpxBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadObocpxBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadObocpxBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadObocpxBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadObocpxBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadObocpxBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadObocpxBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadObocpxBean.xmesg_st}" />
...
<td   colspan="2"    >
<h:inputText id="mesg_var" value="#{cadObocpxBean.mesg_var}"  styleClass="txrr pr5 tb450r" tabindex="-1" readonly="true"/>
<h:commandButton id="aMessage" image="../imagens/btMessage_off.gif" styleClass="btp" title="#{iimsg.botao_message}" rendered="#{cadObocpxBean.canUpdate}" action="#{cadObocpxBean.doValidate}" onmousedown="msgw('aMessage');"/>
</td> <%-- <close td> bbb --%>
</tr> <%-- <tr close> bbb --%>
<tr>   <%-- <tr open> vvv --%>
...
<%-- Processing Fk --%>
<%-- Processing Fk 333--%>
<h:inputText id="obocp_id" tabindex="-1"  onclick="clf(this);" readonly="true" value="#{cadObocpxBean.obocp_id}"  styleClass="tbxr" onkeydown="keypress=1;" size="15" maxlength="15" />
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
<%-- prop Primary Key --%>
<%-- Processing Pk --%>
<h:inputHidden id="obocp_sq" value="#{cadObocpxBean.obocp_sq}"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<h:inputText id="obocp_dt_str" tabindex="1"  value="#{cadObocpxBean.obocp_dt_str}"  styleClass="tbDt" size="10" maxlength="8" onkeydown="formataData('cadForm:obocp_dt_str', event);" onkeyup="SaltaCampo('cadForm:obocp_dt_str', 'cadForm:obocp_tp', 8 , event);" onchange="validaDatas2(this);bv('','obocp_dt_str','0',this.value);"  />
<img src="../imagens/btCalendar.gif" onclick="mostraCalendario('cadForm:obocp_dt_str', 'obocp_dtCal');" style="cursor: hand"/>
<ps:psGraphicImage id="obocp_dt_vc" flagType="val" flag="#{cadObocpxBean.obocp_dt_vc}" styleClass="btp"/>
...
<h:inputText  id="obocp_tp" onclick="clf(this);" value="#{cadObocpxBean.obocp_tp}" onkeydown="keypress=1;"  styleClass="tbx" onchange="bdcd('','obocp_tp','0','TPOCP',this.value);;" size="7" maxlength="5" tabindex="2" />
...
<ps:psGraphicImage id="obocp_tp_vc" flagType="val" flag="#{cadObocpxBean.obocp_tp_vc}" styleClass="btp"/>
<%-- Processing Codf 1 AAA --%>
<h:inputText id="obocp_tp_desc" tabindex="-1" onfocus="this.blur()" value="#{cadObocpxBean.obocp_tp_desc}" styleClass="txlr pr5 tb90r"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<%-- nowrap 5676 --%>
<td   width="400"   >
<h:inputText id="obocp_nm" tabindex="3"  value="#{cadObocpxBean.obocp_nm}" size="82" maxlength="80"  styleClass="tbx" onchange="bv('','obocp_nm','0',this.value);"/>
<ps:psGraphicImage id="obocp_nm_vc" flagType="val" flag="#{cadObocpxBean.obocp_nm_vc}" styleClass="btp"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<%-- Processing Fk --%>
<%-- Processing Fk 333--%>
<h:inputText id="obocp_cd_ccusto" tabindex="4"  onclick="clf(this);" value="#{cadObocpxBean.obocp_cd_ccusto}"  styleClass="tbx" onkeydown="keypress=1;" onchange="Transfk('','','0','obocp_cd_ccusto','Ixccust','ccust_cd','ccust_ds',this.value);" size="12" maxlength="10" />
...
<ps:psGraphicImage id="obocp_cd_ccusto_vc" flagType="val" flag="#{cadObocpxBean.obocp_cd_ccusto_vc}" styleClass="btp"/>
<%-- ak/fk else akhidden --%>
<h:inputText id="obocp_cd_ccusto_desc" tabindex="-1" onfocus="this.blur()" value="#{cadObocpxBean.obocp_cd_ccusto_desc}" styleClass="txlr pr5 tb90r"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<%-- nowrap 5676 --%>
<td   width="400"   >
<h:inputText id="obocp_ds_autorz" tabindex="5"  value="#{cadObocpxBean.obocp_ds_autorz}" size="82" maxlength="80"  styleClass="tbx" onchange="bv('','obocp_ds_autorz','0',this.value);"/>
<ps:psGraphicImage id="obocp_ds_autorz_vc" flagType="val" flag="#{cadObocpxBean.obocp_ds_autorz_vc}" styleClass="btp"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
<tr>   <%-- <tr open> vvv --%>
<td        width="140" > <%-- open w/ inputText 222a--%>
...
<h:commandLink id="xsel_vali" action="#{cadObocpxBean.doValidate}" immediate="true"/>
...
<h:commandLink id="xnew_Ixccust" action="#{cadIxccustBean.doObternull}" immediate="true"/>
<!-- for current oabv -->
<h:commandLink id="xsel_obocp" action="#{cadObocpxBean.doSelecionar}" immediate="true"/>
<h:commandLink id="xrec_obocp" action="#{cadObocpxBean.doObternull}" immediate="true"/>
</h:form>
