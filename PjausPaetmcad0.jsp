...
<title><h:outputText value="#{cadPjausPaetmBean.trans_tt}"/></title>
</head>
<body onkeydown="rk();"  onload="window.focus();loading();PjausPaetm_hl();ufmvini();tran='pjauspaetmcad';cadbeanx='cadPjausPaetmBean'; loadPage(<%= request.getAttribute("pagina") %>); AlternarAbas(parent.cadbeanx, <%=(Object)session.getAttribute(("cadPjausPaetmBeanx"))%>);AlternarSubAbas();">
...
<h:commandButton id="aBackToSearch" immediate="true"  styleClass="btp" image="../imagens/btReturnx.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspaetmpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" action="#{cadPjausPaetmBean.doSelecionarNullOnly}"/>
<h:commandButton id="aBackToSearchMenu" immediate="true"  styleClass="btp" image="../imagens/btReturnxMenu.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspaetmcad'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToMenu_tt}" action="#{cadPjausPaetmBean.doReturnMenu}"/>
<h:commandButton id="aUpdate" styleClass="btp" rendered="#{cadPjausPaetmBean.canUpdate}" image="../imagens/btSave.gif" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspaetmcad'+'&ufmv='+stx;msgwr();upflag=0;AlternarTabsvf();" title="#{iimsg.botao_update}" action="#{cadPjausPaetmBean.doUpdate}"/>
<h:commandButton id="aCancelar" styleClass="btp" rendered="#{cadPjausPaetmBean.canUpdate}" image="../imagens/btCancel.gif"  disabled="" onmousedown="msgwr()" title="#{iimsg.botao_novo}" action="#{cadPjausPaetmBean.doCancelar}"/>
<h:commandButton id="aExcluir" styleClass="btp" title="#{iimsg.botao_excluir}" rendered="#{cadPjausPaetmBean.canExcluir}" image="../imagens/btDelete.gif"  disabled="" onmousedown="msgwex()" action="#{cadPjausPaetmBean.doExcluir}"/>
<h:commandButton id="aRefresh" styleClass="btp"  image="../imagens/btRefresh.gif" title="#{iimsg.botao_refresh}"  action="#{cadPjausPaetmBean.doObter}"  onmousedown="msgwr();document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'pjauspaetmcad'+'&ufmv='+stx"/>
...
<h:commandButton id="aHelpPjausRfm" tabindex="-1" immediate="true" rendered="#{cadPjausPaetmBean.hasHelpSpcRfm}" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes', 'PjausRfm');" image="../imagens/btHelpSpc.gif"/>
<h:commandButton id="aPrint" tabindex="-1" immediate="true" title="#{iimsg.button_printScreen_tt}" onmousedown="window.print()" image="../imagens/btPrinter.gif"/>
<h:commandButton id="aClose" tabindex="-1" immediate="true" title="#{iimsg.botao_close}" onmousedown="msgwinclose()" image="../imagens/btClose.gif"/>
<h:inputHidden id="tabsvf" value="#{cadPjausPaetmBean.tabsvf}" />
<h:inputHidden id="xhelp_rc" value="#{cadPjausPaetmBean.xhelp_rc}" />
<h:inputHidden id="tabsvf_in" value="#{cadPjausPaetmBean.tabsvf_in}" />
<h:inputHidden id="tabsvf_tr" value="#{cadPjausPaetmBean.tabsvf_tr}" />
<h:inputHidden id="xbutn_id" value="#{cadPjausPaetmBean.xbutn_id}" />
<h:inputHidden id="xbutx_id" value="" />
<h:inputHidden id="xuserx_id_login" value="#{cadPjausPaetmBean.xuserx_id_login}" />
<h:inputHidden id="xmesg_rc" value="#{cadPjausPaetmBean.xmesg_rc}" />
<h:inputHidden id="xmesg_st" value="#{cadPjausPaetmBean.xmesg_st}" />
...
<h:outputText value="#{iimsg.PjausPaetm_D00_REGISTER_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.PjausPaetm_D00_DETAIL_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.PjausPaetm_D00_ANALISE_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.PjausPaetm_D00_CONTRACT_UV_st}"/>
</h:outputLink>
</td>
...
<h:outputText value="#{iimsg.PjausPaetm_D00_REQUEST_UV_st}"/>
</h:outputLink>
</td>
...
<h:commandLink id="xsel_vali" action="#{cadPjausPaetmBean.doValidate}" immediate="true"/>
...
<!-- for fkstransGen -->
<h:commandLink id="xsel_ObxlsPaetm" action="#{cadObxlsPaetmBean.doSelecionarOnly}" immediate="true"/>
