...
<h:inputText id="mesg_varastob" rendered="#{cadAssetCulvtBean.canUpdate}" value="#{cadAssetCulvtBean.mesg_var}"  styleClass="txrr pr5 tb450r" tabindex="-1" readonly="true"/>
<ps:psCommandLink id="aMessageastob" rendered="#{cadAssetCulvtBean.canUpdate}" action="#{cadAssetCulvtBean.doValidate}" onmousedown="msgw('aMessageastob');">
...
<h:outputText value="#{iimsg.AssetCulvt_obsrv_tt_tt}"/>
</td>
...
<tr>  <%-- <tr open> vvv --%>
<%-- inputTextArea --%>
<td   colspan="4" >  <h:inputTextarea id="asset_ob" tabindex="54"  value="#{cadAssetCulvtBean.asset_ob}" cols="100" rows="8" styleClass="rtfFontChoice" onchange="bv('','asset_ob','7',this.value);"/>
</td> <%-- <close td> ccc --%>
</tr> <%-- <tr close> ddd--%>
