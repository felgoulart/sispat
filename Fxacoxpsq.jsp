...
<link rel="stylesheet" href="../Fxacoxpsq.css" type="text/css">
...
function loadPage() {
hovDtTable('dtDados');
cfb('cadForm:dtDados_ft:fxaco_cd_fxprs_xfil', 'pfdb9', 'pfd9');
...
<body onload="window.focus();loadPage();loading();helpcd='FxacoxSfm';;tran='fxacoxpsq'; vl='';cadbeanx='cadFxacoxBean';<%session.setAttribute("tipo","fxacoxpsq");%>">
<h:form id="cadForm">
...
<h:commandButton id="aPrev" styleClass="btp"  image="../imagens/btPgAnterior.gif" title="#{iimsg.botao_anterior}" rendered="#{cadFxacoxBean.hasPrevPage}" action="#{cadFxacoxBean.doPaginaAnterior}"/>
<h:commandButton id="aNext" styleClass="btp"  image="../imagens/btPgProxima.gif" title="#{iimsg.botao_proxima}" rendered="#{cadFxacoxBean.hasNextPage}" action="#{cadFxacoxBean.doProximaPagina}"/>
<h:outputText id="label_fill" style="display:none" value="#{iimsg.label_fill}" />
<h:outputText id="label_notfound" style="display:none" value="#{iimsg.label_notfound}" />
<h:outputText id="sys_openning_form" style="display:none" value="#{iimsg.sys_openning_form}" />
<h:commandButton id="aFiltrar" styleClass="btp"  image="../imagens/btFilter.gif" title="#{iimsg.botao_filtrar}" action="#{cadFxacoxBean.doSelecionar}"/>
<h:commandButton id="aLimpar" styleClass="btp" rendered="#{cadFxacoxBean.canPesquisar}" image="../imagens/btCancel.gif" title="#{iimsg.botao_limpar}" action="#{cadFxacoxBean.doLimparPesq}"/>
<%-- prop buttonLink 4577--%>
<h:commandButton id="XlsExport_xls_stb" rendered="#{cadFxacoxBean.canPesquisar}" title="#{iimsg.Fxaco_XlsExport_xls_stb_tt}" image="../imagens/excellRed.jpg" action="#{cadFxacoxBean.doXlsExport_xls_stb}"/>
...
<h:commandButton id="aHelpFxacoxSfm" tabindex="-1" rendered="#{cadFxacoxBean.hasHelpSpcSfm}" immediate="true" title="#{iimsg.botao_help_spc}" onmousedown="pw('helpcad', tran, this.id, 'yes','FxacoxSfm');" image="../imagens/btHelpSpc.gif"/>
...
<h:inputText id="mesg_var" value="#{cadFxacoxBean.mesg_var}"  styleClass="txrr pr5 tb600r" tabindex="-1" readonly="true"/>
</td> <%-- <close td> msg --%>
<td> &nbsp&nbsp </td>
<td      width="50" > <%-- open w/ inputText 222--%>
<%-- outputLabel msg --%>
...
<%-- outputText --%>
<td    width="100" > <h:inputText id="codfqt" onfocus="this.blur()" value="#{cadFxacoxBean.codfqt}" size="5" maxlength="5"  styleClass="txl pl5 tbxr"/>
</td> <%-- <close td> msg --%>
</tr> <%-- <tr close> msg--%>
...
id="dtDados_tt">
<!-- fkeyColumnGen -->
<h:column id="fxaco_cd_fxprs_tt_fk">
<f:facet name="header">
<h:panelGroup id="pg_fxaco_cd_fxprs_tt">
<h:outputText id="hd_fxaco_cd_fxprs_tt" title="#{iimsg.Fxaco_fxaco_cd_fxprs_tt}" value="#{iimsg.Fxaco_fxaco_cd_fxprs_tt}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
id="dtDados_ft">
<!-- fkeyColumnGen -->
<h:column id="fxaco_cd_fxprs_ft_fk">
<f:facet name="footer">
<h:panelGroup id="fpg_fxaco_cd_fxprs">
<!--   // 444-->
<h:inputText id="fxaco_cd_fxprs_xfil" title="#{iimsg.hint_dblclick}" ondblclick="this.value=''" onblur="cfb(this.id, 'pfdb9', 'pfd9');" onfocus="this.className='pfd9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadFxacoxBean.fil_fxaco_cd_fxprs}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="fxaco_cd_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadFxacoxBean.fil_fxaco_cd}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="fxaco_ds_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadFxacoxBean.fil_fxaco_ds}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- fkeyColumnGen -->
...
<!--   // 444-->
<h:inputText id="fxaco_cd_solic_de_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('solicpsq', tran, this.id, 'no', vl);" onblur="cfb(this.id, 'pfdb9', 'pfd9');" onfocus="this.className='pfd9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadFxacoxBean.fil_fxaco_cd_solic_de}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- fkeyColumnGen -->
...
<!--   // 444-->
<h:inputText id="fxaco_cd_solic_para_xfil" title="#{iimsg.hint_dblclick}" ondblclick="pw('solicpsq', tran, this.id, 'no', vl);" onblur="cfb(this.id, 'pfdb9', 'pfd9');" onfocus="this.className='pfd9'"  onchange="this.value = this.value.toUpperCase();" onclick="this.value=''" value="#{cadFxacoxBean.fil_fxaco_cd_solic_para}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- propColumnGen -->
...
<h:inputText id="fxaco_ds_fluxo_xfil" onchange="this.value = this.value.toUpperCase();" ondblclick="this.value=''" value="#{cadFxacoxBean.fil_fxaco_ds_fluxo}" onkeypress="if (event.keyCode == 13) { el('cadForm:aFiltrar').click();}"/>
</h:panelGroup>
</f:facet>
</h:column>
<!-- recdWdColumnGen -->
...
<!-- Dados -->
<h:dataTable
value="#{cadFxacoxBean.pesqData}"
var="Fxaco"
binding="#{cadFxacoxBean.pesqTable}"
rowClasses="tre9, tro9"
headerClass="tbh9"
footerClass="tbf9"
id="dtDados"
rows="#{cadFxacoxBean.pageLength}"
first="#{cadFxacoxBean.currentLine}">
<!-- fkeyColumnGen -->
<h:column id="fxaco_cd_fxprs_fk">
<h:panelGroup id="pg_fxaco_cd_fxprs_sg">
<!--   // 333-->
<h:outputText id="sel_fxaco_cd_fxprs" value="#{Fxaco.fxaco_cd_fxprs}"/>
</h:panelGroup>
</h:column>
<!-- propColumnGen -->
<h:column id="fxaco_sx">
...
<!-- CRX-30-->  <h:commandButton id="flag_imgrecd_wd" image="../imagens/btRecd.gif" action="#{cadFxacoxBean.doObternullSearchBack}" onmousedown="wtran='fxacoxcad';aa=this.id.slice(0,this.id.search('flag_img'));valor1=rpel(aa+'sel_fxaco_cd_fxprs');valor2=rpel(aa+'sel_fxaco_sq');selDtTableOneRow(aa);el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valor1+','+valor2;"/>
</h:panelGroup>
</h:column>
<!-- recdWdColumnGen -->
<h:column id="recd_wdpk">
<h:panelGroup id="pg_recd_wd_sgpk">
<h:inputHidden id="sel_fxaco_sqpk" value="#{Fxaco.fxaco_sq}"/>
<!-- PRX-20-->  <h:commandButton id="flag_imgrecd_wdpk" image="../imagens/btRecdpk.gif" onmousedown="aa=this.id.slice(0,this.id.search('flag_img'));valorPKey=rpel(aa+'sel_fxaco_cd_fxprs');typevl=rpel(aa+'sel_');tranx=FxprsType(typevl);wtran=tranx+'cad';selDtTableOneRow(aa);el('fiiSaveType').src = 'iiSaveType.jsp?tipo='+wtran+'&valor='+valorPKey; onclickx('xrec_'+tranx,'yes');"/>
</h:panelGroup>
</h:column>
<!-- propSearchChildTableGen -->
</h:dataTable>
...
<h:commandLink id="xrec_obnv" action="#{cadFxacoxBean.doObterParentForCancel}" immediate="true"/>
