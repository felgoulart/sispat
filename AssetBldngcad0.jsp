...
<body onkeydown="rk();"  onload="window.focus();loading();ufmvini();tran='assetbldngcad';cadbeanx='cadAssetBldngBean'; loadPage(<%= request.getAttribute("pagina") %>); AlternarAbas(parent.cadbeanx, <%=(Object)session.getAttribute(("cadAssetBldngBeanx"))%>);AlternarSubAbas();">
...
<div id="loading" class="loading" align="center"><h:outputText id="label_wait" value="#{iimsg.msg_wait}"/></div>
	<div class="container expand-max bg-transparent mt-3">
	  <div class="row">
		...
		<div class="col-sm-10">
		<h2 class="title" style="font-size: 35px;"><h:outputText styleClass="h2 mt-3"  value="#{cadAssetBldngBean.trans_tt}"/></h2>
		...
		<p class="subtitle" style="text-align:center;color:#505050">
			...
			<h:outputText id="asset_id11" value="#{cadAssetBldngBean.asset_id}"  />
			<h:outputText value="#{iimsg.AssetBldng_asset_nu_tt}"/>
			<h:outputText id="asset_id_dsc11" value="#{cadAssetBldngBean.asset_nu}" />
		</p>
		<p style="text-align:center;">
		<h:outputText id="mesg_varastif1" rendered="#{cadAssetBldngBean.canUpdate}" value="#{cadAssetBldngBean.mesg_var}"  styleClass="alert alert-primary" />
		<h:commandButton id="aMessageastif1" image="../imagens/btMessage_off.gif" styleClass="d-none" title="#{iimsg.botao_message}" rendered="#{cadAssetBldngBean.canUpdate}" action="#{cadAssetBldngBean.doValidate}" onmousedown="msgw('aMessageastif1');"/>
		</p>
		</div>
		<div class="col-sm-1">
		<h:commandButton id="aBackToSearch1" immediate="true"  styleClass="btn btn-outline-dark" onmousedown="if(abatp=='m'){ufmsg1();return;};if(keypress==1){ufmsg2();return;};document.getElementById('iiSaveUfmv').src = 'iiSaveUfmv.jsp?tipo='+'assetbldngpsq'+'&ufmv='+stx;msgwr();upflag=0;" title="#{iimsg.buttonReturnToPrevious_tt}" value="Voltar" action="#{cadAssetBldngBean.doSelecionar}"/>
		</div>
	</div>
	</div>
...
<tr> <td valign="top" >
<table class="tbab" width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
<tr>
...
<h:outputLink value="#" onclick="AlternarAbas(parent.cadbeanx, 2);"  style="text-align:center" styleClass="mnt">
